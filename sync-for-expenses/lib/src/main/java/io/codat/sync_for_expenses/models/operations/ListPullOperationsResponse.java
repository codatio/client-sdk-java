...
public class ListPullOperationsResponse {
     ...
     * OK
     */
    private Optional<? extends io.codat.sync_for_expenses.models.shared.PullOperations> pullOperations;
    ...
    public ListPullOperationsResponse(
            ...
            Optional<? extends io.codat.sync_for_expenses.models.shared.PullOperations> pullOperations,
            int statusCode,
     ...
     * OK
     */
    public Optional<? extends io.codat.sync_for_expenses.models.shared.PullOperations> pullOperations() {
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListPullOperationsResponse withErrorMessage(io.codat.sync_for_expenses.models.shared.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListPullOperationsResponse withErrorMessage(Optional<? extends io.codat.sync_for_expenses.models.shared.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * OK
     */
    public ListPullOperationsResponse withPullOperations(io.codat.sync_for_expenses.models.shared.PullOperations pullOperations) {
        Utils.checkNotNull(pullOperations, "pullOperations");
     ...
     * OK
     */
    public ListPullOperationsResponse withPullOperations(Optional<? extends io.codat.sync_for_expenses.models.shared.PullOperations> pullOperations) {
        Utils.checkNotNull(pullOperations, "pullOperations");
        this.pullOperations = pullOperations;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.sync_for_expenses.models.shared.PullOperations> pullOperations = Optional.empty();
         ...
         * OK
         */
        public Builder pullOperations(io.codat.sync_for_expenses.models.shared.PullOperations pullOperations) {
            Utils.checkNotNull(pullOperations, "pullOperations");
            this.pullOperations = Optional.ofNullable(pullOperations);
            return this;
        }
         ...
         * OK
         */
        public Builder pullOperations(Optional<? extends io.codat.sync_for_expenses.models.shared.PullOperations> pullOperations) {
            Utils.checkNotNull(pullOperations, "pullOperations");
            this.pullOperations = pullOperations;
            return this;
        }
