...
public class ListConnectionsResponse {
     ...
     * OK
     */
    private Optional<? extends io.codat.sync_for_expenses.models.shared.Connections> connections;
    ...
    public ListConnectionsResponse(
            Optional<? extends io.codat.sync_for_expenses.models.shared.Connections> connections,
            String contentType,
     ...
     * OK
     */
    public Optional<? extends io.codat.sync_for_expenses.models.shared.Connections> connections() {
        return connections;
    }
     ...
     * OK
     */
    public ListConnectionsResponse withConnections(io.codat.sync_for_expenses.models.shared.Connections connections) {
        Utils.checkNotNull(connections, "connections");
     ...
     * OK
     */
    public ListConnectionsResponse withConnections(Optional<? extends io.codat.sync_for_expenses.models.shared.Connections> connections) {
        Utils.checkNotNull(connections, "connections");
        this.connections = connections;
        return this;
    }
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListConnectionsResponse withErrorMessage(io.codat.sync_for_expenses.models.shared.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListConnectionsResponse withErrorMessage(Optional<? extends io.codat.sync_for_expenses.models.shared.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.sync_for_expenses.models.shared.Connections> connections = Optional.empty();
         ...
         * OK
         */
        public Builder connections(io.codat.sync_for_expenses.models.shared.Connections connections) {
            Utils.checkNotNull(connections, "connections");
            this.connections = Optional.ofNullable(connections);
            return this;
        }
         ...
         * OK
         */
        public Builder connections(Optional<? extends io.codat.sync_for_expenses.models.shared.Connections> connections) {
            Utils.checkNotNull(connections, "connections");
            this.connections = connections;
            return this;
        }
