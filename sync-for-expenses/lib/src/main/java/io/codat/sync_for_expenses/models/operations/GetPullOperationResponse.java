...
public class GetPullOperationResponse {
     ...
     * OK
     */
    private Optional<? extends io.codat.sync_for_expenses.models.shared.PullOperation> pullOperation;
    ...
    public GetPullOperationResponse(
            ...
            Optional<? extends io.codat.sync_for_expenses.models.shared.PullOperation> pullOperation,
            int statusCode,
     ...
     * OK
     */
    public Optional<? extends io.codat.sync_for_expenses.models.shared.PullOperation> pullOperation() {
     ...
     * Your API request was not properly authorized.
     */
    public GetPullOperationResponse withErrorMessage(io.codat.sync_for_expenses.models.shared.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public GetPullOperationResponse withErrorMessage(Optional<? extends io.codat.sync_for_expenses.models.shared.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * OK
     */
    public GetPullOperationResponse withPullOperation(io.codat.sync_for_expenses.models.shared.PullOperation pullOperation) {
        Utils.checkNotNull(pullOperation, "pullOperation");
     ...
     * OK
     */
    public GetPullOperationResponse withPullOperation(Optional<? extends io.codat.sync_for_expenses.models.shared.PullOperation> pullOperation) {
        Utils.checkNotNull(pullOperation, "pullOperation");
        this.pullOperation = pullOperation;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.sync_for_expenses.models.shared.PullOperation> pullOperation = Optional.empty();
         ...
         * OK
         */
        public Builder pullOperation(io.codat.sync_for_expenses.models.shared.PullOperation pullOperation) {
            Utils.checkNotNull(pullOperation, "pullOperation");
            this.pullOperation = Optional.ofNullable(pullOperation);
            return this;
        }
         ...
         * OK
         */
        public Builder pullOperation(Optional<? extends io.codat.sync_for_expenses.models.shared.PullOperation> pullOperation) {
            Utils.checkNotNull(pullOperation, "pullOperation");
            this.pullOperation = pullOperation;
            return this;
        }
