...
public class ListPushOperationsResponse {
     ...
     * OK
     */
    private Optional<? extends io.codat.sync_for_expenses.models.shared.PushOperations> pushOperations;
    ...
    public ListPushOperationsResponse(
            ...
            Optional<? extends io.codat.sync_for_expenses.models.shared.PushOperations> pushOperations,
            int statusCode,
     ...
     * OK
     */
    public Optional<? extends io.codat.sync_for_expenses.models.shared.PushOperations> pushOperations() {
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListPushOperationsResponse withErrorMessage(io.codat.sync_for_expenses.models.shared.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListPushOperationsResponse withErrorMessage(Optional<? extends io.codat.sync_for_expenses.models.shared.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * OK
     */
    public ListPushOperationsResponse withPushOperations(io.codat.sync_for_expenses.models.shared.PushOperations pushOperations) {
        Utils.checkNotNull(pushOperations, "pushOperations");
     ...
     * OK
     */
    public ListPushOperationsResponse withPushOperations(Optional<? extends io.codat.sync_for_expenses.models.shared.PushOperations> pushOperations) {
        Utils.checkNotNull(pushOperations, "pushOperations");
        this.pushOperations = pushOperations;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.sync_for_expenses.models.shared.PushOperations> pushOperations = Optional.empty();
         ...
         * OK
         */
        public Builder pushOperations(io.codat.sync_for_expenses.models.shared.PushOperations pushOperations) {
            Utils.checkNotNull(pushOperations, "pushOperations");
            this.pushOperations = Optional.ofNullable(pushOperations);
            return this;
        }
         ...
         * OK
         */
        public Builder pushOperations(Optional<? extends io.codat.sync_for_expenses.models.shared.PushOperations> pushOperations) {
            Utils.checkNotNull(pushOperations, "pushOperations");
            this.pushOperations = pushOperations;
            return this;
        }
