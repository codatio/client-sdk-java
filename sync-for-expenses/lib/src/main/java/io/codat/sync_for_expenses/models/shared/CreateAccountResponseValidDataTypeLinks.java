...
public class CreateAccountResponseValidDataTypeLinks {
     ...
     * Supported `dataTypes` that the record can be linked to.
     */
    public CreateAccountResponseValidDataTypeLinks withLinks(java.util.List<String> links) {
        Utils.checkNotNull(links, "links");
     ...
     * Supported `dataTypes` that the record can be linked to.
     */
    public CreateAccountResponseValidDataTypeLinks withLinks(JsonNullable<? extends java.util.List<String>> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
     ...
     * The property from the account that can be linked.
     */
    public CreateAccountResponseValidDataTypeLinks withProperty(JsonNullable<? extends String> property) {
        Utils.checkNotNull(property, "property");
        this.property = property;
        return this;
    }
