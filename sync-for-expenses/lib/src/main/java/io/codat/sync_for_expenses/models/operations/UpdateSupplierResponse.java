...
public class UpdateSupplierResponse {
     ...
     * Success
     */
    private Optional<? extends io.codat.sync_for_expenses.models.shared.UpdateSupplierResponse> updateSupplierResponse;
    ...
    public UpdateSupplierResponse(
            ...
            Optional<? extends io.codat.sync_for_expenses.models.shared.UpdateSupplierResponse> updateSupplierResponse) {
     ...
     * Success
     */
    public Optional<? extends io.codat.sync_for_expenses.models.shared.UpdateSupplierResponse> updateSupplierResponse() {
     ...
     * The request made is not valid.
     */
    public UpdateSupplierResponse withErrorMessage(io.codat.sync_for_expenses.models.shared.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * The request made is not valid.
     */
    public UpdateSupplierResponse withErrorMessage(Optional<? extends io.codat.sync_for_expenses.models.shared.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * Success
     */
    public UpdateSupplierResponse withUpdateSupplierResponse(io.codat.sync_for_expenses.models.shared.UpdateSupplierResponse updateSupplierResponse) {
        Utils.checkNotNull(updateSupplierResponse, "updateSupplierResponse");
     ...
     * Success
     */
    public UpdateSupplierResponse withUpdateSupplierResponse(Optional<? extends io.codat.sync_for_expenses.models.shared.UpdateSupplierResponse> updateSupplierResponse) {
        Utils.checkNotNull(updateSupplierResponse, "updateSupplierResponse");
        this.updateSupplierResponse = updateSupplierResponse;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.sync_for_expenses.models.shared.UpdateSupplierResponse> updateSupplierResponse = Optional.empty();  
         ...
         * Success
         */
        public Builder updateSupplierResponse(io.codat.sync_for_expenses.models.shared.UpdateSupplierResponse updateSupplierResponse) {
            Utils.checkNotNull(updateSupplierResponse, "updateSupplierResponse");
            this.updateSupplierResponse = Optional.ofNullable(updateSupplierResponse);
            return this;
        }
         ...
         * Success
         */
        public Builder updateSupplierResponse(Optional<? extends io.codat.sync_for_expenses.models.shared.UpdateSupplierResponse> updateSupplierResponse) {
            Utils.checkNotNull(updateSupplierResponse, "updateSupplierResponse");
            this.updateSupplierResponse = updateSupplierResponse;
            return this;
        }        
