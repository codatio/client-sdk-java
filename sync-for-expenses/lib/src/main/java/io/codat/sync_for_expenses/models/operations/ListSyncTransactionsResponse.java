...
public class ListSyncTransactionsResponse {
     ...
     * Success
     */
    private Optional<? extends io.codat.sync_for_expenses.models.shared.Transactions> transactions;
    ...
    public ListSyncTransactionsResponse(
            ...
            Optional<? extends io.codat.sync_for_expenses.models.shared.Transactions> transactions) {
     ...
     * Success
     */
    public Optional<? extends io.codat.sync_for_expenses.models.shared.Transactions> transactions() {
        return transactions;
    }
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListSyncTransactionsResponse withErrorMessage(io.codat.sync_for_expenses.models.shared.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListSyncTransactionsResponse withErrorMessage(Optional<? extends io.codat.sync_for_expenses.models.shared.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * Success
     */
    public ListSyncTransactionsResponse withTransactions(io.codat.sync_for_expenses.models.shared.Transactions transactions) {
        Utils.checkNotNull(transactions, "transactions");
     ...
     * Success
     */
    public ListSyncTransactionsResponse withTransactions(Optional<? extends io.codat.sync_for_expenses.models.shared.Transactions> transactions) {
        Utils.checkNotNull(transactions, "transactions");
        this.transactions = transactions;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.sync_for_expenses.models.shared.Transactions> transactions = Optional.empty();  
         ...
         * Success
         */
        public Builder transactions(io.codat.sync_for_expenses.models.shared.Transactions transactions) {
            Utils.checkNotNull(transactions, "transactions");
            this.transactions = Optional.ofNullable(transactions);
            return this;
        }
         ...
         * Success
         */
        public Builder transactions(Optional<? extends io.codat.sync_for_expenses.models.shared.Transactions> transactions) {
            Utils.checkNotNull(transactions, "transactions");
            this.transactions = transactions;
            return this;
        }        
