...
public class ListSuppliersResponse {
     ...
     * Success
     */
    private Optional<? extends io.codat.sync_for_expenses.models.shared.Suppliers> suppliers;
    ...
    public ListSuppliersResponse(
            ...
            Optional<? extends io.codat.sync_for_expenses.models.shared.Suppliers> suppliers) {
     ...
     * Success
     */
    public Optional<? extends io.codat.sync_for_expenses.models.shared.Suppliers> suppliers() {
        return suppliers;
    }
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListSuppliersResponse withErrorMessage(io.codat.sync_for_expenses.models.shared.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListSuppliersResponse withErrorMessage(Optional<? extends io.codat.sync_for_expenses.models.shared.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * Success
     */
    public ListSuppliersResponse withSuppliers(io.codat.sync_for_expenses.models.shared.Suppliers suppliers) {
        Utils.checkNotNull(suppliers, "suppliers");
     ...
     * Success
     */
    public ListSuppliersResponse withSuppliers(Optional<? extends io.codat.sync_for_expenses.models.shared.Suppliers> suppliers) {
        Utils.checkNotNull(suppliers, "suppliers");
        this.suppliers = suppliers;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.sync_for_expenses.models.shared.Suppliers> suppliers = Optional.empty();  
         ...
         * Success
         */
        public Builder suppliers(io.codat.sync_for_expenses.models.shared.Suppliers suppliers) {
            Utils.checkNotNull(suppliers, "suppliers");
            this.suppliers = Optional.ofNullable(suppliers);
            return this;
        }
         ...
         * Success
         */
        public Builder suppliers(Optional<? extends io.codat.sync_for_expenses.models.shared.Suppliers> suppliers) {
            Utils.checkNotNull(suppliers, "suppliers");
            this.suppliers = suppliers;
            return this;
        }        
