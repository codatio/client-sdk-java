...
import io.codat.sync_for_expenses.utils.SpeakeasyHTTPClient;
...
public class CodatSyncExpenses {
    ...
    public static class Builder {
         ...
         * @return The builder instance.
         */
        public Builder security(io.codat.sync_for_expenses.models.shared.Security security) {
        ...
        public Builder serverURL(String serverUrl, java.util.Map<String, String> params) {
            this.sdkConfiguration.serverUrl = io.codat.sync_for_expenses.utils.Utils.templateUrl(serverUrl, params);
            return this;
        }
         ...
         */
        public CodatSyncExpenses build() throws Exception {
    ...
    private CodatSyncExpenses(SDKConfiguration sdkConfiguration) throws Exception {
