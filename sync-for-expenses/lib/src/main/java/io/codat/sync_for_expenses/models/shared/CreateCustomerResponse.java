...
public class CreateCustomerResponse {
    ...
    public JsonNullable<? extends AccountingCustomer> data() {
        return data;
    }
     ...
     * Contains a single entry that communicates which record has changed and the manner in which it changed. 
     */
    public CreateCustomerResponse withChanges(java.util.List<PushOperationChange> changes) {
        Utils.checkNotNull(changes, "changes");
     ...
     * Contains a single entry that communicates which record has changed and the manner in which it changed. 
     */
    public CreateCustomerResponse withChanges(JsonNullable<? extends java.util.List<PushOperationChange>> changes) {
        Utils.checkNotNull(changes, "changes");
        this.changes = changes;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CreateCustomerResponse withCompletedOnUtc(Optional<? extends String> completedOnUtc) {
        Utils.checkNotNull(completedOnUtc, "completedOnUtc");
        this.completedOnUtc = completedOnUtc;
        return this;
    }
     ...
     * A message about the error.
     */
    public CreateCustomerResponse withErrorMessage(JsonNullable<? extends String> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * Number of minutes the push operation must complete within before it times out.
     */
    public CreateCustomerResponse withTimeoutInMinutes(JsonNullable<? extends Integer> timeoutInMinutes) {
        Utils.checkNotNull(timeoutInMinutes, "timeoutInMinutes");
        this.timeoutInMinutes = timeoutInMinutes;
        return this;
    }
     ...
     */
    @Deprecated
    public CreateCustomerResponse withTimeoutInSeconds(JsonNullable<? extends Integer> timeoutInSeconds) {
        Utils.checkNotNull(timeoutInSeconds, "timeoutInSeconds");
        this.timeoutInSeconds = timeoutInSeconds;
        return this;
    }
