...
public class GetCreateChartOfAccountsModelResponse {
     ...
     * OK
     */
    private Optional<? extends io.codat.sync_for_expenses.models.shared.PushOption> pushOption;
    ...
    public GetCreateChartOfAccountsModelResponse(
            ...
            Optional<? extends io.codat.sync_for_expenses.models.shared.PushOption> pushOption,
            int statusCode,
     ...
     * OK
     */
    public Optional<? extends io.codat.sync_for_expenses.models.shared.PushOption> pushOption() {
        return pushOption;
    }
     ...
     * Your API request was not properly authorized.
     */
    public GetCreateChartOfAccountsModelResponse withErrorMessage(io.codat.sync_for_expenses.models.shared.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public GetCreateChartOfAccountsModelResponse withErrorMessage(Optional<? extends io.codat.sync_for_expenses.models.shared.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * OK
     */
    public GetCreateChartOfAccountsModelResponse withPushOption(io.codat.sync_for_expenses.models.shared.PushOption pushOption) {
        Utils.checkNotNull(pushOption, "pushOption");
     ...
     * OK
     */
    public GetCreateChartOfAccountsModelResponse withPushOption(Optional<? extends io.codat.sync_for_expenses.models.shared.PushOption> pushOption) {
        Utils.checkNotNull(pushOption, "pushOption");
        this.pushOption = pushOption;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.sync_for_expenses.models.shared.PushOption> pushOption = Optional.empty();
         ...
         * OK
         */
        public Builder pushOption(io.codat.sync_for_expenses.models.shared.PushOption pushOption) {
            Utils.checkNotNull(pushOption, "pushOption");
            this.pushOption = Optional.ofNullable(pushOption);
            return this;
        }
         ...
         * OK
         */
        public Builder pushOption(Optional<? extends io.codat.sync_for_expenses.models.shared.PushOption> pushOption) {
            Utils.checkNotNull(pushOption, "pushOption");
            this.pushOption = pushOption;
            return this;
        }
