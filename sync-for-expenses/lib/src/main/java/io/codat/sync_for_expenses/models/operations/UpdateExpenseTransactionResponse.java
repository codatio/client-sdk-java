...
public class UpdateExpenseTransactionResponse {
     ...
     * Accepted
     */
    private Optional<? extends io.codat.sync_for_expenses.models.shared.UpdateExpenseResponse> updateExpenseResponse;
    ...
    public UpdateExpenseTransactionResponse(
            ...
            Optional<? extends io.codat.sync_for_expenses.models.shared.UpdateExpenseResponse> updateExpenseResponse) {
     ...
     * Accepted
     */
    public Optional<? extends io.codat.sync_for_expenses.models.shared.UpdateExpenseResponse> updateExpenseResponse() {
     ...
     * The request made is not valid.
     */
    public UpdateExpenseTransactionResponse withErrorMessage(io.codat.sync_for_expenses.models.shared.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * The request made is not valid.
     */
    public UpdateExpenseTransactionResponse withErrorMessage(Optional<? extends io.codat.sync_for_expenses.models.shared.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * Accepted
     */
    public UpdateExpenseTransactionResponse withUpdateExpenseResponse(io.codat.sync_for_expenses.models.shared.UpdateExpenseResponse updateExpenseResponse) {
        Utils.checkNotNull(updateExpenseResponse, "updateExpenseResponse");
     ...
     * Accepted
     */
    public UpdateExpenseTransactionResponse withUpdateExpenseResponse(Optional<? extends io.codat.sync_for_expenses.models.shared.UpdateExpenseResponse> updateExpenseResponse) {
        Utils.checkNotNull(updateExpenseResponse, "updateExpenseResponse");
        this.updateExpenseResponse = updateExpenseResponse;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.sync_for_expenses.models.shared.UpdateExpenseResponse> updateExpenseResponse = Optional.empty();  
         ...
         * Accepted
         */
        public Builder updateExpenseResponse(io.codat.sync_for_expenses.models.shared.UpdateExpenseResponse updateExpenseResponse) {
            Utils.checkNotNull(updateExpenseResponse, "updateExpenseResponse");
            this.updateExpenseResponse = Optional.ofNullable(updateExpenseResponse);
            return this;
        }
         ...
         * Accepted
         */
        public Builder updateExpenseResponse(Optional<? extends io.codat.sync_for_expenses.models.shared.UpdateExpenseResponse> updateExpenseResponse) {
            Utils.checkNotNull(updateExpenseResponse, "updateExpenseResponse");
            this.updateExpenseResponse = updateExpenseResponse;
            return this;
        }        
