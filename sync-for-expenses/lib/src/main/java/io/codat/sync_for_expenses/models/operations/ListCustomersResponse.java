...
public class ListCustomersResponse {
     ...
     * Success
     */
    private Optional<? extends io.codat.sync_for_expenses.models.shared.Customers> customers;
    ...
    public ListCustomersResponse(
            String contentType,
            Optional<? extends io.codat.sync_for_expenses.models.shared.Customers> customers,
     ...
     * Success
     */
    public Optional<? extends io.codat.sync_for_expenses.models.shared.Customers> customers() {
        return customers;
    }
     ...
     * Success
     */
    public ListCustomersResponse withCustomers(io.codat.sync_for_expenses.models.shared.Customers customers) {
        Utils.checkNotNull(customers, "customers");
     ...
     * Success
     */
    public ListCustomersResponse withCustomers(Optional<? extends io.codat.sync_for_expenses.models.shared.Customers> customers) {
        Utils.checkNotNull(customers, "customers");
        this.customers = customers;
        return this;
    }
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListCustomersResponse withErrorMessage(io.codat.sync_for_expenses.models.shared.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListCustomersResponse withErrorMessage(Optional<? extends io.codat.sync_for_expenses.models.shared.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.sync_for_expenses.models.shared.Customers> customers = Optional.empty();
         ...
         * Success
         */
        public Builder customers(io.codat.sync_for_expenses.models.shared.Customers customers) {
            Utils.checkNotNull(customers, "customers");
            this.customers = Optional.ofNullable(customers);
            return this;
        }
         ...
         * Success
         */
        public Builder customers(Optional<? extends io.codat.sync_for_expenses.models.shared.Customers> customers) {
            Utils.checkNotNull(customers, "customers");
            this.customers = customers;
            return this;
        }
