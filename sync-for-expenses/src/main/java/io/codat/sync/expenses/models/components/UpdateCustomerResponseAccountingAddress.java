...
public class UpdateCustomerResponseAccountingAddress {
     ...
     * City of the customer address.
     */
    public UpdateCustomerResponseAccountingAddress withCity(JsonNullable<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
     ...
     * Country of the customer address.
     */
    public UpdateCustomerResponseAccountingAddress withCountry(JsonNullable<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
     ...
     * Line 1 of the customer address.
     */
    public UpdateCustomerResponseAccountingAddress withLine1(JsonNullable<String> line1) {
        Utils.checkNotNull(line1, "line1");
        this.line1 = line1;
        return this;
    }
     ...
     * Line 2 of the customer address.
     */
    public UpdateCustomerResponseAccountingAddress withLine2(JsonNullable<String> line2) {
        Utils.checkNotNull(line2, "line2");
        this.line2 = line2;
        return this;
    }
     ...
     * Postal code or zip code.
     */
    public UpdateCustomerResponseAccountingAddress withPostalCode(JsonNullable<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
     ...
     * Region of the customer address.
     */
    public UpdateCustomerResponseAccountingAddress withRegion(JsonNullable<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
