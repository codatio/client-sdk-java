...
public class CreateConnectionResponse implements io.codat.sync.expenses.utils.Response {
     ...
     * OK
     */
    public CreateConnectionResponse withConnection(io.codat.sync.expenses.models.components.Connection connection) {
        Utils.checkNotNull(connection, "connection");
     ...
     * OK
     */
    public CreateConnectionResponse withConnection(Optional<? extends io.codat.sync.expenses.models.components.Connection> connection) {
        Utils.checkNotNull(connection, "connection");
        this.connection = connection;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public CreateConnectionResponse withErrorMessage(io.codat.sync.expenses.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public CreateConnectionResponse withErrorMessage(Optional<? extends io.codat.sync.expenses.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
