...
public class DeleteConnectionRequestBuilder {
    ...
    public DeleteConnectionRequestBuilder request(io.codat.sync.expenses.models.operations.DeleteConnectionRequest request) {
    ...
    public DeleteConnectionRequestBuilder retryConfig(java.util.Optional<io.codat.sync.expenses.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
