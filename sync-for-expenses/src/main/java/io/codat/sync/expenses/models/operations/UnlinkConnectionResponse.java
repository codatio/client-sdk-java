...
public class UnlinkConnectionResponse implements Response {
     ...
     * OK
     */
    public UnlinkConnectionResponse withConnection(Connection connection) {
        Utils.checkNotNull(connection, "connection");
     ...
     * OK
     */
    public UnlinkConnectionResponse withConnection(Optional<? extends Connection> connection) {
        Utils.checkNotNull(connection, "connection");
        this.connection = connection;
        return this;
    }
