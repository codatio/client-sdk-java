...
public class SyncFailedWebhook {
    ...
    public SyncFailedWebhook(
            ...
            @JsonProperty("Data") Optional<? extends SyncFailedWebhookData> data,
    ...
    @JsonIgnore
    public Optional<SyncFailedWebhookData> data() {
        return (Optional<SyncFailedWebhookData>) data;
    }
     ...
     * Unique identifier of the webhook event.
     */
    public SyncFailedWebhook withAlertId(String alertId) {
        Utils.checkNotNull(alertId, "alertId");
     ...
     * Unique identifier of the webhook event.
     */
    public SyncFailedWebhook withAlertId(Optional<String> alertId) {
        Utils.checkNotNull(alertId, "alertId");
        this.alertId = alertId;
        return this;
    }
     ...
     * Unique identifier for your client in Codat.
     */
    public SyncFailedWebhook withClientId(String clientId) {
        Utils.checkNotNull(clientId, "clientId");
     ...
     * Unique identifier for your client in Codat.
     */
    public SyncFailedWebhook withClientId(Optional<String> clientId) {
        Utils.checkNotNull(clientId, "clientId");
        this.clientId = clientId;
        return this;
    }
     ...
     * Name of your client in Codat.
     */
    public SyncFailedWebhook withClientName(String clientName) {
        Utils.checkNotNull(clientName, "clientName");
     ...
     * Name of your client in Codat.
     */
    public SyncFailedWebhook withClientName(Optional<String> clientName) {
        Utils.checkNotNull(clientName, "clientName");
        this.clientName = clientName;
        return this;
    }
     ...
     * Unique identifier for your SMB in Codat.
     */
    public SyncFailedWebhook withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * Unique identifier for your SMB in Codat.
     */
    public SyncFailedWebhook withCompanyId(Optional<String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }

    public SyncFailedWebhook withData(SyncFailedWebhookData data) {
        Utils.checkNotNull(data, "data");
     ...
     * A human-readable message about the webhook.
     */
    public SyncFailedWebhook withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     */
    @Deprecated
    public SyncFailedWebhook withRuleId(Optional<String> ruleId) {
        Utils.checkNotNull(ruleId, "ruleId");
        this.ruleId = ruleId;
        return this;
    }
     ...
     * The type of rule.
     */
    public SyncFailedWebhook withRuleType(String ruleType) {
        Utils.checkNotNull(ruleType, "ruleType");
     ...
     * The type of rule.
     */
    public SyncFailedWebhook withRuleType(Optional<String> ruleType) {
        Utils.checkNotNull(ruleType, "ruleType");
        this.ruleType = ruleType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SyncFailedWebhook other = (SyncFailedWebhook) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SyncFailedWebhook.class,
                "alertId", alertId,
                "clientId", clientId,
    ...
    public final static class Builder {
        ...
        private Optional<? extends SyncFailedWebhookData> data = Optional.empty();
        ...
        public Builder data(SyncFailedWebhookData data) {
            Utils.checkNotNull(data, "data");
            this.data = Optional.ofNullable(data);
            return this;
        }
        ...
        public SyncFailedWebhook build() {
            return new SyncFailedWebhook(
                alertId,
                clientId,
                clientName,
                companyId,
