...
public class CreateCustomerRequest {
    ...
    public CreateCustomerRequest withCustomer(Customer customer) {
        Utils.checkNotNull(customer, "customer");
        this.customer = JsonNullable.of(customer);
        return this;
    }

    public CreateCustomerRequest withCustomer(JsonNullable<? extends Customer> customer) {
        Utils.checkNotNull(customer, "customer");
        this.customer = customer;
        return this;
    }
     ...
     * Allow a sync upon push completion.
     */
    public CreateCustomerRequest withAllowSyncOnPushComplete(Optional<Boolean> allowSyncOnPushComplete) {
        Utils.checkNotNull(allowSyncOnPushComplete, "allowSyncOnPushComplete");
        this.allowSyncOnPushComplete = allowSyncOnPushComplete;
        return this;
    }
     ...
     * Time limit for the push operation to complete before it is timed out.
     */
    public CreateCustomerRequest withTimeoutInMinutes(Optional<Integer> timeoutInMinutes) {
        Utils.checkNotNull(timeoutInMinutes, "timeoutInMinutes");
        this.timeoutInMinutes = timeoutInMinutes;
        return this;
    }
