...
public class CompanyInformation {
     ...
     * Identifier or reference for the company in the accounting software.
     */
    public CompanyInformation withAccountingPlatformRef(String accountingPlatformRef) {
        Utils.checkNotNull(accountingPlatformRef, "accountingPlatformRef");
     ...
     * Identifier or reference for the company in the accounting software.
     */
    public CompanyInformation withAccountingPlatformRef(JsonNullable<String> accountingPlatformRef) {
        Utils.checkNotNull(accountingPlatformRef, "accountingPlatformRef");
        this.accountingPlatformRef = accountingPlatformRef;
        return this;
    }
     ...
     * An array of Addresses.
     */
    public CompanyInformation withAddresses(List<AccountingAddress> addresses) {
        Utils.checkNotNull(addresses, "addresses");
     ...
     * An array of Addresses.
     */
    public CompanyInformation withAddresses(JsonNullable<? extends List<AccountingAddress>> addresses) {
        Utils.checkNotNull(addresses, "addresses");
        this.addresses = addresses;
        return this;
    }
     ...
     * Registered legal name of the linked company.
     */
    public CompanyInformation withCompanyLegalName(String companyLegalName) {
        Utils.checkNotNull(companyLegalName, "companyLegalName");
     ...
     * Registered legal name of the linked company.
     */
    public CompanyInformation withCompanyLegalName(JsonNullable<String> companyLegalName) {
        Utils.checkNotNull(companyLegalName, "companyLegalName");
        this.companyLegalName = companyLegalName;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CompanyInformation withCreatedDate(String createdDate) {
        Utils.checkNotNull(createdDate, "createdDate");
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CompanyInformation withCreatedDate(Optional<String> createdDate) {
        Utils.checkNotNull(createdDate, "createdDate");
        this.createdDate = createdDate;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CompanyInformation withFinancialYearStartDate(String financialYearStartDate) {
        Utils.checkNotNull(financialYearStartDate, "financialYearStartDate");
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CompanyInformation withFinancialYearStartDate(Optional<String> financialYearStartDate) {
        Utils.checkNotNull(financialYearStartDate, "financialYearStartDate");
        this.financialYearStartDate = financialYearStartDate;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CompanyInformation withLedgerLockDate(String ledgerLockDate) {
        Utils.checkNotNull(ledgerLockDate, "ledgerLockDate");
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CompanyInformation withLedgerLockDate(Optional<String> ledgerLockDate) {
        Utils.checkNotNull(ledgerLockDate, "ledgerLockDate");
        this.ledgerLockDate = ledgerLockDate;
        return this;
    }
     ...
     * An array of phone numbers.
     */
    public CompanyInformation withPhoneNumbers(List<Phone> phoneNumbers) {
        Utils.checkNotNull(phoneNumbers, "phoneNumbers");
     ...
     * An array of phone numbers.
     */
    public CompanyInformation withPhoneNumbers(JsonNullable<? extends List<Phone>> phoneNumbers) {
        Utils.checkNotNull(phoneNumbers, "phoneNumbers");
        this.phoneNumbers = phoneNumbers;
        return this;
    }
     ...
     * Registration number given to the linked company by the companies authority in the country of origin. In the UK this is Companies House.
     */
    public CompanyInformation withRegistrationNumber(String registrationNumber) {
        Utils.checkNotNull(registrationNumber, "registrationNumber");
     ...
     * Registration number given to the linked company by the companies authority in the country of origin. In the UK this is Companies House.
     */
    public CompanyInformation withRegistrationNumber(JsonNullable<String> registrationNumber) {
        Utils.checkNotNull(registrationNumber, "registrationNumber");
        this.registrationNumber = registrationNumber;
        return this;
    }
     ...
     * For example, for Xero integrations two URLs are returned. These have many potential use cases, such as [deep linking](https://developer.xero.com/documentation/api-guides/deep-link-xero).
     */
    public CompanyInformation withSourceUrls(Map<String, String> sourceUrls) {
        Utils.checkNotNull(sourceUrls, "sourceUrls");
     ...
     * For example, for Xero integrations two URLs are returned. These have many potential use cases, such as [deep linking](https://developer.xero.com/documentation/api-guides/deep-link-xero).
     */
    public CompanyInformation withSourceUrls(JsonNullable<? extends Map<String, String>> sourceUrls) {
        Utils.checkNotNull(sourceUrls, "sourceUrls");
        this.sourceUrls = sourceUrls;
        return this;
    }
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting software. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public CompanyInformation withSupplementalData(SupplementalData supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting software. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public CompanyInformation withSupplementalData(Optional<? extends SupplementalData> supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
        this.supplementalData = supplementalData;
        return this;
    }
     ...
     * Company tax number.
     */
    public CompanyInformation withTaxNumber(String taxNumber) {
        Utils.checkNotNull(taxNumber, "taxNumber");
     ...
     * Company tax number.
     */
    public CompanyInformation withTaxNumber(JsonNullable<String> taxNumber) {
        Utils.checkNotNull(taxNumber, "taxNumber");
        this.taxNumber = taxNumber;
        return this;
    }
     ...
     * An array of weblinks.
     */
    public CompanyInformation withWebLinks(List<Weblink> webLinks) {
        Utils.checkNotNull(webLinks, "webLinks");
     ...
     * An array of weblinks.
     */
    public CompanyInformation withWebLinks(JsonNullable<? extends List<Weblink>> webLinks) {
        Utils.checkNotNull(webLinks, "webLinks");
        this.webLinks = webLinks;
        return this;
    }
