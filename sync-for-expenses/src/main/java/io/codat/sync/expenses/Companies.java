...
import io.codat.sync.expenses.models.components.Company;
...
import io.codat.sync.expenses.models.operations.CreateCompanyRequestBuilder;
...
import io.codat.sync.expenses.models.operations.DeleteCompanyRequestBuilder;
...
import io.codat.sync.expenses.models.operations.GetCompanyRequestBuilder;
...
import io.codat.sync.expenses.models.operations.ListCompaniesRequestBuilder;
...
import io.codat.sync.expenses.models.operations.UpdateCompanyRequestBuilder;
...
public class Companies implements
    ...
    public ListCompaniesResponse list(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                io.codat.sync.expenses.models.components.Companies _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
