...
public class ReimbursableExpenseTransaction {
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public ReimbursableExpenseTransaction withDueDate(String dueDate) {
        Utils.checkNotNull(dueDate, "dueDate");
        this.dueDate = dueDate;
        return this;
    }
     ...
     * Array of transaction lines.
     */
    public ReimbursableExpenseTransaction withLines(List<ReimbursableExpenseTransactionLine> lines) {
        Utils.checkNotNull(lines, "lines");
     ...
     * Array of transaction lines.
     */
    public ReimbursableExpenseTransaction withLines(Optional<? extends List<ReimbursableExpenseTransactionLine>> lines) {
        Utils.checkNotNull(lines, "lines");
        this.lines = lines;
        return this;
    }
     ...
     * Any private, company notes about the transaction.
     */
    public ReimbursableExpenseTransaction withNotes(Optional<String> notes) {
        Utils.checkNotNull(notes, "notes");
        this.notes = notes;
        return this;
    }
     ...
     * User-friendly reference for the reimbursable expense.
     */
    public ReimbursableExpenseTransaction withReference(JsonNullable<String> reference) {
        Utils.checkNotNull(reference, "reference");
        this.reference = reference;
        return this;
    }
