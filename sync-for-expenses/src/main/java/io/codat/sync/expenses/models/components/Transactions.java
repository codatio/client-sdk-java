...
public class Transactions {
    ...
    private Optional<? extends java.util.List<Transaction>> results;
    ...
    public Transactions(
            ...
            @JsonProperty("results") Optional<? extends java.util.List<Transaction>> results,
    ...
    public Optional<? extends java.util.List<Transaction>> results() {
        return results;
    }
    ...
    public Transactions withResults(java.util.List<Transaction> results) {
        Utils.checkNotNull(results, "results");
        this.results = Optional.ofNullable(results);
        return this;
    }

    public Transactions withResults(Optional<? extends java.util.List<Transaction>> results) {
        Utils.checkNotNull(results, "results");
        this.results = results;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends java.util.List<Transaction>> results = Optional.empty();
        ...
        public Builder results(java.util.List<Transaction> results) {
            Utils.checkNotNull(results, "results");
            this.results = Optional.ofNullable(results);
            return this;
        }

        public Builder results(Optional<? extends java.util.List<Transaction>> results) {
            Utils.checkNotNull(results, "results");
            this.results = results;
            return this;
        }
