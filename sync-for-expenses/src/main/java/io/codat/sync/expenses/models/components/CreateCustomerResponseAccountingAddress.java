...
public class CreateCustomerResponseAccountingAddress {
    ...
    public CreateCustomerResponseAccountingAddress(
     ...
     * City of the customer address.
     */
    public CreateCustomerResponseAccountingAddress withCity(String city) {
        Utils.checkNotNull(city, "city");
     ...
     * City of the customer address.
     */
    public CreateCustomerResponseAccountingAddress withCity(JsonNullable<? extends String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
     ...
     * Country of the customer address.
     */
    public CreateCustomerResponseAccountingAddress withCountry(String country) {
        Utils.checkNotNull(country, "country");
     ...
     * Country of the customer address.
     */
    public CreateCustomerResponseAccountingAddress withCountry(JsonNullable<? extends String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
     ...
     * Line 1 of the customer address.
     */
    public CreateCustomerResponseAccountingAddress withLine1(String line1) {
        Utils.checkNotNull(line1, "line1");
     ...
     * Line 1 of the customer address.
     */
    public CreateCustomerResponseAccountingAddress withLine1(JsonNullable<? extends String> line1) {
        Utils.checkNotNull(line1, "line1");
        this.line1 = line1;
        return this;
    }
     ...
     * Line 2 of the customer address.
     */
    public CreateCustomerResponseAccountingAddress withLine2(String line2) {
        Utils.checkNotNull(line2, "line2");
     ...
     * Line 2 of the customer address.
     */
    public CreateCustomerResponseAccountingAddress withLine2(JsonNullable<? extends String> line2) {
        Utils.checkNotNull(line2, "line2");
        this.line2 = line2;
        return this;
    }
     ...
     * Postal code or zip code.
     */
    public CreateCustomerResponseAccountingAddress withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
     ...
     * Postal code or zip code.
     */
    public CreateCustomerResponseAccountingAddress withPostalCode(JsonNullable<? extends String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
     ...
     * Region of the customer address.
     */
    public CreateCustomerResponseAccountingAddress withRegion(String region) {
        Utils.checkNotNull(region, "region");
     ...
     * Region of the customer address.
     */
    public CreateCustomerResponseAccountingAddress withRegion(JsonNullable<? extends String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
     ...
     * The type of the address
     */
    public CreateCustomerResponseAccountingAddress withType(AccountingAddressType type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateCustomerResponseAccountingAddress other = (CreateCustomerResponseAccountingAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateCustomerResponseAccountingAddress.class,
                "city", city,
                "country", country,
                "line1", line1,
                "line2", line2,
    ...
    public final static class Builder {
        ...
        public CreateCustomerResponseAccountingAddress build() {
            return new CreateCustomerResponseAccountingAddress(
                city,
                country,
                line1,
                line2,
