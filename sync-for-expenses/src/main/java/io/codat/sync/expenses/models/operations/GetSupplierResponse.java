...
public class GetSupplierResponse implements io.codat.sync.expenses.utils.Response {
     ...
     * Your API request was not properly authorized.
     */
    public GetSupplierResponse withErrorMessage(io.codat.sync.expenses.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public GetSupplierResponse withErrorMessage(Optional<? extends io.codat.sync.expenses.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * Success
     */
    public GetSupplierResponse withSupplier(io.codat.sync.expenses.models.components.Supplier supplier) {
        Utils.checkNotNull(supplier, "supplier");
     ...
     * Success
     */
    public GetSupplierResponse withSupplier(JsonNullable<? extends io.codat.sync.expenses.models.components.Supplier> supplier) {
        Utils.checkNotNull(supplier, "supplier");
        this.supplier = supplier;
        return this;
    }
