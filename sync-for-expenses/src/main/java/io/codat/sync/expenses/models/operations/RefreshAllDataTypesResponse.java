...
public class RefreshAllDataTypesResponse implements io.codat.sync.expenses.utils.Response {
     ...
     * Your API request was not properly authorized.
     */
    public RefreshAllDataTypesResponse withErrorMessage(io.codat.sync.expenses.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public RefreshAllDataTypesResponse withErrorMessage(Optional<? extends io.codat.sync.expenses.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
