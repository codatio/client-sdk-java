...
public class UpdateCustomerResponseAccountingCustomer {
    ...
    private JsonNullable<? extends java.util.List<UpdateCustomerResponseAccountingAddress>> addresses;
    ...
    public UpdateCustomerResponseAccountingCustomer(
            @JsonProperty("addresses") JsonNullable<? extends java.util.List<UpdateCustomerResponseAccountingAddress>> addresses,
     ...
     * An array of Addresses.
     */
    public JsonNullable<? extends java.util.List<UpdateCustomerResponseAccountingAddress>> addresses() {
        return addresses;
    }
     ...
     * An array of Addresses.
     */
    public UpdateCustomerResponseAccountingCustomer withAddresses(java.util.List<UpdateCustomerResponseAccountingAddress> addresses) {
        Utils.checkNotNull(addresses, "addresses");
     ...
     * An array of Addresses.
     */
    public UpdateCustomerResponseAccountingCustomer withAddresses(JsonNullable<? extends java.util.List<UpdateCustomerResponseAccountingAddress>> addresses) {
        Utils.checkNotNull(addresses, "addresses");
        this.addresses = addresses;
        return this;
    }
     ...
     * Name of the main contact for the identified customer.
     */
    public UpdateCustomerResponseAccountingCustomer withContactName(String contactName) {
        Utils.checkNotNull(contactName, "contactName");
     ...
     * Name of the main contact for the identified customer.
     */
    public UpdateCustomerResponseAccountingCustomer withContactName(JsonNullable<? extends String> contactName) {
        Utils.checkNotNull(contactName, "contactName");
        this.contactName = contactName;
        return this;
    }
     ...
     * An array of Contacts.
     */
    public UpdateCustomerResponseAccountingCustomer withContacts(java.util.List<Contact> contacts) {
        Utils.checkNotNull(contacts, "contacts");
     ...
     * An array of Contacts.
     */
    public UpdateCustomerResponseAccountingCustomer withContacts(JsonNullable<? extends java.util.List<Contact>> contacts) {
        Utils.checkNotNull(contacts, "contacts");
        this.contacts = contacts;
        return this;
    }
     ...
     * Name of the customer as recorded in the accounting system, typically the company name.
     */
    public UpdateCustomerResponseAccountingCustomer withCustomerName(String customerName) {
        Utils.checkNotNull(customerName, "customerName");
     ...
     * Name of the customer as recorded in the accounting system, typically the company name.
     */
    public UpdateCustomerResponseAccountingCustomer withCustomerName(JsonNullable<? extends String> customerName) {
        Utils.checkNotNull(customerName, "customerName");
        this.customerName = customerName;
        return this;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public UpdateCustomerResponseAccountingCustomer withDefaultCurrency(String defaultCurrency) {
        Utils.checkNotNull(defaultCurrency, "defaultCurrency");
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public UpdateCustomerResponseAccountingCustomer withDefaultCurrency(Optional<? extends String> defaultCurrency) {
        Utils.checkNotNull(defaultCurrency, "defaultCurrency");
        this.defaultCurrency = defaultCurrency;
        return this;
    }
     ...
     * Email address the customer can be contacted by.
     */
    public UpdateCustomerResponseAccountingCustomer withEmailAddress(String emailAddress) {
        Utils.checkNotNull(emailAddress, "emailAddress");
     ...
     * Email address the customer can be contacted by.
     */
    public UpdateCustomerResponseAccountingCustomer withEmailAddress(JsonNullable<? extends String> emailAddress) {
        Utils.checkNotNull(emailAddress, "emailAddress");
        this.emailAddress = emailAddress;
        return this;
    }
     ...
     * Identifier for the customer, unique to the company in the accounting platform.
     */
    public UpdateCustomerResponseAccountingCustomer withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Identifier for the customer, unique to the company in the accounting platform.
     */
    public UpdateCustomerResponseAccountingCustomer withId(Optional<? extends String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public UpdateCustomerResponseAccountingCustomer withMetadata(Metadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = Optional.ofNullable(metadata);
        return this;
    }
    
    public UpdateCustomerResponseAccountingCustomer withMetadata(Optional<? extends Metadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }

    public UpdateCustomerResponseAccountingCustomer withModifiedDate(String modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = Optional.ofNullable(modifiedDate);
        return this;
    }
    
    public UpdateCustomerResponseAccountingCustomer withModifiedDate(Optional<? extends String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Phone number the customer can be contacted by.
     */
    public UpdateCustomerResponseAccountingCustomer withPhone(String phone) {
        Utils.checkNotNull(phone, "phone");
     ...
     * Phone number the customer can be contacted by.
     */
    public UpdateCustomerResponseAccountingCustomer withPhone(JsonNullable<? extends String> phone) {
        Utils.checkNotNull(phone, "phone");
        this.phone = phone;
        return this;
    }
     ...
     * Company number. In the UK, this is typically the Companies House company registration number.
     */
    public UpdateCustomerResponseAccountingCustomer withRegistrationNumber(String registrationNumber) {
        Utils.checkNotNull(registrationNumber, "registrationNumber");
     ...
     * Company number. In the UK, this is typically the Companies House company registration number.
     */
    public UpdateCustomerResponseAccountingCustomer withRegistrationNumber(JsonNullable<? extends String> registrationNumber) {
        Utils.checkNotNull(registrationNumber, "registrationNumber");
        this.registrationNumber = registrationNumber;
        return this;
    }

    public UpdateCustomerResponseAccountingCustomer withSourceModifiedDate(String sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = Optional.ofNullable(sourceModifiedDate);
        return this;
    }
    
    public UpdateCustomerResponseAccountingCustomer withSourceModifiedDate(Optional<? extends String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * Status of customer.
     */
    public UpdateCustomerResponseAccountingCustomer withStatus(CustomerStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting platform. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public UpdateCustomerResponseAccountingCustomer withSupplementalData(SupplementalData supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting platform. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public UpdateCustomerResponseAccountingCustomer withSupplementalData(Optional<? extends SupplementalData> supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
        this.supplementalData = supplementalData;
        return this;
    }
     ...
     * Company tax number.
     */
    public UpdateCustomerResponseAccountingCustomer withTaxNumber(String taxNumber) {
        Utils.checkNotNull(taxNumber, "taxNumber");
     ...
     * Company tax number.
     */
    public UpdateCustomerResponseAccountingCustomer withTaxNumber(JsonNullable<? extends String> taxNumber) {
        Utils.checkNotNull(taxNumber, "taxNumber");
        this.taxNumber = taxNumber;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateCustomerResponseAccountingCustomer other = (UpdateCustomerResponseAccountingCustomer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateCustomerResponseAccountingCustomer.class,
                "addresses", addresses,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends java.util.List<UpdateCustomerResponseAccountingAddress>> addresses = JsonNullable.undefined();
         ...
         * An array of Addresses.
         */
        public Builder addresses(java.util.List<UpdateCustomerResponseAccountingAddress> addresses) {
            Utils.checkNotNull(addresses, "addresses");
            this.addresses = JsonNullable.of(addresses);
            return this;
        }
         ...
         * An array of Addresses.
         */
        public Builder addresses(JsonNullable<? extends java.util.List<UpdateCustomerResponseAccountingAddress>> addresses) {
            Utils.checkNotNull(addresses, "addresses");
            this.addresses = addresses;
            return this;
        }
        ...
        public UpdateCustomerResponseAccountingCustomer build() {
            return new UpdateCustomerResponseAccountingCustomer(
                addresses,
                contactName,
                contacts,
                customerName,
