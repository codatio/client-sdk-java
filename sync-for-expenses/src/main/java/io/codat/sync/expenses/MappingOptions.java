...
import io.codat.sync.expenses.models.operations.GetMappingOptionsRequestBuilder;
 ...
 */
public class MappingOptions implements
            MethodCallGetMappingOptions {

    private final SDKConfiguration sdkConfiguration;

    MappingOptions(SDKConfiguration sdkConfiguration) {
     ...
     */
    public GetMappingOptionsRequestBuilder getMappingOptions() {
        return new GetMappingOptionsRequestBuilder(this);
    }
     ...
     */
    public GetMappingOptionsResponse getMappingOptions(
            GetMappingOptionsRequest request) throws Exception {
        return getMappingOptions(request, Optional.empty());
    }
    ...
    public GetMappingOptionsResponse getMappingOptions(
        ...
        String _url = Utils.generateURL(
                GetMappingOptionsRequest.class,
                _baseUrl,
        ...
        GetMappingOptionsResponse.Builder _resBuilder = 
        ...
        GetMappingOptionsResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                io.codat.sync.expenses.models.components.MappingOptions _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<io.codat.sync.expenses.models.components.MappingOptions>() {});
                _res.withMappingOptions(Optional.ofNullable(_out));
                return _res;
            } else {
                throw new SDKError(
                    _httpRes, 
