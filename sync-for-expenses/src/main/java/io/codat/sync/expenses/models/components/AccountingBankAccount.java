...
public class AccountingBankAccount {
    ...
    private Optional<? extends CreateBankAccountResponseBankAccountType> accountType;
    ...
    public AccountingBankAccount(
            ...
            @JsonProperty("accountType") Optional<? extends CreateBankAccountResponseBankAccountType> accountType,
    ...
    @JsonIgnore
    public Optional<CreateBankAccountResponseBankAccountType> accountType() {
        return (Optional<CreateBankAccountResponseBankAccountType>) accountType;
    }
     ...
     * Name of the bank account in the accounting software.
     */
    public AccountingBankAccount withAccountName(String accountName) {
        Utils.checkNotNull(accountName, "accountName");
     ...
     * Name of the bank account in the accounting software.
     */
    public AccountingBankAccount withAccountName(JsonNullable<String> accountName) {
        Utils.checkNotNull(accountName, "accountName");
        this.accountName = accountName;
        return this;
    }
     ...
     * For Debit accounts, positive balances are assets, and positive transactions **increase** assets.
     */
    public AccountingBankAccount withAccountType(CreateBankAccountResponseBankAccountType accountType) {
        Utils.checkNotNull(accountType, "accountType");
     ...
     * For Debit accounts, positive balances are assets, and positive transactions **increase** assets.
     */
    public AccountingBankAccount withAccountType(Optional<? extends CreateBankAccountResponseBankAccountType> accountType) {
        Utils.checkNotNull(accountType, "accountType");
        this.accountType = accountType;
        return this;
    }
     ...
     * Total available balance of the bank account as reported by the underlying data source. This may take into account overdrafts or pending transactions for example.
     */
    public AccountingBankAccount withAvailableBalance(BigDecimal availableBalance) {
        Utils.checkNotNull(availableBalance, "availableBalance");
     ...
     * Total available balance of the bank account as reported by the underlying data source. This may take into account overdrafts or pending transactions for example.
     */
    public AccountingBankAccount withAvailableBalance(JsonNullable<? extends BigDecimal> availableBalance) {
        Utils.checkNotNull(availableBalance, "availableBalance");
        this.availableBalance = availableBalance;
        return this;
    }
     ...
     * Balance of the bank account.
     */
    public AccountingBankAccount withBalance(BigDecimal balance) {
        Utils.checkNotNull(balance, "balance");
     ...
     * Balance of the bank account.
     */
    public AccountingBankAccount withBalance(JsonNullable<? extends BigDecimal> balance) {
        Utils.checkNotNull(balance, "balance");
        this.balance = balance;
        return this;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public AccountingBankAccount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public AccountingBankAccount withCurrency(Optional<String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * The institution of the bank account.
     */
    public AccountingBankAccount withInstitution(String institution) {
        Utils.checkNotNull(institution, "institution");
     ...
     * The institution of the bank account.
     */
    public AccountingBankAccount withInstitution(JsonNullable<String> institution) {
        Utils.checkNotNull(institution, "institution");
        this.institution = institution;
        return this;
    }

    public AccountingBankAccount withMetadata(Metadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = Optional.ofNullable(metadata);
        return this;
    }

    public AccountingBankAccount withMetadata(Optional<? extends Metadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }

    public AccountingBankAccount withModifiedDate(String modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = Optional.ofNullable(modifiedDate);
        return this;
    }

    public AccountingBankAccount withModifiedDate(Optional<String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Code used to identify each nominal account for a business.
     */
    public AccountingBankAccount withNominalCode(String nominalCode) {
        Utils.checkNotNull(nominalCode, "nominalCode");
     ...
     * Code used to identify each nominal account for a business.
     */
    public AccountingBankAccount withNominalCode(JsonNullable<String> nominalCode) {
        Utils.checkNotNull(nominalCode, "nominalCode");
        this.nominalCode = nominalCode;
        return this;
    }
     ...
     * The value is always positive. For example, an overdraftLimit of `1000` means that the balance of the account can go down to `-1000`.
     */
    public AccountingBankAccount withOverdraftLimit(BigDecimal overdraftLimit) {
        Utils.checkNotNull(overdraftLimit, "overdraftLimit");
     ...
     * The value is always positive. For example, an overdraftLimit of `1000` means that the balance of the account can go down to `-1000`.
     */
    public AccountingBankAccount withOverdraftLimit(JsonNullable<? extends BigDecimal> overdraftLimit) {
        Utils.checkNotNull(overdraftLimit, "overdraftLimit");
        this.overdraftLimit = overdraftLimit;
        return this;
    }
     ...
     * The sort code is only displayed when the currency = GBP and the sort code and account number sum to 14 digits. For non-GBP accounts, this field is not populated.
     */
    public AccountingBankAccount withSortCode(String sortCode) {
        Utils.checkNotNull(sortCode, "sortCode");
     ...
     * The sort code is only displayed when the currency = GBP and the sort code and account number sum to 14 digits. For non-GBP accounts, this field is not populated.
     */
    public AccountingBankAccount withSortCode(JsonNullable<String> sortCode) {
        Utils.checkNotNull(sortCode, "sortCode");
        this.sortCode = sortCode;
        return this;
    }

    public AccountingBankAccount withSourceModifiedDate(String sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = Optional.ofNullable(sourceModifiedDate);
        return this;
    }

    public AccountingBankAccount withSourceModifiedDate(Optional<String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * Status of the bank account.
     */
    public AccountingBankAccount withStatus(BankAccountStatus status) {
        Utils.checkNotNull(status, "status");
     ...
     * Status of the bank account.
     */
    public AccountingBankAccount withStatus(Optional<? extends BankAccountStatus> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting software. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public AccountingBankAccount withSupplementalData(SupplementalData supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting software. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public AccountingBankAccount withSupplementalData(Optional<? extends SupplementalData> supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
        this.supplementalData = supplementalData;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends CreateBankAccountResponseBankAccountType> accountType = Optional.empty();
         ...
         * For Debit accounts, positive balances are assets, and positive transactions **increase** assets.
         */
        public Builder accountType(CreateBankAccountResponseBankAccountType accountType) {
            Utils.checkNotNull(accountType, "accountType");
            this.accountType = Optional.ofNullable(accountType);
            return this;
        }
         ...
         * For Debit accounts, positive balances are assets, and positive transactions **increase** assets.
         */
        public Builder accountType(Optional<? extends CreateBankAccountResponseBankAccountType> accountType) {
            Utils.checkNotNull(accountType, "accountType");
            this.accountType = accountType;
            return this;
        }
