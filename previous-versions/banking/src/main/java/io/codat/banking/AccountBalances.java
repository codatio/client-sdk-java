...
import io.codat.banking.models.operations.ListAccountBalancesRequestBuilder;
...
public class AccountBalances implements
     ...
     */
    public ListAccountBalancesRequestBuilder list() {
        return new ListAccountBalancesRequestBuilder(this);
    }
     ...
     */
    public ListAccountBalancesResponse list(
            ListAccountBalancesRequest request) throws Exception {
    ...
    public ListAccountBalancesResponse list(
        ...
        String _url = Utils.generateURL(
                ListAccountBalancesRequest.class,
                _baseUrl,
        ...
        ListAccountBalancesResponse.Builder _resBuilder = 
        ...
        ListAccountBalancesResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                io.codat.banking.models.components.AccountBalances _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<io.codat.banking.models.components.AccountBalances>() {});
                _res.withAccountBalances(Optional.ofNullable(_out));
                return _res;
            } else {
                throw new SDKError(
                    _httpRes, 
