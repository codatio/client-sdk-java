...
import io.codat.banking.models.operations.GetTransactionCategoryRequestBuilder;
...
import io.codat.banking.models.operations.ListTransactionCategoriesRequestBuilder;
...
public class TransactionCategories implements
     ...
     */
    public GetTransactionCategoryRequestBuilder get() {
        return new GetTransactionCategoryRequestBuilder(this);
    }
     ...
     */
    public GetTransactionCategoryResponse get(
            GetTransactionCategoryRequest request) throws Exception {
    ...
    public GetTransactionCategoryResponse get(
        ...
        String _url = Utils.generateURL(
                GetTransactionCategoryRequest.class,
                _baseUrl,
        ...
        GetTransactionCategoryResponse.Builder _resBuilder = 
        ...
        GetTransactionCategoryResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                TransactionCategory _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<TransactionCategory>() {});
                _res.withTransactionCategory(JsonNullable.of(_out));
                return _res;
            } else {
                throw new SDKError(
                    _httpRes, 
     ...
     * @return The call builder
     */
    public ListTransactionCategoriesRequestBuilder list() {
        return new ListTransactionCategoriesRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public ListTransactionCategoriesResponse list(
            ListTransactionCategoriesRequest request) throws Exception {
    ...
    public ListTransactionCategoriesResponse list(
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                ListTransactionCategoriesRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListTransactionCategoriesResponse.Builder _resBuilder = 
        ...
        ListTransactionCategoriesResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                io.codat.banking.models.components.TransactionCategories _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<io.codat.banking.models.components.TransactionCategories>() {});
                _res.withTransactionCategories(Optional.ofNullable(_out));
                return _res;
            } else {
                throw new SDKError(
                    _httpRes, 
