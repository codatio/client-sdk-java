...
public class ListTransactionsResponse implements Response {
     ...
     * Success
     */
    public ListTransactionsResponse withTransactions(Transactions transactions) {
        Utils.checkNotNull(transactions, "transactions");
     ...
     * Success
     */
    public ListTransactionsResponse withTransactions(Optional<? extends Transactions> transactions) {
        Utils.checkNotNull(transactions, "transactions");
        this.transactions = transactions;
        return this;
    }
