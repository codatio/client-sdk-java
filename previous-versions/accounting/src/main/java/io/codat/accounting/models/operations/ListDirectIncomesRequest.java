...
public class ListDirectIncomesRequest {
    ...
    public ListDirectIncomesRequest(
            String companyId,
            String connectionId,
     ...
     * Unique identifier for a company.
     */
    public ListDirectIncomesRequest withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * Unique identifier for a connection.
     */
    public ListDirectIncomesRequest withConnectionId(String connectionId) {
        Utils.checkNotNull(connectionId, "connectionId");
        this.connectionId = connectionId;
        return this;
    }
     ...
     * Field to order results by. [Read more](https://docs.codat.io/using-the-api/ordering-results).
     */
    public ListDirectIncomesRequest withOrderBy(String orderBy) {
        Utils.checkNotNull(orderBy, "orderBy");
     ...
     * Field to order results by. [Read more](https://docs.codat.io/using-the-api/ordering-results).
     */
    public ListDirectIncomesRequest withOrderBy(Optional<? extends String> orderBy) {
        Utils.checkNotNull(orderBy, "orderBy");
        this.orderBy = orderBy;
        return this;
    }
     ...
     * Page number. [Read more](https://docs.codat.io/using-the-api/paging).
     */
    public ListDirectIncomesRequest withPage(int page) {
        Utils.checkNotNull(page, "page");
     ...
     * Page number. [Read more](https://docs.codat.io/using-the-api/paging).
     */
    public ListDirectIncomesRequest withPage(Optional<? extends Integer> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * Number of records to return in a page. [Read more](https://docs.codat.io/using-the-api/paging).
     */
    public ListDirectIncomesRequest withPageSize(int pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * Number of records to return in a page. [Read more](https://docs.codat.io/using-the-api/paging).
     */
    public ListDirectIncomesRequest withPageSize(Optional<? extends Integer> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * Codat query string. [Read more](https://docs.codat.io/using-the-api/querying).
     */
    public ListDirectIncomesRequest withQuery(String query) {
        Utils.checkNotNull(query, "query");
     ...
     * Codat query string. [Read more](https://docs.codat.io/using-the-api/querying).
     */
    public ListDirectIncomesRequest withQuery(Optional<? extends String> query) {
        Utils.checkNotNull(query, "query");
        this.query = query;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListDirectIncomesRequest other = (ListDirectIncomesRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListDirectIncomesRequest.class,
                "companyId", companyId,
    ...
    public final static class Builder {
        ...
        public ListDirectIncomesRequest build() {
            if (page == null) {
            ...
            return new ListDirectIncomesRequest(
                companyId,
                connectionId,
                orderBy,
                page,
