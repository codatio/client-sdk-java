...
public class GetCreateUpdateBillCreditNotesModelResponse {
    ...
    public GetCreateUpdateBillCreditNotesModelResponse(
            String contentType,
     ...
     * HTTP response content type for this operation
     */
    public GetCreateUpdateBillCreditNotesModelResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public GetCreateUpdateBillCreditNotesModelResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public GetCreateUpdateBillCreditNotesModelResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * OK
     */
    public GetCreateUpdateBillCreditNotesModelResponse withPushOption(io.codat.accounting.models.components.PushOption pushOption) {
        Utils.checkNotNull(pushOption, "pushOption");
     ...
     * OK
     */
    public GetCreateUpdateBillCreditNotesModelResponse withPushOption(Optional<? extends io.codat.accounting.models.components.PushOption> pushOption) {
        Utils.checkNotNull(pushOption, "pushOption");
        this.pushOption = pushOption;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetCreateUpdateBillCreditNotesModelResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetCreateUpdateBillCreditNotesModelResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCreateUpdateBillCreditNotesModelResponse other = (GetCreateUpdateBillCreditNotesModelResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCreateUpdateBillCreditNotesModelResponse.class,
    ...
    public final static class Builder {
        ...
        public GetCreateUpdateBillCreditNotesModelResponse build() {
            return new GetCreateUpdateBillCreditNotesModelResponse(
                contentType,
                errorMessage,
                pushOption,
                statusCode,
