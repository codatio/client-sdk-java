...
public class CreateBillPaymentRequest {
    ...
    public CreateBillPaymentRequest withBillPayment(io.codat.accounting.models.components.BillPayment billPayment) {
        Utils.checkNotNull(billPayment, "billPayment");
        this.billPayment = JsonNullable.of(billPayment);
        return this;
    }

    public CreateBillPaymentRequest withBillPayment(JsonNullable<? extends io.codat.accounting.models.components.BillPayment> billPayment) {
        Utils.checkNotNull(billPayment, "billPayment");
        this.billPayment = billPayment;
        return this;
    }
     ...
     * Time limit for the push operation to complete before it is timed out.
     */
    public CreateBillPaymentRequest withTimeoutInMinutes(Optional<? extends Integer> timeoutInMinutes) {
        Utils.checkNotNull(timeoutInMinutes, "timeoutInMinutes");
        this.timeoutInMinutes = timeoutInMinutes;
        return this;
    }
