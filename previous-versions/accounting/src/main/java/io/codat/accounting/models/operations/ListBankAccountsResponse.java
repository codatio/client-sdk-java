...
public class ListBankAccountsResponse {
     ...
     * Success
     */
    private Optional<? extends io.codat.accounting.models.components.BankAccounts> bankAccounts;
    ...
    public ListBankAccountsResponse(
            Optional<? extends io.codat.accounting.models.components.BankAccounts> bankAccounts,
            String contentType,
     ...
     * Success
     */
    public Optional<? extends io.codat.accounting.models.components.BankAccounts> bankAccounts() {
        return bankAccounts;
    }
     ...
     * Success
     */
    public ListBankAccountsResponse withBankAccounts(io.codat.accounting.models.components.BankAccounts bankAccounts) {
        Utils.checkNotNull(bankAccounts, "bankAccounts");
     ...
     * Success
     */
    public ListBankAccountsResponse withBankAccounts(Optional<? extends io.codat.accounting.models.components.BankAccounts> bankAccounts) {
        Utils.checkNotNull(bankAccounts, "bankAccounts");
        this.bankAccounts = bankAccounts;
        return this;
    }
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListBankAccountsResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListBankAccountsResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.accounting.models.components.BankAccounts> bankAccounts = Optional.empty();
         ...
         * Success
         */
        public Builder bankAccounts(io.codat.accounting.models.components.BankAccounts bankAccounts) {
            Utils.checkNotNull(bankAccounts, "bankAccounts");
            this.bankAccounts = Optional.ofNullable(bankAccounts);
            return this;
        }
         ...
         * Success
         */
        public Builder bankAccounts(Optional<? extends io.codat.accounting.models.components.BankAccounts> bankAccounts) {
            Utils.checkNotNull(bankAccounts, "bankAccounts");
            this.bankAccounts = bankAccounts;
            return this;
        }
