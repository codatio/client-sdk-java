...
public class AgedCreditor {
    ...
    private Optional<? extends List<AccountingAgedCurrencyOutstanding>> agedCurrencyOutstanding;
    ...
    @JsonCreator
    public AgedCreditor(
            @JsonProperty("agedCurrencyOutstanding") Optional<? extends List<AccountingAgedCurrencyOutstanding>> agedCurrencyOutstanding,
    ...
    @JsonIgnore
    public Optional<List<AccountingAgedCurrencyOutstanding>> agedCurrencyOutstanding() {
        return (Optional<List<AccountingAgedCurrencyOutstanding>>) agedCurrencyOutstanding;
    }
     ...
     * Array of aged creditors by currency.
     */
    public AgedCreditor withAgedCurrencyOutstanding(List<AccountingAgedCurrencyOutstanding> agedCurrencyOutstanding) {
        Utils.checkNotNull(agedCurrencyOutstanding, "agedCurrencyOutstanding");
     ...
     * Array of aged creditors by currency.
     */
    public AgedCreditor withAgedCurrencyOutstanding(Optional<? extends List<AccountingAgedCurrencyOutstanding>> agedCurrencyOutstanding) {
        Utils.checkNotNull(agedCurrencyOutstanding, "agedCurrencyOutstanding");
        this.agedCurrencyOutstanding = agedCurrencyOutstanding;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<AccountingAgedCurrencyOutstanding>> agedCurrencyOutstanding = Optional.empty();
         ...
         * Array of aged creditors by currency.
         */
        public Builder agedCurrencyOutstanding(List<AccountingAgedCurrencyOutstanding> agedCurrencyOutstanding) {
            Utils.checkNotNull(agedCurrencyOutstanding, "agedCurrencyOutstanding");
            this.agedCurrencyOutstanding = Optional.ofNullable(agedCurrencyOutstanding);
            return this;
        }
         ...
         * Array of aged creditors by currency.
         */
        public Builder agedCurrencyOutstanding(Optional<? extends List<AccountingAgedCurrencyOutstanding>> agedCurrencyOutstanding) {
            Utils.checkNotNull(agedCurrencyOutstanding, "agedCurrencyOutstanding");
            this.agedCurrencyOutstanding = agedCurrencyOutstanding;
            return this;
        }
