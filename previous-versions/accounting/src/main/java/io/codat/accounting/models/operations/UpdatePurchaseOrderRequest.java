...
public class UpdatePurchaseOrderRequest {
    ...
    public UpdatePurchaseOrderRequest(
            ...
            String connectionId,
            String purchaseOrderId) {
        this(JsonNullable.undefined(), companyId, connectionId, Optional.empty(), purchaseOrderId, Optional.empty());
    }
    ...
    public UpdatePurchaseOrderRequest withPurchaseOrder(PurchaseOrder purchaseOrder) {
        Utils.checkNotNull(purchaseOrder, "purchaseOrder");
        this.purchaseOrder = JsonNullable.of(purchaseOrder);
        return this;
    }

    public UpdatePurchaseOrderRequest withPurchaseOrder(JsonNullable<? extends PurchaseOrder> purchaseOrder) {
        Utils.checkNotNull(purchaseOrder, "purchaseOrder");
        this.purchaseOrder = purchaseOrder;
        return this;
    }
     ...
     * When updating data in the destination platform Codat checks the `sourceModifiedDate` against the `lastupdated` date from the accounting software, if they're different Codat will return an error suggesting you should initiate another pull of the data. If this is set to `true` then the update will override this check.
     */
    public UpdatePurchaseOrderRequest withForceUpdate(Optional<Boolean> forceUpdate) {
        Utils.checkNotNull(forceUpdate, "forceUpdate");
        this.forceUpdate = forceUpdate;
        return this;
    }
     ...
     * Time limit for the push operation to complete before it is timed out.
     */
    public UpdatePurchaseOrderRequest withTimeoutInMinutes(Optional<Integer> timeoutInMinutes) {
        Utils.checkNotNull(timeoutInMinutes, "timeoutInMinutes");
        this.timeoutInMinutes = timeoutInMinutes;
        return this;
    }
