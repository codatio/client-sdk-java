 ...
 */
@Deprecated
public class UpdateBankAccountResponseAccountingBankAccount {
    ...
    private Optional<? extends UpdateBankAccountResponseBankAccountType> accountType;
    ...
    @JsonCreator
    public UpdateBankAccountResponseAccountingBankAccount(
            @JsonProperty("accountName") JsonNullable<String> accountName,
            @JsonProperty("accountNumber") JsonNullable<String> accountNumber,
            @JsonProperty("accountType") Optional<? extends UpdateBankAccountResponseBankAccountType> accountType,
    ...
    @JsonIgnore
    public Optional<UpdateBankAccountResponseBankAccountType> accountType() {
        return (Optional<UpdateBankAccountResponseBankAccountType>) accountType;
    }
     ...
     * Name of the bank account in the accounting software.
     */
    public UpdateBankAccountResponseAccountingBankAccount withAccountName(String accountName) {
        Utils.checkNotNull(accountName, "accountName");
     ...
     * Name of the bank account in the accounting software.
     */
    public UpdateBankAccountResponseAccountingBankAccount withAccountName(JsonNullable<String> accountName) {
        Utils.checkNotNull(accountName, "accountName");
        this.accountName = accountName;
        return this;
    }
     ...
     * For Credit accounts, only the last four digits are required. For other types, the field is optional.
     */
    public UpdateBankAccountResponseAccountingBankAccount withAccountNumber(String accountNumber) {
        Utils.checkNotNull(accountNumber, "accountNumber");
     ...
     * For Credit accounts, only the last four digits are required. For other types, the field is optional.
     */
    public UpdateBankAccountResponseAccountingBankAccount withAccountNumber(JsonNullable<String> accountNumber) {
        Utils.checkNotNull(accountNumber, "accountNumber");
        this.accountNumber = accountNumber;
        return this;
    }
     ...
     * For Debit accounts, positive balances are assets, and positive transactions **increase** assets.
     */
    public UpdateBankAccountResponseAccountingBankAccount withAccountType(UpdateBankAccountResponseBankAccountType accountType) {
        Utils.checkNotNull(accountType, "accountType");
     ...
     * For Debit accounts, positive balances are assets, and positive transactions **increase** assets.
     */
    public UpdateBankAccountResponseAccountingBankAccount withAccountType(Optional<? extends UpdateBankAccountResponseBankAccountType> accountType) {
        Utils.checkNotNull(accountType, "accountType");
        this.accountType = accountType;
        return this;
    }
     ...
     * Total available balance of the bank account as reported by the underlying data source. This may take into account overdrafts or pending transactions for example.
     */
    public UpdateBankAccountResponseAccountingBankAccount withAvailableBalance(BigDecimal availableBalance) {
        Utils.checkNotNull(availableBalance, "availableBalance");
         ...
         * Total available balance of the bank account as reported by the underlying data source. This may take into account overdrafts or pending transactions for example.
         */
    public UpdateBankAccountResponseAccountingBankAccount withAvailableBalance(double availableBalance) {
     ...
     * Total available balance of the bank account as reported by the underlying data source. This may take into account overdrafts or pending transactions for example.
     */
    public UpdateBankAccountResponseAccountingBankAccount withAvailableBalance(JsonNullable<? extends BigDecimal> availableBalance) {
        Utils.checkNotNull(availableBalance, "availableBalance");
        this.availableBalance = availableBalance;
        return this;
    }
     ...
     * Balance of the bank account.
     */
    public UpdateBankAccountResponseAccountingBankAccount withBalance(BigDecimal balance) {
        Utils.checkNotNull(balance, "balance");
         ...
         * Balance of the bank account.
         */
    public UpdateBankAccountResponseAccountingBankAccount withBalance(double balance) {
     ...
     * Balance of the bank account.
     */
    public UpdateBankAccountResponseAccountingBankAccount withBalance(JsonNullable<? extends BigDecimal> balance) {
        Utils.checkNotNull(balance, "balance");
        this.balance = balance;
        return this;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public UpdateBankAccountResponseAccountingBankAccount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public UpdateBankAccountResponseAccountingBankAccount withCurrency(Optional<String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * International bank account number of the account. Often used when making or receiving international payments.
     */
    public UpdateBankAccountResponseAccountingBankAccount withIBan(String iBan) {
        Utils.checkNotNull(iBan, "iBan");
     ...
     * International bank account number of the account. Often used when making or receiving international payments.
     */
    public UpdateBankAccountResponseAccountingBankAccount withIBan(JsonNullable<String> iBan) {
        Utils.checkNotNull(iBan, "iBan");
        this.iBan = iBan;
        return this;
    }
     ...
     * Identifier for the account, unique for the company in the accounting software.
     */
    public UpdateBankAccountResponseAccountingBankAccount withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Identifier for the account, unique for the company in the accounting software.
     */
    public UpdateBankAccountResponseAccountingBankAccount withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * The institution of the bank account.
     */
    public UpdateBankAccountResponseAccountingBankAccount withInstitution(String institution) {
        Utils.checkNotNull(institution, "institution");
     ...
     * The institution of the bank account.
     */
    public UpdateBankAccountResponseAccountingBankAccount withInstitution(JsonNullable<String> institution) {
        Utils.checkNotNull(institution, "institution");
        this.institution = institution;
        return this;
    }

    public UpdateBankAccountResponseAccountingBankAccount withMetadata(Metadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = Optional.ofNullable(metadata);
        return this;
    }

    public UpdateBankAccountResponseAccountingBankAccount withMetadata(Optional<? extends Metadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }

    public UpdateBankAccountResponseAccountingBankAccount withModifiedDate(String modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = Optional.ofNullable(modifiedDate);
        return this;
    }

    public UpdateBankAccountResponseAccountingBankAccount withModifiedDate(Optional<String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Code used to identify each nominal account for a business.
     */
    public UpdateBankAccountResponseAccountingBankAccount withNominalCode(String nominalCode) {
        Utils.checkNotNull(nominalCode, "nominalCode");
     ...
     * Code used to identify each nominal account for a business.
     */
    public UpdateBankAccountResponseAccountingBankAccount withNominalCode(JsonNullable<String> nominalCode) {
        Utils.checkNotNull(nominalCode, "nominalCode");
        this.nominalCode = nominalCode;
        return this;
    }
     ...
     * The value is always positive. For example, an overdraftLimit of `1000` means that the balance of the account can go down to `-1000`.
     */
    public UpdateBankAccountResponseAccountingBankAccount withOverdraftLimit(BigDecimal overdraftLimit) {
        Utils.checkNotNull(overdraftLimit, "overdraftLimit");
         ...
         * The value is always positive. For example, an overdraftLimit of `1000` means that the balance of the account can go down to `-1000`.
         */
    public UpdateBankAccountResponseAccountingBankAccount withOverdraftLimit(double overdraftLimit) {
     ...
     * The value is always positive. For example, an overdraftLimit of `1000` means that the balance of the account can go down to `-1000`.
     */
    public UpdateBankAccountResponseAccountingBankAccount withOverdraftLimit(JsonNullable<? extends BigDecimal> overdraftLimit) {
        Utils.checkNotNull(overdraftLimit, "overdraftLimit");
        this.overdraftLimit = overdraftLimit;
        return this;
    }
     ...
     * The sort code is only displayed when the currency = GBP and the sort code and account number sum to 14 digits. For non-GBP accounts, this field is not populated.
     */
    public UpdateBankAccountResponseAccountingBankAccount withSortCode(String sortCode) {
        Utils.checkNotNull(sortCode, "sortCode");
     ...
     * The sort code is only displayed when the currency = GBP and the sort code and account number sum to 14 digits. For non-GBP accounts, this field is not populated.
     */
    public UpdateBankAccountResponseAccountingBankAccount withSortCode(JsonNullable<String> sortCode) {
        Utils.checkNotNull(sortCode, "sortCode");
        this.sortCode = sortCode;
        return this;
    }

    public UpdateBankAccountResponseAccountingBankAccount withSourceModifiedDate(String sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = Optional.ofNullable(sourceModifiedDate);
        return this;
    }

    public UpdateBankAccountResponseAccountingBankAccount withSourceModifiedDate(Optional<String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * Status of the bank account.
     */
    public UpdateBankAccountResponseAccountingBankAccount withStatus(BankAccountStatus status) {
        Utils.checkNotNull(status, "status");
     ...
     * Status of the bank account.
     */
    public UpdateBankAccountResponseAccountingBankAccount withStatus(Optional<? extends BankAccountStatus> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting software. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public UpdateBankAccountResponseAccountingBankAccount withSupplementalData(SupplementalData supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting software. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public UpdateBankAccountResponseAccountingBankAccount withSupplementalData(Optional<? extends SupplementalData> supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
        this.supplementalData = supplementalData;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateBankAccountResponseAccountingBankAccount other = (UpdateBankAccountResponseAccountingBankAccount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateBankAccountResponseAccountingBankAccount.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends UpdateBankAccountResponseBankAccountType> accountType = Optional.empty();
         ...
         * For Debit accounts, positive balances are assets, and positive transactions **increase** assets.
         */
        public Builder accountType(UpdateBankAccountResponseBankAccountType accountType) {
            Utils.checkNotNull(accountType, "accountType");
            this.accountType = Optional.ofNullable(accountType);
            return this;
        }
         ...
         * For Debit accounts, positive balances are assets, and positive transactions **increase** assets.
         */
        public Builder accountType(Optional<? extends UpdateBankAccountResponseBankAccountType> accountType) {
            Utils.checkNotNull(accountType, "accountType");
            this.accountType = accountType;
            return this;
        }
        ...
        public UpdateBankAccountResponseAccountingBankAccount build() {
            return new UpdateBankAccountResponseAccountingBankAccount(
                accountName,
                accountNumber,
                accountType,
                availableBalance,
