...
public class PushOption {
    ...
    public PushOption(
            ...
            @JsonProperty("options") JsonNullable<? extends List<PushOptionChoice>> options,
            @JsonProperty("properties") JsonNullable<? extends Map<String, PushOptionProperty>> properties,
    ...
    @JsonIgnore
    public JsonNullable<List<PushOptionChoice>> options() {
        return (JsonNullable<List<PushOptionChoice>>) options;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<Map<String, PushOptionProperty>> properties() {
        return (JsonNullable<Map<String, PushOptionProperty>>) properties;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<PushValidationInfo> validation() {
        return (Optional<PushValidationInfo>) validation;
    }
     ...
     * A description of the property.
     */
    public PushOption withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
    ...
    public PushOption withOptions(List<PushOptionChoice> options) {
        Utils.checkNotNull(options, "options");
        this.options = JsonNullable.of(options);
        return this;
    }

    public PushOption withOptions(JsonNullable<? extends List<PushOptionChoice>> options) {
        Utils.checkNotNull(options, "options");
        this.options = options;
        return this;
    }

    public PushOption withProperties(Map<String, PushOptionProperty> properties) {
        Utils.checkNotNull(properties, "properties");
        this.properties = JsonNullable.of(properties);
        return this;
    }

    public PushOption withProperties(JsonNullable<? extends Map<String, PushOptionProperty>> properties) {
        Utils.checkNotNull(properties, "properties");
        this.properties = properties;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder options(List<PushOptionChoice> options) {
            Utils.checkNotNull(options, "options");
            this.options = JsonNullable.of(options);
            return this;
        }

        public Builder options(JsonNullable<? extends List<PushOptionChoice>> options) {
            Utils.checkNotNull(options, "options");
            this.options = options;
            return this;
        }

        public Builder properties(Map<String, PushOptionProperty> properties) {
            Utils.checkNotNull(properties, "properties");
            this.properties = JsonNullable.of(properties);
            return this;
        }

        public Builder properties(JsonNullable<? extends Map<String, PushOptionProperty>> properties) {
            Utils.checkNotNull(properties, "properties");
            this.properties = properties;
            return this;
        }
