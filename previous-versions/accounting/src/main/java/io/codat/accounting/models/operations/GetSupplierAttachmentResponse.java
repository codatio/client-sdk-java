...
public class GetSupplierAttachmentResponse {
    ...
    public GetSupplierAttachmentResponse(
     ...
     * Success
     */
    public GetSupplierAttachmentResponse withAttachment(io.codat.accounting.models.components.Attachment attachment) {
        Utils.checkNotNull(attachment, "attachment");
     ...
     * Success
     */
    public GetSupplierAttachmentResponse withAttachment(JsonNullable<? extends io.codat.accounting.models.components.Attachment> attachment) {
        Utils.checkNotNull(attachment, "attachment");
        this.attachment = attachment;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public GetSupplierAttachmentResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public GetSupplierAttachmentResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public GetSupplierAttachmentResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetSupplierAttachmentResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetSupplierAttachmentResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSupplierAttachmentResponse other = (GetSupplierAttachmentResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSupplierAttachmentResponse.class,
    ...
    public final static class Builder {
        ...
        public GetSupplierAttachmentResponse build() {
            return new GetSupplierAttachmentResponse(
                attachment,
                contentType,
                errorMessage,
                statusCode,
