...
public class DownloadCustomerAttachmentRequestBuilder {
    ...
    public DownloadCustomerAttachmentRequestBuilder request(DownloadCustomerAttachmentRequest request) {
    ...
    public DownloadCustomerAttachmentRequestBuilder retryConfig(Optional<io.codat.accounting.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
