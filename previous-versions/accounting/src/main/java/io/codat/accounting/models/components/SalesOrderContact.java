...
public class SalesOrderContact {
     ...
     * Email address of the contact at the delivery address.
     */
    public SalesOrderContact withEmail(JsonNullable<String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * Name of the contact at the delivery address.
     */
    public SalesOrderContact withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * Phone number of the contact at the delivery address.
     */
    public SalesOrderContact withPhone(JsonNullable<String> phone) {
        Utils.checkNotNull(phone, "phone");
        this.phone = phone;
        return this;
    }
