...
public class BillCreditNoteLineItem {
     ...
     * Categories, and a project and customer, against which the item is tracked.
     */
    public Optional<? extends BillCreditNoteLineItemTracking> tracking() {
        return tracking;
    }
     ...
     * The measurement which defines a unit for this item (e.g. 'kilogram', 'litre').
     */
    public BillCreditNoteLineItem withUnitOfMeasurement(JsonNullable<? extends String> unitOfMeasurement) {
        Utils.checkNotNull(unitOfMeasurement, "unitOfMeasurement");
        this.unitOfMeasurement = unitOfMeasurement;
        return this;
    }
