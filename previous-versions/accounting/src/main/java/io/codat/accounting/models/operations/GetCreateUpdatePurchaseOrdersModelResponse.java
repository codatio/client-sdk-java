...
public class GetCreateUpdatePurchaseOrdersModelResponse {
    ...
    public GetCreateUpdatePurchaseOrdersModelResponse(
            String contentType,
     ...
     * HTTP response content type for this operation
     */
    public GetCreateUpdatePurchaseOrdersModelResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public GetCreateUpdatePurchaseOrdersModelResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public GetCreateUpdatePurchaseOrdersModelResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * OK
     */
    public GetCreateUpdatePurchaseOrdersModelResponse withPushOption(io.codat.accounting.models.components.PushOption pushOption) {
        Utils.checkNotNull(pushOption, "pushOption");
     ...
     * OK
     */
    public GetCreateUpdatePurchaseOrdersModelResponse withPushOption(Optional<? extends io.codat.accounting.models.components.PushOption> pushOption) {
        Utils.checkNotNull(pushOption, "pushOption");
        this.pushOption = pushOption;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetCreateUpdatePurchaseOrdersModelResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetCreateUpdatePurchaseOrdersModelResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCreateUpdatePurchaseOrdersModelResponse other = (GetCreateUpdatePurchaseOrdersModelResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCreateUpdatePurchaseOrdersModelResponse.class,
    ...
    public final static class Builder {
        ...
        public GetCreateUpdatePurchaseOrdersModelResponse build() {
            return new GetCreateUpdatePurchaseOrdersModelResponse(
                contentType,
                errorMessage,
                pushOption,
                statusCode,
