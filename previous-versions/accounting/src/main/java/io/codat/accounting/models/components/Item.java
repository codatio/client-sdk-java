...
public class Item {
     ...
     * Item details that are only for bills.
     */
    public Item withBillItem(BillItem billItem) {
        Utils.checkNotNull(billItem, "billItem");
     ...
     * Item details that are only for bills.
     */
    public Item withBillItem(Optional<? extends BillItem> billItem) {
        Utils.checkNotNull(billItem, "billItem");
        this.billItem = billItem;
        return this;
    }
     ...
     * Friendly reference for the item.
     */
    public Item withCode(JsonNullable<? extends String> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * Identifier for the item that is unique to a company in the accounting platform.
     */
    public Item withId(Optional<? extends String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Item details that are only for bills.
     */
    public Item withInvoiceItem(InvoiceItem invoiceItem) {
        Utils.checkNotNull(invoiceItem, "invoiceItem");
     ...
     * Item details that are only for bills.
     */
    public Item withInvoiceItem(Optional<? extends InvoiceItem> invoiceItem) {
        Utils.checkNotNull(invoiceItem, "invoiceItem");
        this.invoiceItem = invoiceItem;
        return this;
    }
     ...
     * Whether you can use this item for bills.
     */
    public Item withIsBillItem(boolean isBillItem) {
        Utils.checkNotNull(isBillItem, "isBillItem");
        this.isBillItem = isBillItem;
        return this;
    }
     ...
     * Whether you can use this item for invoices.
     */
    public Item withIsInvoiceItem(boolean isInvoiceItem) {
        Utils.checkNotNull(isInvoiceItem, "isInvoiceItem");
        this.isInvoiceItem = isInvoiceItem;
        return this;
    }
    ...
    public Item withMetadata(Optional<? extends Metadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }
    ...
    public Item withModifiedDate(Optional<? extends String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Name of the item in the accounting platform.
     */
    public Item withName(JsonNullable<? extends String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public Item withSourceModifiedDate(String sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = Optional.ofNullable(sourceModifiedDate);
        return this;
    }
    
    public Item withSourceModifiedDate(Optional<? extends String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting platform. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public Item withSupplementalData(SupplementalData supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting platform. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public Item withSupplementalData(Optional<? extends SupplementalData> supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
        this.supplementalData = supplementalData;
        return this;
    }
