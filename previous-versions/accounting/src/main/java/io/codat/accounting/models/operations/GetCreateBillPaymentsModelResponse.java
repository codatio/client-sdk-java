...
public class GetCreateBillPaymentsModelResponse {
    ...
    public GetCreateBillPaymentsModelResponse(
            String contentType,
     ...
     * HTTP response content type for this operation
     */
    public GetCreateBillPaymentsModelResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public GetCreateBillPaymentsModelResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public GetCreateBillPaymentsModelResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * OK
     */
    public GetCreateBillPaymentsModelResponse withPushOption(io.codat.accounting.models.components.PushOption pushOption) {
        Utils.checkNotNull(pushOption, "pushOption");
     ...
     * OK
     */
    public GetCreateBillPaymentsModelResponse withPushOption(Optional<? extends io.codat.accounting.models.components.PushOption> pushOption) {
        Utils.checkNotNull(pushOption, "pushOption");
        this.pushOption = pushOption;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetCreateBillPaymentsModelResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetCreateBillPaymentsModelResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCreateBillPaymentsModelResponse other = (GetCreateBillPaymentsModelResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCreateBillPaymentsModelResponse.class,
    ...
    public final static class Builder {
        ...
        public GetCreateBillPaymentsModelResponse build() {
            return new GetCreateBillPaymentsModelResponse(
                contentType,
                errorMessage,
                pushOption,
                statusCode,
