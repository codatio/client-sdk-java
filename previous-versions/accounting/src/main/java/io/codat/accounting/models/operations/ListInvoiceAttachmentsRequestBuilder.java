...
public class ListInvoiceAttachmentsRequestBuilder {
    ...
    public ListInvoiceAttachmentsRequestBuilder request(ListInvoiceAttachmentsRequest request) {
    ...
    public ListInvoiceAttachmentsRequestBuilder retryConfig(Optional<io.codat.accounting.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
