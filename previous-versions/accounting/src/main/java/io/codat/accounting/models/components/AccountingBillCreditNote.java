...
public class AccountingBillCreditNote {
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public AccountingBillCreditNote withAllocatedOnDate(Optional<String> allocatedOnDate) {
        Utils.checkNotNull(allocatedOnDate, "allocatedOnDate");
        this.allocatedOnDate = allocatedOnDate;
        return this;
    }
     ...
     * Friendly reference for the bill credit note.
     */
    public AccountingBillCreditNote withBillCreditNoteNumber(JsonNullable<String> billCreditNoteNumber) {
        Utils.checkNotNull(billCreditNoteNumber, "billCreditNoteNumber");
        this.billCreditNoteNumber = billCreditNoteNumber;
        return this;
    }
     ...
     * An array of records the credit note was created from.
     */
    public AccountingBillCreditNote withCreatedFromRefs(List<InvoiceTo> createdFromRefs) {
        Utils.checkNotNull(createdFromRefs, "createdFromRefs");
     ...
     * An array of records the credit note was created from.
     */
    public AccountingBillCreditNote withCreatedFromRefs(JsonNullable<? extends List<InvoiceTo>> createdFromRefs) {
        Utils.checkNotNull(createdFromRefs, "createdFromRefs");
        this.createdFromRefs = createdFromRefs;
        return this;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public AccountingBillCreditNote withCurrency(Optional<String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
     */
    public AccountingBillCreditNote withCurrencyRate(BigDecimal currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
     */
    public AccountingBillCreditNote withCurrencyRate(JsonNullable<? extends BigDecimal> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }
     ...
     * Percentage rate of any discount applied to the bill credit note.
     */
    public AccountingBillCreditNote withDiscountPercentage(BigDecimal discountPercentage) {
        Utils.checkNotNull(discountPercentage, "discountPercentage");
        this.discountPercentage = discountPercentage;
        return this;
    }
     ...
     * Identifier for the bill credit note that is unique to a company in the accounting software.
     */
    public AccountingBillCreditNote withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public AccountingBillCreditNote withIssueDate(Optional<String> issueDate) {
        Utils.checkNotNull(issueDate, "issueDate");
        this.issueDate = issueDate;
        return this;
    }
     ...
     * An array of line 
     */
    public AccountingBillCreditNote withLineItems(List<BillCreditNoteLineItem> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
     ...
     * An array of line 
     */
    public AccountingBillCreditNote withLineItems(JsonNullable<? extends List<BillCreditNoteLineItem>> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = lineItems;
        return this;
    }
    ...
    public AccountingBillCreditNote withModifiedDate(Optional<String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Any additional information about the bill credit note.
     */
    public AccountingBillCreditNote withNote(JsonNullable<String> note) {
        Utils.checkNotNull(note, "note");
        this.note = note;
        return this;
    }
     ...
     * An array of payment allocations.
     */
    public AccountingBillCreditNote withPaymentAllocations(List<PaymentAllocationItems> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
     ...
     * An array of payment allocations.
     */
    public AccountingBillCreditNote withPaymentAllocations(JsonNullable<? extends List<PaymentAllocationItems>> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
        this.paymentAllocations = paymentAllocations;
        return this;
    }
     ...
     * Amount of the bill credit note that is still outstanding.
     */
    public AccountingBillCreditNote withRemainingCredit(BigDecimal remainingCredit) {
        Utils.checkNotNull(remainingCredit, "remainingCredit");
     ...
     * Amount of the bill credit note that is still outstanding.
     */
    public AccountingBillCreditNote withRemainingCredit(Optional<? extends BigDecimal> remainingCredit) {
        Utils.checkNotNull(remainingCredit, "remainingCredit");
        this.remainingCredit = remainingCredit;
        return this;
    }
    ...
    public AccountingBillCreditNote withSourceModifiedDate(Optional<String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * Total amount of the bill credit note, including discounts but excluding tax.
     */
    public AccountingBillCreditNote withSubTotal(BigDecimal subTotal) {
        Utils.checkNotNull(subTotal, "subTotal");
        this.subTotal = subTotal;
        return this;
    }
     ...
     * Total amount of credit that has been applied to the business' account with the supplier, including discounts and tax.
     */
    public AccountingBillCreditNote withTotalAmount(BigDecimal totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
     ...
     * Total value of any discounts applied.
     */
    public AccountingBillCreditNote withTotalDiscount(BigDecimal totalDiscount) {
        Utils.checkNotNull(totalDiscount, "totalDiscount");
        this.totalDiscount = totalDiscount;
        return this;
    }
     ...
     * Amount of tax included in the bill credit note.
     */
    public AccountingBillCreditNote withTotalTaxAmount(BigDecimal totalTaxAmount) {
        Utils.checkNotNull(totalTaxAmount, "totalTaxAmount");
        this.totalTaxAmount = totalTaxAmount;
        return this;
    }

    public AccountingBillCreditNote withWithholdingTax(List<WithholdingTaxItems> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = JsonNullable.of(withholdingTax);
        return this;
    }

    public AccountingBillCreditNote withWithholdingTax(JsonNullable<? extends List<WithholdingTaxItems>> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = withholdingTax;
        return this;
    }
