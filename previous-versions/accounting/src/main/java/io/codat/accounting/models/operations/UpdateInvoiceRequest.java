...
public class UpdateInvoiceRequest {
    ...
    public UpdateInvoiceRequest withInvoice(io.codat.accounting.models.components.Invoice invoice) {
        Utils.checkNotNull(invoice, "invoice");
        this.invoice = JsonNullable.of(invoice);
        return this;
    }

    public UpdateInvoiceRequest withInvoice(JsonNullable<? extends io.codat.accounting.models.components.Invoice> invoice) {
        Utils.checkNotNull(invoice, "invoice");
        this.invoice = invoice;
        return this;
    }
     ...
     * When updating data in the destination platform Codat checks the `sourceModifiedDate` against the `lastupdated` date from the accounting platform, if they're different Codat will return an error suggesting you should initiate another pull of the data. If this is set to `true` then the update will override this check.
     */
    public UpdateInvoiceRequest withForceUpdate(Optional<? extends Boolean> forceUpdate) {
        Utils.checkNotNull(forceUpdate, "forceUpdate");
        this.forceUpdate = forceUpdate;
        return this;
    }
     ...
     * Time limit for the push operation to complete before it is timed out.
     */
    public UpdateInvoiceRequest withTimeoutInMinutes(Optional<? extends Integer> timeoutInMinutes) {
        Utils.checkNotNull(timeoutInMinutes, "timeoutInMinutes");
        this.timeoutInMinutes = timeoutInMinutes;
        return this;
    }
