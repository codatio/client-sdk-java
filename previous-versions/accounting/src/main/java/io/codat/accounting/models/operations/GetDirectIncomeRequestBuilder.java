...
public class GetDirectIncomeRequestBuilder {
    ...
    public GetDirectIncomeRequestBuilder request(GetDirectIncomeRequest request) {
    ...
    public GetDirectIncomeRequestBuilder retryConfig(Optional<io.codat.accounting.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
