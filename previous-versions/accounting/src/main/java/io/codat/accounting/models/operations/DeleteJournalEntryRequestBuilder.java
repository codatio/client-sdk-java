...
public class DeleteJournalEntryRequestBuilder {
    ...
    public DeleteJournalEntryRequestBuilder request(DeleteJournalEntryRequest request) {
    ...
    public DeleteJournalEntryRequestBuilder retryConfig(Optional<io.codat.accounting.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
