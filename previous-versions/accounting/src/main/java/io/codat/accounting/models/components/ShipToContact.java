...
public class ShipToContact {
     ...
     * Email address of the contact at the delivery address.
     */
    public ShipToContact withEmail(JsonNullable<? extends String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * Name of the contact at the delivery address.
     */
    public ShipToContact withName(JsonNullable<? extends String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * Phone number of the contact at the delivery address.
     */
    public ShipToContact withPhone(JsonNullable<? extends String> phone) {
        Utils.checkNotNull(phone, "phone");
        this.phone = phone;
        return this;
    }
