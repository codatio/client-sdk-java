...
public class GetCashFlowStatementRequest {
    ...
    public GetCashFlowStatementRequest(
            String companyId,
            int periodLength,
     ...
     * Unique identifier for a company.
     */
    public GetCashFlowStatementRequest withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * Number of months defining the period of interest.
     */
    public GetCashFlowStatementRequest withPeriodLength(int periodLength) {
        Utils.checkNotNull(periodLength, "periodLength");
        this.periodLength = periodLength;
        return this;
    }
     ...
     * Number of periods with `periodLength` to compare.
     */
    public GetCashFlowStatementRequest withPeriodsToCompare(int periodsToCompare) {
        Utils.checkNotNull(periodsToCompare, "periodsToCompare");
        this.periodsToCompare = periodsToCompare;
        return this;
    }
     ...
     * The month the report starts from.
     */
    public GetCashFlowStatementRequest withStartMonth(String startMonth) {
        Utils.checkNotNull(startMonth, "startMonth");
     ...
     * The month the report starts from.
     */
    public GetCashFlowStatementRequest withStartMonth(Optional<? extends String> startMonth) {
        Utils.checkNotNull(startMonth, "startMonth");
        this.startMonth = startMonth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCashFlowStatementRequest other = (GetCashFlowStatementRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCashFlowStatementRequest.class,
                "companyId", companyId,
    ...
    public final static class Builder {
        ...
        public GetCashFlowStatementRequest build() {
            return new GetCashFlowStatementRequest(
                companyId,
                periodLength,
                periodsToCompare,
                startMonth);
