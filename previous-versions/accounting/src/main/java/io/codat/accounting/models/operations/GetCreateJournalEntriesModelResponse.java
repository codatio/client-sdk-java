...
public class GetCreateJournalEntriesModelResponse {
    ...
    public GetCreateJournalEntriesModelResponse(
            String contentType,
     ...
     * HTTP response content type for this operation
     */
    public GetCreateJournalEntriesModelResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public GetCreateJournalEntriesModelResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public GetCreateJournalEntriesModelResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * OK
     */
    public GetCreateJournalEntriesModelResponse withPushOption(io.codat.accounting.models.components.PushOption pushOption) {
        Utils.checkNotNull(pushOption, "pushOption");
     ...
     * OK
     */
    public GetCreateJournalEntriesModelResponse withPushOption(Optional<? extends io.codat.accounting.models.components.PushOption> pushOption) {
        Utils.checkNotNull(pushOption, "pushOption");
        this.pushOption = pushOption;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetCreateJournalEntriesModelResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetCreateJournalEntriesModelResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCreateJournalEntriesModelResponse other = (GetCreateJournalEntriesModelResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCreateJournalEntriesModelResponse.class,
    ...
    public final static class Builder {
        ...
        public GetCreateJournalEntriesModelResponse build() {
            return new GetCreateJournalEntriesModelResponse(
                contentType,
                errorMessage,
                pushOption,
                statusCode,
