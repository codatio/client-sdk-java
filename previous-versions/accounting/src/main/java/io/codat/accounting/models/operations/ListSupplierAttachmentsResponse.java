...
public class ListSupplierAttachmentsResponse {
    ...
    public ListSupplierAttachmentsResponse(
     ...
     * Success
     */
    public ListSupplierAttachmentsResponse withAttachmentsDataset(io.codat.accounting.models.components.AttachmentsDataset attachmentsDataset) {
        Utils.checkNotNull(attachmentsDataset, "attachmentsDataset");
     ...
     * Success
     */
    public ListSupplierAttachmentsResponse withAttachmentsDataset(Optional<? extends io.codat.accounting.models.components.AttachmentsDataset> attachmentsDataset) {
        Utils.checkNotNull(attachmentsDataset, "attachmentsDataset");
        this.attachmentsDataset = attachmentsDataset;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public ListSupplierAttachmentsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public ListSupplierAttachmentsResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public ListSupplierAttachmentsResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public ListSupplierAttachmentsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListSupplierAttachmentsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSupplierAttachmentsResponse other = (ListSupplierAttachmentsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListSupplierAttachmentsResponse.class,
    ...
    public final static class Builder {
        ...
        public ListSupplierAttachmentsResponse build() {
            return new ListSupplierAttachmentsResponse(
                attachmentsDataset,
                contentType,
                errorMessage,
                statusCode,
