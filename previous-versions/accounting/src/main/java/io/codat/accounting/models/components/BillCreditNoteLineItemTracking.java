...
public class BillCreditNoteLineItemTracking {
    ...
    @JsonCreator
    public BillCreditNoteLineItemTracking(
    ...
    public BillCreditNoteLineItemTracking withCategoryRefs(List<TrackingCategoryRef> categoryRefs) {
        Utils.checkNotNull(categoryRefs, "categoryRefs");
        this.categoryRefs = categoryRefs;
        return this;
    }

    public BillCreditNoteLineItemTracking withCustomerRef(AccountingCustomerRef customerRef) {
        Utils.checkNotNull(customerRef, "customerRef");
        this.customerRef = Optional.ofNullable(customerRef);
        return this;
    }

    public BillCreditNoteLineItemTracking withCustomerRef(Optional<? extends AccountingCustomerRef> customerRef) {
        Utils.checkNotNull(customerRef, "customerRef");
        this.customerRef = customerRef;
        return this;
    }
     ...
     * Defines if the invoice or credit note is billed/rebilled to a project or customer.
     */
    public BillCreditNoteLineItemTracking withIsBilledTo(BilledToType isBilledTo) {
        Utils.checkNotNull(isBilledTo, "isBilledTo");
        this.isBilledTo = isBilledTo;
        return this;
    }
     ...
     * Defines if the invoice or credit note is billed/rebilled to a project or customer.
     */
    public BillCreditNoteLineItemTracking withIsRebilledTo(BilledToType isRebilledTo) {
        Utils.checkNotNull(isRebilledTo, "isRebilledTo");
        this.isRebilledTo = isRebilledTo;
        return this;
    }

    public BillCreditNoteLineItemTracking withProjectRef(ProjectRef projectRef) {
        Utils.checkNotNull(projectRef, "projectRef");
        this.projectRef = Optional.ofNullable(projectRef);
        return this;
    }

    public BillCreditNoteLineItemTracking withProjectRef(Optional<? extends ProjectRef> projectRef) {
        Utils.checkNotNull(projectRef, "projectRef");
        this.projectRef = projectRef;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BillCreditNoteLineItemTracking other = (BillCreditNoteLineItemTracking) o;
        return 
    ...
    public String toString() {
        return Utils.toString(BillCreditNoteLineItemTracking.class,
    ...
    public final static class Builder {
        ...
        public BillCreditNoteLineItemTracking build() {
            return new BillCreditNoteLineItemTracking(
                categoryRefs,
                customerRef,
                isBilledTo,
                isRebilledTo,
