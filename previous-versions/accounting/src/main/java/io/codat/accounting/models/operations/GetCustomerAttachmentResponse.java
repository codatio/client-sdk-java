...
public class GetCustomerAttachmentResponse {
    ...
    public GetCustomerAttachmentResponse(
     ...
     * Success
     */
    public GetCustomerAttachmentResponse withAttachment(io.codat.accounting.models.components.Attachment attachment) {
        Utils.checkNotNull(attachment, "attachment");
     ...
     * Success
     */
    public GetCustomerAttachmentResponse withAttachment(JsonNullable<? extends io.codat.accounting.models.components.Attachment> attachment) {
        Utils.checkNotNull(attachment, "attachment");
        this.attachment = attachment;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public GetCustomerAttachmentResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public GetCustomerAttachmentResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public GetCustomerAttachmentResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetCustomerAttachmentResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetCustomerAttachmentResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCustomerAttachmentResponse other = (GetCustomerAttachmentResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCustomerAttachmentResponse.class,
    ...
    public final static class Builder {
        ...
        public GetCustomerAttachmentResponse build() {
            return new GetCustomerAttachmentResponse(
                attachment,
                contentType,
                errorMessage,
                statusCode,
