...
public class CashFlowStatementInput {
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CashFlowStatementInput withEarliestAvailableMonth(Optional<? extends String> earliestAvailableMonth) {
        Utils.checkNotNull(earliestAvailableMonth, "earliestAvailableMonth");
        this.earliestAvailableMonth = earliestAvailableMonth;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CashFlowStatementInput withMostRecentAvailableMonth(Optional<? extends String> mostRecentAvailableMonth) {
        Utils.checkNotNull(mostRecentAvailableMonth, "mostRecentAvailableMonth");
        this.mostRecentAvailableMonth = mostRecentAvailableMonth;
        return this;
    }
     ...
     * Array of cash flow statements.
     */
    public CashFlowStatementInput withReports(java.util.List<CashFlowStatement> reports) {
        Utils.checkNotNull(reports, "reports");
        this.reports = reports;
        return this;
    }
