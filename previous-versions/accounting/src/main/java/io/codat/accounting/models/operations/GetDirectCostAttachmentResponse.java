...
public class GetDirectCostAttachmentResponse {
    ...
    public GetDirectCostAttachmentResponse(
     ...
     * Success
     */
    public GetDirectCostAttachmentResponse withAttachment(io.codat.accounting.models.components.Attachment attachment) {
        Utils.checkNotNull(attachment, "attachment");
     ...
     * Success
     */
    public GetDirectCostAttachmentResponse withAttachment(JsonNullable<? extends io.codat.accounting.models.components.Attachment> attachment) {
        Utils.checkNotNull(attachment, "attachment");
        this.attachment = attachment;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public GetDirectCostAttachmentResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public GetDirectCostAttachmentResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public GetDirectCostAttachmentResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetDirectCostAttachmentResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetDirectCostAttachmentResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetDirectCostAttachmentResponse other = (GetDirectCostAttachmentResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetDirectCostAttachmentResponse.class,
    ...
    public final static class Builder {
        ...
        public GetDirectCostAttachmentResponse build() {
            return new GetDirectCostAttachmentResponse(
                attachment,
                contentType,
                errorMessage,
                statusCode,
