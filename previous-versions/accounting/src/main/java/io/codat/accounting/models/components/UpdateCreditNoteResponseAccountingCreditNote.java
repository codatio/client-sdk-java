...
public class UpdateCreditNoteResponseAccountingCreditNote {
     ...
     * Additional tax amount applied to credit note.
     */
    public UpdateCreditNoteResponseAccountingCreditNote withAdditionalTaxAmount(Optional<? extends Double> additionalTaxAmount) {
        Utils.checkNotNull(additionalTaxAmount, "additionalTaxAmount");
        this.additionalTaxAmount = additionalTaxAmount;
        return this;
    }
     ...
     * Percentage rate of any additional tax applied to the credit note.
     */
    public UpdateCreditNoteResponseAccountingCreditNote withAdditionalTaxPercentage(Optional<? extends Double> additionalTaxPercentage) {
        Utils.checkNotNull(additionalTaxPercentage, "additionalTaxPercentage");
        this.additionalTaxPercentage = additionalTaxPercentage;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public UpdateCreditNoteResponseAccountingCreditNote withAllocatedOnDate(Optional<? extends String> allocatedOnDate) {
        Utils.checkNotNull(allocatedOnDate, "allocatedOnDate");
        this.allocatedOnDate = allocatedOnDate;
        return this;
    }
     ...
     * Friendly reference for the credit note.
     */
    public UpdateCreditNoteResponseAccountingCreditNote withCreditNoteNumber(JsonNullable<? extends String> creditNoteNumber) {
        Utils.checkNotNull(creditNoteNumber, "creditNoteNumber");
        this.creditNoteNumber = creditNoteNumber;
        return this;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public UpdateCreditNoteResponseAccountingCreditNote withCurrency(Optional<? extends String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, include the required currency rate in the expense transaction.  |
     */
    public UpdateCreditNoteResponseAccountingCreditNote withCurrencyRate(JsonNullable<? extends Double> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }
     ...
     * Identifier for the credit note, unique to the company in the accounting platform.
     */
    public UpdateCreditNoteResponseAccountingCreditNote withId(Optional<? extends String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public UpdateCreditNoteResponseAccountingCreditNote withIssueDate(Optional<? extends String> issueDate) {
        Utils.checkNotNull(issueDate, "issueDate");
        this.issueDate = issueDate;
        return this;
    }

    public UpdateCreditNoteResponseAccountingCreditNote withLineItems(java.util.List<CreditNoteLineItem> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = JsonNullable.of(lineItems);
        return this;
    }

    public UpdateCreditNoteResponseAccountingCreditNote withLineItems(JsonNullable<? extends java.util.List<CreditNoteLineItem>> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = lineItems;
        return this;
    }
    ...
    public UpdateCreditNoteResponseAccountingCreditNote withModifiedDate(Optional<? extends String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Any additional information about the credit note. Where possible, Codat links to a data field in the accounting platform that is publicly available. This means that the contents of the note field are included when a credit note is emailed from the accounting platform to the customer.
     */
    public UpdateCreditNoteResponseAccountingCreditNote withNote(JsonNullable<? extends String> note) {
        Utils.checkNotNull(note, "note");
        this.note = note;
        return this;
    }
     ...
     * An array of payment allocations.
     */
    public UpdateCreditNoteResponseAccountingCreditNote withPaymentAllocations(java.util.List<PaymentAllocationItems> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
     ...
     * An array of payment allocations.
     */
    public UpdateCreditNoteResponseAccountingCreditNote withPaymentAllocations(JsonNullable<? extends java.util.List<PaymentAllocationItems>> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
        this.paymentAllocations = paymentAllocations;
        return this;
    }
    ...
    public UpdateCreditNoteResponseAccountingCreditNote withSourceModifiedDate(Optional<? extends String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
    ...
    public UpdateCreditNoteResponseAccountingCreditNote withWithholdingTax(java.util.List<WithholdingTaxItems> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = JsonNullable.of(withholdingTax);
        return this;
    }

    public UpdateCreditNoteResponseAccountingCreditNote withWithholdingTax(JsonNullable<? extends java.util.List<WithholdingTaxItems>> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = withholdingTax;
        return this;
    }
