...
public class UpdateBillResponseAccountingBill {
    ...
    private JsonNullable<? extends java.util.List<UpdateBillResponseWithholdingTax>> withholdingTax;
    ...
    public UpdateBillResponseAccountingBill(
            ...
            @JsonProperty("withholdingTax") JsonNullable<? extends java.util.List<UpdateBillResponseWithholdingTax>> withholdingTax) {
    ...
    public JsonNullable<? extends java.util.List<UpdateBillResponseWithholdingTax>> withholdingTax() {
     ...
     * Amount outstanding on the bill.
     */
    public UpdateBillResponseAccountingBill withAmountDue(JsonNullable<? extends Double> amountDue) {
        Utils.checkNotNull(amountDue, "amountDue");
        this.amountDue = amountDue;
        return this;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public UpdateBillResponseAccountingBill withCurrency(Optional<? extends String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, include the required currency rate in the expense transaction.  |
     */
    public UpdateBillResponseAccountingBill withCurrencyRate(JsonNullable<? extends Double> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }
    ...
    public UpdateBillResponseAccountingBill withDueDate(Optional<? extends String> dueDate) {
        Utils.checkNotNull(dueDate, "dueDate");
        this.dueDate = dueDate;
        return this;
    }
     ...
     * Identifier for the bill, unique for the company in the accounting platform.
     */
    public UpdateBillResponseAccountingBill withId(Optional<? extends String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Array of Bill line items.
     */
    public UpdateBillResponseAccountingBill withLineItems(java.util.List<BillLineItem> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
     ...
     * Array of Bill line items.
     */
    public UpdateBillResponseAccountingBill withLineItems(JsonNullable<? extends java.util.List<BillLineItem>> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = lineItems;
        return this;
    }
    ...
    public UpdateBillResponseAccountingBill withModifiedDate(Optional<? extends String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Any private, company notes about the bill, such as payment information.
     */
    public UpdateBillResponseAccountingBill withNote(JsonNullable<? extends String> note) {
        Utils.checkNotNull(note, "note");
        this.note = note;
        return this;
    }
     ...
     * An array of payment allocations.
     */
    public UpdateBillResponseAccountingBill withPaymentAllocations(java.util.List<PaymentAllocationItems> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
     ...
     * An array of payment allocations.
     */
    public UpdateBillResponseAccountingBill withPaymentAllocations(JsonNullable<? extends java.util.List<PaymentAllocationItems>> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
        this.paymentAllocations = paymentAllocations;
        return this;
    }

    public UpdateBillResponseAccountingBill withPurchaseOrderRefs(java.util.List<PurchaseOrderRef> purchaseOrderRefs) {
        Utils.checkNotNull(purchaseOrderRefs, "purchaseOrderRefs");
        this.purchaseOrderRefs = JsonNullable.of(purchaseOrderRefs);
        return this;
    }

    public UpdateBillResponseAccountingBill withPurchaseOrderRefs(JsonNullable<? extends java.util.List<PurchaseOrderRef>> purchaseOrderRefs) {
        Utils.checkNotNull(purchaseOrderRefs, "purchaseOrderRefs");
        this.purchaseOrderRefs = purchaseOrderRefs;
        return this;
    }
     ...
     * User-friendly reference for the bill.
     */
    public UpdateBillResponseAccountingBill withReference(JsonNullable<? extends String> reference) {
        Utils.checkNotNull(reference, "reference");
        this.reference = reference;
        return this;
    }
    ...
    public UpdateBillResponseAccountingBill withSourceModifiedDate(Optional<? extends String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
    ...
    public UpdateBillResponseAccountingBill withWithholdingTax(java.util.List<UpdateBillResponseWithholdingTax> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = JsonNullable.of(withholdingTax);
        return this;
    }

    public UpdateBillResponseAccountingBill withWithholdingTax(JsonNullable<? extends java.util.List<UpdateBillResponseWithholdingTax>> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = withholdingTax;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends java.util.List<UpdateBillResponseWithholdingTax>> withholdingTax = JsonNullable.undefined();  
        ...
        public Builder withholdingTax(java.util.List<UpdateBillResponseWithholdingTax> withholdingTax) {
            Utils.checkNotNull(withholdingTax, "withholdingTax");
            this.withholdingTax = JsonNullable.of(withholdingTax);
            return this;
        }

        public Builder withholdingTax(JsonNullable<? extends java.util.List<UpdateBillResponseWithholdingTax>> withholdingTax) {
            Utils.checkNotNull(withholdingTax, "withholdingTax");
            this.withholdingTax = withholdingTax;
            return this;
        }
