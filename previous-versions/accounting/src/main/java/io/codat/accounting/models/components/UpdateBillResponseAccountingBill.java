...
public class UpdateBillResponseAccountingBill {
    ...
    private JsonNullable<? extends List<UpdateBillResponseWithholdingTax>> withholdingTax;

    @JsonCreator
    public UpdateBillResponseAccountingBill(
            ...
            @JsonProperty("withholdingTax") JsonNullable<? extends List<UpdateBillResponseWithholdingTax>> withholdingTax) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<List<UpdateBillResponseWithholdingTax>> withholdingTax() {
        return (JsonNullable<List<UpdateBillResponseWithholdingTax>>) withholdingTax;
    }
     ...
     * Amount outstanding on the bill.
     */
    public UpdateBillResponseAccountingBill withAmountDue(BigDecimal amountDue) {
        Utils.checkNotNull(amountDue, "amountDue");
         ...
         * Amount outstanding on the bill.
         */
    public UpdateBillResponseAccountingBill withAmountDue(double amountDue) {
     ...
     * Amount outstanding on the bill.
     */
    public UpdateBillResponseAccountingBill withAmountDue(JsonNullable<? extends BigDecimal> amountDue) {
        Utils.checkNotNull(amountDue, "amountDue");
        this.amountDue = amountDue;
        return this;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public UpdateBillResponseAccountingBill withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public UpdateBillResponseAccountingBill withCurrency(Optional<String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
     */
    public UpdateBillResponseAccountingBill withCurrencyRate(BigDecimal currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
         ...
         * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
         */
    public UpdateBillResponseAccountingBill withCurrencyRate(double currencyRate) {
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
     */
    public UpdateBillResponseAccountingBill withCurrencyRate(JsonNullable<? extends BigDecimal> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }

    public UpdateBillResponseAccountingBill withDueDate(String dueDate) {
        Utils.checkNotNull(dueDate, "dueDate");
        this.dueDate = Optional.ofNullable(dueDate);
        return this;
    }

    public UpdateBillResponseAccountingBill withDueDate(Optional<String> dueDate) {
        Utils.checkNotNull(dueDate, "dueDate");
        this.dueDate = dueDate;
        return this;
    }
     ...
     * Identifier for the bill, unique for the company in the accounting software.
     */
    public UpdateBillResponseAccountingBill withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Identifier for the bill, unique for the company in the accounting software.
     */
    public UpdateBillResponseAccountingBill withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public UpdateBillResponseAccountingBill withIssueDate(String issueDate) {
        Utils.checkNotNull(issueDate, "issueDate");
        this.issueDate = issueDate;
        return this;
    }
     ...
     * Array of Bill line items.
     */
    public UpdateBillResponseAccountingBill withLineItems(List<BillLineItem> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
     ...
     * Array of Bill line items.
     */
    public UpdateBillResponseAccountingBill withLineItems(JsonNullable<? extends List<BillLineItem>> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = lineItems;
        return this;
    }

    public UpdateBillResponseAccountingBill withMetadata(Metadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = Optional.ofNullable(metadata);
        return this;
    }

    public UpdateBillResponseAccountingBill withMetadata(Optional<? extends Metadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }

    public UpdateBillResponseAccountingBill withModifiedDate(String modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = Optional.ofNullable(modifiedDate);
        return this;
    }

    public UpdateBillResponseAccountingBill withModifiedDate(Optional<String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Any private, company notes about the bill, such as payment information.
     */
    public UpdateBillResponseAccountingBill withNote(String note) {
        Utils.checkNotNull(note, "note");
     ...
     * Any private, company notes about the bill, such as payment information.
     */
    public UpdateBillResponseAccountingBill withNote(JsonNullable<String> note) {
        Utils.checkNotNull(note, "note");
        this.note = note;
        return this;
    }
     ...
     * An array of payment allocations.
     */
    public UpdateBillResponseAccountingBill withPaymentAllocations(List<PaymentAllocationItems> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
     ...
     * An array of payment allocations.
     */
    public UpdateBillResponseAccountingBill withPaymentAllocations(JsonNullable<? extends List<PaymentAllocationItems>> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
        this.paymentAllocations = paymentAllocations;
        return this;
    }

    public UpdateBillResponseAccountingBill withPurchaseOrderRefs(List<PurchaseOrderRef> purchaseOrderRefs) {
        Utils.checkNotNull(purchaseOrderRefs, "purchaseOrderRefs");
        this.purchaseOrderRefs = JsonNullable.of(purchaseOrderRefs);
        return this;
    }

    public UpdateBillResponseAccountingBill withPurchaseOrderRefs(JsonNullable<? extends List<PurchaseOrderRef>> purchaseOrderRefs) {
        Utils.checkNotNull(purchaseOrderRefs, "purchaseOrderRefs");
        this.purchaseOrderRefs = purchaseOrderRefs;
        return this;
    }
     ...
     * User-friendly reference for the bill.
     */
    public UpdateBillResponseAccountingBill withReference(String reference) {
        Utils.checkNotNull(reference, "reference");
     ...
     * User-friendly reference for the bill.
     */
    public UpdateBillResponseAccountingBill withReference(JsonNullable<String> reference) {
        Utils.checkNotNull(reference, "reference");
        this.reference = reference;
        return this;
    }

    public UpdateBillResponseAccountingBill withSourceModifiedDate(String sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = Optional.ofNullable(sourceModifiedDate);
        return this;
    }

    public UpdateBillResponseAccountingBill withSourceModifiedDate(Optional<String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * Current state of the bill.
     */
    public UpdateBillResponseAccountingBill withStatus(BillStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
         ...
         * Total amount of the bill, excluding any taxes.
         */
    public UpdateBillResponseAccountingBill withSubTotal(double subTotal) {
     ...
     * Total amount of the bill, excluding any taxes.
     */
    public UpdateBillResponseAccountingBill withSubTotal(BigDecimal subTotal) {
        Utils.checkNotNull(subTotal, "subTotal");
        this.subTotal = subTotal;
        return this;
    }
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting software. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public UpdateBillResponseAccountingBill withSupplementalData(SupplementalData supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting software. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public UpdateBillResponseAccountingBill withSupplementalData(Optional<? extends SupplementalData> supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
        this.supplementalData = supplementalData;
        return this;
    }
     ...
     * Reference to the supplier the record relates to.
     */
    public UpdateBillResponseAccountingBill withSupplierRef(SupplierRef supplierRef) {
        Utils.checkNotNull(supplierRef, "supplierRef");
     ...
     * Reference to the supplier the record relates to.
     */
    public UpdateBillResponseAccountingBill withSupplierRef(Optional<? extends SupplierRef> supplierRef) {
        Utils.checkNotNull(supplierRef, "supplierRef");
        this.supplierRef = supplierRef;
        return this;
    }
         ...
         * Amount of tax on the bill.
         */
    public UpdateBillResponseAccountingBill withTaxAmount(double taxAmount) {
     ...
     * Amount of tax on the bill.
     */
    public UpdateBillResponseAccountingBill withTaxAmount(BigDecimal taxAmount) {
        Utils.checkNotNull(taxAmount, "taxAmount");
        this.taxAmount = taxAmount;
        return this;
    }
         ...
         * Amount of the bill, including tax.
         */
    public UpdateBillResponseAccountingBill withTotalAmount(double totalAmount) {
     ...
     * Amount of the bill, including tax.
     */
    public UpdateBillResponseAccountingBill withTotalAmount(BigDecimal totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }

    public UpdateBillResponseAccountingBill withWithholdingTax(List<UpdateBillResponseWithholdingTax> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = JsonNullable.of(withholdingTax);
        return this;
    }

    public UpdateBillResponseAccountingBill withWithholdingTax(JsonNullable<? extends List<UpdateBillResponseWithholdingTax>> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = withholdingTax;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateBillResponseAccountingBill other = (UpdateBillResponseAccountingBill) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateBillResponseAccountingBill.class,
                "amountDue", amountDue,
                "currency", currency,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends List<UpdateBillResponseWithholdingTax>> withholdingTax = JsonNullable.undefined();  
        ...
        public Builder withholdingTax(List<UpdateBillResponseWithholdingTax> withholdingTax) {
            Utils.checkNotNull(withholdingTax, "withholdingTax");
            this.withholdingTax = JsonNullable.of(withholdingTax);
            return this;
        }

        public Builder withholdingTax(JsonNullable<? extends List<UpdateBillResponseWithholdingTax>> withholdingTax) {
            Utils.checkNotNull(withholdingTax, "withholdingTax");
            this.withholdingTax = withholdingTax;
            return this;
        }
        
        public UpdateBillResponseAccountingBill build() {
            return new UpdateBillResponseAccountingBill(
                amountDue,
                currency,
                currencyRate,
                dueDate,
