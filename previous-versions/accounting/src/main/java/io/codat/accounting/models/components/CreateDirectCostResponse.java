...
public class CreateDirectCostResponse {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("data")
    private JsonNullable<? extends AccountingDirectCost> data;
    ...
    public CreateDirectCostResponse(
            ...
            @JsonProperty("data") JsonNullable<? extends AccountingDirectCost> data,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<AccountingDirectCost> data() {
        return (JsonNullable<AccountingDirectCost>) data;
    }
     ...
     * Contains a single entry that communicates which record has changed and the manner in which it changed. 
     */
    public CreateDirectCostResponse withChanges(List<PushOperationChange> changes) {
        Utils.checkNotNull(changes, "changes");
     ...
     * Contains a single entry that communicates which record has changed and the manner in which it changed. 
     */
    public CreateDirectCostResponse withChanges(JsonNullable<? extends List<PushOperationChange>> changes) {
        Utils.checkNotNull(changes, "changes");
        this.changes = changes;
        return this;
    }
     ...
     * Unique identifier for your SMB in Codat.
     */
    public CreateDirectCostResponse withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CreateDirectCostResponse withCompletedOnUtc(String completedOnUtc) {
        Utils.checkNotNull(completedOnUtc, "completedOnUtc");
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CreateDirectCostResponse withCompletedOnUtc(Optional<String> completedOnUtc) {
        Utils.checkNotNull(completedOnUtc, "completedOnUtc");
        this.completedOnUtc = completedOnUtc;
        return this;
    }

    public CreateDirectCostResponse withData(AccountingDirectCost data) {
        Utils.checkNotNull(data, "data");
        this.data = JsonNullable.of(data);
        return this;
    }

    public CreateDirectCostResponse withData(JsonNullable<? extends AccountingDirectCost> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Unique identifier for a company's data connection.
     */
    public CreateDirectCostResponse withDataConnectionKey(String dataConnectionKey) {
        Utils.checkNotNull(dataConnectionKey, "dataConnectionKey");
        this.dataConnectionKey = dataConnectionKey;
        return this;
    }
     ...
     * Available data types
     */
    public CreateDirectCostResponse withDataType(DataType dataType) {
        Utils.checkNotNull(dataType, "dataType");
     ...
     * Available data types
     */
    public CreateDirectCostResponse withDataType(Optional<? extends DataType> dataType) {
        Utils.checkNotNull(dataType, "dataType");
        this.dataType = dataType;
        return this;
    }
     ...
     * A message about the error.
     */
    public CreateDirectCostResponse withErrorMessage(String errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * A message about the error.
     */
    public CreateDirectCostResponse withErrorMessage(JsonNullable<String> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * A unique identifier generated by Codat to represent this single push operation. This identifier can be used to track the status of the push, and should be persisted.
     */
    public CreateDirectCostResponse withPushOperationKey(String pushOperationKey) {
        Utils.checkNotNull(pushOperationKey, "pushOperationKey");
        this.pushOperationKey = pushOperationKey;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CreateDirectCostResponse withRequestedOnUtc(String requestedOnUtc) {
        Utils.checkNotNull(requestedOnUtc, "requestedOnUtc");
        this.requestedOnUtc = requestedOnUtc;
        return this;
    }
     ...
     * The current status of the push operation.
     */
    public CreateDirectCostResponse withStatus(PushOperationStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Push status code.
     */
    public CreateDirectCostResponse withStatusCode(long statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Number of minutes the push operation must complete within before it times out.
     */
    public CreateDirectCostResponse withTimeoutInMinutes(int timeoutInMinutes) {
        Utils.checkNotNull(timeoutInMinutes, "timeoutInMinutes");
     ...
     * Number of minutes the push operation must complete within before it times out.
     */
    public CreateDirectCostResponse withTimeoutInMinutes(JsonNullable<Integer> timeoutInMinutes) {
        Utils.checkNotNull(timeoutInMinutes, "timeoutInMinutes");
        this.timeoutInMinutes = timeoutInMinutes;
        return this;
    }
     ...
     */
    @Deprecated
    public CreateDirectCostResponse withTimeoutInSeconds(int timeoutInSeconds) {
        Utils.checkNotNull(timeoutInSeconds, "timeoutInSeconds");
     ...
     */
    @Deprecated
    public CreateDirectCostResponse withTimeoutInSeconds(JsonNullable<Integer> timeoutInSeconds) {
        Utils.checkNotNull(timeoutInSeconds, "timeoutInSeconds");
        this.timeoutInSeconds = timeoutInSeconds;
        return this;
    }
     ...
     * A human-readable object describing validation decisions Codat has made when pushing data into the platform. If a push has failed because of validation errors, they will be detailed here.
     */
    public CreateDirectCostResponse withValidation(Validation validation) {
        Utils.checkNotNull(validation, "validation");
     ...
     * A human-readable object describing validation decisions Codat has made when pushing data into the platform. If a push has failed because of validation errors, they will be detailed here.
     */
    public CreateDirectCostResponse withValidation(Optional<? extends Validation> validation) {
        Utils.checkNotNull(validation, "validation");
        this.validation = validation;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends AccountingDirectCost> data = JsonNullable.undefined();
        ...
        public Builder data(AccountingDirectCost data) {
            Utils.checkNotNull(data, "data");
            this.data = JsonNullable.of(data);
            return this;
        }

        public Builder data(JsonNullable<? extends AccountingDirectCost> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
