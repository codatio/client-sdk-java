...
public class ListDirectIncomeAttachmentsRequestBuilder {
    ...
    public ListDirectIncomeAttachmentsRequestBuilder request(ListDirectIncomeAttachmentsRequest request) {
    ...
    public ListDirectIncomeAttachmentsRequestBuilder retryConfig(Optional<io.codat.accounting.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
