...
public class AccountingInvoice {
     ...
     * An array of payment allocations.
     */
    public AccountingInvoice withPaymentAllocations(List<PaymentAllocationItems> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
     ...
     * An array of payment allocations.
     */
    public AccountingInvoice withPaymentAllocations(JsonNullable<? extends List<PaymentAllocationItems>> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
        this.paymentAllocations = paymentAllocations;
        return this;
    }
     ...
     * List of references to related Sales orders.
     */
    public AccountingInvoice withSalesOrderRefs(List<SalesOrderRef> salesOrderRefs) {
        Utils.checkNotNull(salesOrderRefs, "salesOrderRefs");
     ...
     * List of references to related Sales orders.
     */
    public AccountingInvoice withSalesOrderRefs(JsonNullable<? extends List<SalesOrderRef>> salesOrderRefs) {
        Utils.checkNotNull(salesOrderRefs, "salesOrderRefs");
        this.salesOrderRefs = salesOrderRefs;
        return this;
    }
    ...
    public AccountingInvoice withWithholdingTax(List<WithholdingTaxItems> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = JsonNullable.of(withholdingTax);
        return this;
    }

    public AccountingInvoice withWithholdingTax(JsonNullable<? extends List<WithholdingTaxItems>> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = withholdingTax;
        return this;
    }
