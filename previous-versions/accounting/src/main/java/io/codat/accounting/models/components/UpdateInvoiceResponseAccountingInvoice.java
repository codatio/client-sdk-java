...
public class UpdateInvoiceResponseAccountingInvoice {
    ...
    private JsonNullable<? extends List<SalesOrderRef>> salesOrderRefs;
    ...
    public UpdateInvoiceResponseAccountingInvoice(
            ...
            @JsonProperty("salesOrderRefs") JsonNullable<? extends List<SalesOrderRef>> salesOrderRefs,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<List<SalesOrderRef>> salesOrderRefs() {
        return (JsonNullable<List<SalesOrderRef>>) salesOrderRefs;
    }
     ...
     * Additional tax amount applied to invoice.
     */
    public UpdateInvoiceResponseAccountingInvoice withAdditionalTaxAmount(BigDecimal additionalTaxAmount) {
        Utils.checkNotNull(additionalTaxAmount, "additionalTaxAmount");
     ...
     * Additional tax amount applied to invoice.
     */
    public UpdateInvoiceResponseAccountingInvoice withAdditionalTaxAmount(Optional<? extends BigDecimal> additionalTaxAmount) {
        Utils.checkNotNull(additionalTaxAmount, "additionalTaxAmount");
        this.additionalTaxAmount = additionalTaxAmount;
        return this;
    }
     ...
     * Percentage rate of any additional tax applied to the invoice.
     */
    public UpdateInvoiceResponseAccountingInvoice withAdditionalTaxPercentage(BigDecimal additionalTaxPercentage) {
        Utils.checkNotNull(additionalTaxPercentage, "additionalTaxPercentage");
     ...
     * Percentage rate of any additional tax applied to the invoice.
     */
    public UpdateInvoiceResponseAccountingInvoice withAdditionalTaxPercentage(Optional<? extends BigDecimal> additionalTaxPercentage) {
        Utils.checkNotNull(additionalTaxPercentage, "additionalTaxPercentage");
        this.additionalTaxPercentage = additionalTaxPercentage;
        return this;
    }
     ...
     * Amount outstanding on the invoice.
     */
    public UpdateInvoiceResponseAccountingInvoice withAmountDue(BigDecimal amountDue) {
        Utils.checkNotNull(amountDue, "amountDue");
        this.amountDue = amountDue;
        return this;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public UpdateInvoiceResponseAccountingInvoice withCurrency(Optional<String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
     */
    public UpdateInvoiceResponseAccountingInvoice withCurrencyRate(BigDecimal currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
     */
    public UpdateInvoiceResponseAccountingInvoice withCurrencyRate(JsonNullable<? extends BigDecimal> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }
     ...
     * Percentage rate (from 0 to 100) of discounts applied to the invoice. For example: A 5% discount will return a value of `5`, not `0.05`.
     */
    public UpdateInvoiceResponseAccountingInvoice withDiscountPercentage(BigDecimal discountPercentage) {
        Utils.checkNotNull(discountPercentage, "discountPercentage");
     ...
     * Percentage rate (from 0 to 100) of discounts applied to the invoice. For example: A 5% discount will return a value of `5`, not `0.05`.
     */
    public UpdateInvoiceResponseAccountingInvoice withDiscountPercentage(JsonNullable<? extends BigDecimal> discountPercentage) {
        Utils.checkNotNull(discountPercentage, "discountPercentage");
        this.discountPercentage = discountPercentage;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public UpdateInvoiceResponseAccountingInvoice withDueDate(Optional<String> dueDate) {
        Utils.checkNotNull(dueDate, "dueDate");
        this.dueDate = dueDate;
        return this;
    }
     ...
     * Identifier for the invoice, unique to the company in the accounting software.
     */
    public UpdateInvoiceResponseAccountingInvoice withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Friendly reference for the invoice. If available, this appears in the file name of invoice attachments.
     */
    public UpdateInvoiceResponseAccountingInvoice withInvoiceNumber(JsonNullable<String> invoiceNumber) {
        Utils.checkNotNull(invoiceNumber, "invoiceNumber");
        this.invoiceNumber = invoiceNumber;
        return this;
    }
     ...
     * An array of line items.
     */
    public UpdateInvoiceResponseAccountingInvoice withLineItems(List<InvoiceLineItem> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
     ...
     * An array of line items.
     */
    public UpdateInvoiceResponseAccountingInvoice withLineItems(JsonNullable<? extends List<InvoiceLineItem>> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = lineItems;
        return this;
    }
    ...
    public UpdateInvoiceResponseAccountingInvoice withModifiedDate(Optional<String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Any additional information about the invoice. Where possible, Codat links to a data field in the accounting software that is publicly available. This means that the contents of the note field are included when an invoice is emailed from the accounting software to the customer.
     */
    public UpdateInvoiceResponseAccountingInvoice withNote(JsonNullable<String> note) {
        Utils.checkNotNull(note, "note");
        this.note = note;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public UpdateInvoiceResponseAccountingInvoice withPaidOnDate(Optional<String> paidOnDate) {
        Utils.checkNotNull(paidOnDate, "paidOnDate");
        this.paidOnDate = paidOnDate;
        return this;
    }
     ...
     * An array of payment allocations.
     */
    public UpdateInvoiceResponseAccountingInvoice withPaymentAllocations(List<PaymentAllocationItems> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
     ...
     * An array of payment allocations.
     */
    public UpdateInvoiceResponseAccountingInvoice withPaymentAllocations(JsonNullable<? extends List<PaymentAllocationItems>> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
        this.paymentAllocations = paymentAllocations;
        return this;
    }
     ...
     * List of references to related Sales orders.
     */
    public UpdateInvoiceResponseAccountingInvoice withSalesOrderRefs(List<SalesOrderRef> salesOrderRefs) {
        Utils.checkNotNull(salesOrderRefs, "salesOrderRefs");
     ...
     * List of references to related Sales orders.
     */
    public UpdateInvoiceResponseAccountingInvoice withSalesOrderRefs(JsonNullable<? extends List<SalesOrderRef>> salesOrderRefs) {
        Utils.checkNotNull(salesOrderRefs, "salesOrderRefs");
        this.salesOrderRefs = salesOrderRefs;
        return this;
    }
    ...
    public UpdateInvoiceResponseAccountingInvoice withSourceModifiedDate(Optional<String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * Total amount of the invoice excluding any taxes.
     */
    public UpdateInvoiceResponseAccountingInvoice withSubTotal(BigDecimal subTotal) {
        Utils.checkNotNull(subTotal, "subTotal");
     ...
     * Total amount of the invoice excluding any taxes.
     */
    public UpdateInvoiceResponseAccountingInvoice withSubTotal(JsonNullable<? extends BigDecimal> subTotal) {
        Utils.checkNotNull(subTotal, "subTotal");
        this.subTotal = subTotal;
        return this;
    }
     ...
     * Amount of the invoice, inclusive of tax.
     */
    public UpdateInvoiceResponseAccountingInvoice withTotalAmount(BigDecimal totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
     ...
     * Numerical value of discounts applied to the invoice.
     */
    public UpdateInvoiceResponseAccountingInvoice withTotalDiscount(BigDecimal totalDiscount) {
        Utils.checkNotNull(totalDiscount, "totalDiscount");
     ...
     * Numerical value of discounts applied to the invoice.
     */
    public UpdateInvoiceResponseAccountingInvoice withTotalDiscount(JsonNullable<? extends BigDecimal> totalDiscount) {
        Utils.checkNotNull(totalDiscount, "totalDiscount");
        this.totalDiscount = totalDiscount;
        return this;
    }
     ...
     * Amount of tax on the invoice.
     */
    public UpdateInvoiceResponseAccountingInvoice withTotalTaxAmount(BigDecimal totalTaxAmount) {
        Utils.checkNotNull(totalTaxAmount, "totalTaxAmount");
        this.totalTaxAmount = totalTaxAmount;
        return this;
    }

    public UpdateInvoiceResponseAccountingInvoice withWithholdingTax(List<WithholdingTaxItems> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = JsonNullable.of(withholdingTax);
        return this;
    }

    public UpdateInvoiceResponseAccountingInvoice withWithholdingTax(JsonNullable<? extends List<WithholdingTaxItems>> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = withholdingTax;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends List<SalesOrderRef>> salesOrderRefs = JsonNullable.undefined();
         ...
         * List of references to related Sales orders.
         */
        public Builder salesOrderRefs(List<SalesOrderRef> salesOrderRefs) {
            Utils.checkNotNull(salesOrderRefs, "salesOrderRefs");
            this.salesOrderRefs = JsonNullable.of(salesOrderRefs);
            return this;
        }
         ...
         * List of references to related Sales orders.
         */
        public Builder salesOrderRefs(JsonNullable<? extends List<SalesOrderRef>> salesOrderRefs) {
            Utils.checkNotNull(salesOrderRefs, "salesOrderRefs");
            this.salesOrderRefs = salesOrderRefs;
            return this;
        }
