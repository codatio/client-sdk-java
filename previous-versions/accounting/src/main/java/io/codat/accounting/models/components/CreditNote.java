...
public class CreditNote {
     ...
     * Additional tax amount applied to credit note.
     */
    public CreditNote withAdditionalTaxAmount(BigDecimal additionalTaxAmount) {
        Utils.checkNotNull(additionalTaxAmount, "additionalTaxAmount");
         ...
         * Additional tax amount applied to credit note.
         */
    public CreditNote withAdditionalTaxAmount(double additionalTaxAmount) {
     ...
     * Additional tax amount applied to credit note.
     */
    public CreditNote withAdditionalTaxAmount(Optional<? extends BigDecimal> additionalTaxAmount) {
        Utils.checkNotNull(additionalTaxAmount, "additionalTaxAmount");
        this.additionalTaxAmount = additionalTaxAmount;
        return this;
    }
     ...
     * Percentage rate of any additional tax applied to the credit note.
     */
    public CreditNote withAdditionalTaxPercentage(BigDecimal additionalTaxPercentage) {
        Utils.checkNotNull(additionalTaxPercentage, "additionalTaxPercentage");
         ...
         * Percentage rate of any additional tax applied to the credit note.
         */
    public CreditNote withAdditionalTaxPercentage(double additionalTaxPercentage) {
     ...
     * Percentage rate of any additional tax applied to the credit note.
     */
    public CreditNote withAdditionalTaxPercentage(Optional<? extends BigDecimal> additionalTaxPercentage) {
        Utils.checkNotNull(additionalTaxPercentage, "additionalTaxPercentage");
        this.additionalTaxPercentage = additionalTaxPercentage;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CreditNote withAllocatedOnDate(String allocatedOnDate) {
        Utils.checkNotNull(allocatedOnDate, "allocatedOnDate");
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CreditNote withAllocatedOnDate(Optional<String> allocatedOnDate) {
        Utils.checkNotNull(allocatedOnDate, "allocatedOnDate");
        this.allocatedOnDate = allocatedOnDate;
        return this;
    }
     ...
     * Friendly reference for the credit note.
     */
    public CreditNote withCreditNoteNumber(JsonNullable<String> creditNoteNumber) {
        Utils.checkNotNull(creditNoteNumber, "creditNoteNumber");
        this.creditNoteNumber = creditNoteNumber;
        return this;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public CreditNote withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public CreditNote withCurrency(Optional<String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
     */
    public CreditNote withCurrencyRate(BigDecimal currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
     */
    public CreditNote withCurrencyRate(JsonNullable<? extends BigDecimal> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }

    public CreditNote withCustomerRef(AccountingCustomerRef customerRef) {
        Utils.checkNotNull(customerRef, "customerRef");
        this.customerRef = Optional.ofNullable(customerRef);
        return this;
    }

    public CreditNote withCustomerRef(Optional<? extends AccountingCustomerRef> customerRef) {
        Utils.checkNotNull(customerRef, "customerRef");
        this.customerRef = customerRef;
        return this;
    }
         ...
         * Percentage rate (from 0 to 100) of discounts applied to the credit note.
         */
    public CreditNote withDiscountPercentage(double discountPercentage) {
     ...
     * Percentage rate (from 0 to 100) of discounts applied to the credit note.
     */
    public CreditNote withDiscountPercentage(BigDecimal discountPercentage) {
        Utils.checkNotNull(discountPercentage, "discountPercentage");
        this.discountPercentage = discountPercentage;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CreditNote withIssueDate(String issueDate) {
        Utils.checkNotNull(issueDate, "issueDate");
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CreditNote withIssueDate(Optional<String> issueDate) {
        Utils.checkNotNull(issueDate, "issueDate");
        this.issueDate = issueDate;
        return this;
    }

    public CreditNote withLineItems(List<CreditNoteLineItem> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = JsonNullable.of(lineItems);
        return this;
    }

    public CreditNote withLineItems(JsonNullable<? extends List<CreditNoteLineItem>> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = lineItems;
        return this;
    }

    public CreditNote withMetadata(Metadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = Optional.ofNullable(metadata);
        return this;
    }

    public CreditNote withMetadata(Optional<? extends Metadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }

    public CreditNote withModifiedDate(String modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = Optional.ofNullable(modifiedDate);
        return this;
    }

    public CreditNote withModifiedDate(Optional<String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * An array of payment allocations.
     */
    public CreditNote withPaymentAllocations(List<PaymentAllocationItems> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
     ...
     * An array of payment allocations.
     */
    public CreditNote withPaymentAllocations(JsonNullable<? extends List<PaymentAllocationItems>> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
        this.paymentAllocations = paymentAllocations;
        return this;
    }
     ...
     * Unused balance of totalAmount originally raised.
     */
    public CreditNote withRemainingCredit(BigDecimal remainingCredit) {
        Utils.checkNotNull(remainingCredit, "remainingCredit");
        this.remainingCredit = remainingCredit;
        return this;
    }

    public CreditNote withSourceModifiedDate(String sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = Optional.ofNullable(sourceModifiedDate);
        return this;
    }

    public CreditNote withSourceModifiedDate(Optional<String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * Value of the credit note, including discounts and excluding tax.
     */
    public CreditNote withSubTotal(BigDecimal subTotal) {
        Utils.checkNotNull(subTotal, "subTotal");
        this.subTotal = subTotal;
        return this;
    }
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting software. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public CreditNote withSupplementalData(SupplementalData supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting software. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public CreditNote withSupplementalData(Optional<? extends SupplementalData> supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
        this.supplementalData = supplementalData;
        return this;
    }
     ...
     * Total amount of credit that has been applied to the customer's accounts receivable
     */
    public CreditNote withTotalAmount(BigDecimal totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
         ...
         * Any discounts applied to the credit note amount.
         */
    public CreditNote withTotalDiscount(double totalDiscount) {
     ...
     * Any discounts applied to the credit note amount.
     */
    public CreditNote withTotalDiscount(BigDecimal totalDiscount) {
        Utils.checkNotNull(totalDiscount, "totalDiscount");
        this.totalDiscount = totalDiscount;
        return this;
    }
         ...
         * Any tax applied to the credit note amount.
         */
    public CreditNote withTotalTaxAmount(double totalTaxAmount) {
     ...
     * Any tax applied to the credit note amount.
     */
    public CreditNote withTotalTaxAmount(BigDecimal totalTaxAmount) {
        Utils.checkNotNull(totalTaxAmount, "totalTaxAmount");
        this.totalTaxAmount = totalTaxAmount;
        return this;
    }

    public CreditNote withWithholdingTax(List<WithholdingTaxItems> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = JsonNullable.of(withholdingTax);
        return this;
    }

    public CreditNote withWithholdingTax(JsonNullable<? extends List<WithholdingTaxItems>> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = withholdingTax;
        return this;
    }
