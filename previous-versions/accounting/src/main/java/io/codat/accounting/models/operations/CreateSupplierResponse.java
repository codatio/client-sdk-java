...
public class CreateSupplierResponse {
     ...
     * Success
     */
    public Optional<? extends io.codat.accounting.models.components.CreateSupplierResponse> createSupplierResponse() {
     ...
     * The request made is not valid.
     */
    public CreateSupplierResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * The request made is not valid.
     */
    public CreateSupplierResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
