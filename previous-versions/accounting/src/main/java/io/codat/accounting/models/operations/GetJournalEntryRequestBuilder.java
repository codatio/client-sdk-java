...
public class GetJournalEntryRequestBuilder {
    ...
    public GetJournalEntryRequestBuilder request(GetJournalEntryRequest request) {
    ...
    public GetJournalEntryRequestBuilder retryConfig(Optional<io.codat.accounting.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
