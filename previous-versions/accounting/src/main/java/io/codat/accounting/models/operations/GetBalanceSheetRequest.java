...
public class GetBalanceSheetRequest {
     ...
     * Unique identifier for a company.
     */
    public GetBalanceSheetRequest withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * Number of months defining the period of interest.
     */
    public GetBalanceSheetRequest withPeriodLength(int periodLength) {
        Utils.checkNotNull(periodLength, "periodLength");
        this.periodLength = periodLength;
        return this;
    }
     ...
     * Number of periods with `periodLength` to compare.
     */
    public GetBalanceSheetRequest withPeriodsToCompare(int periodsToCompare) {
        Utils.checkNotNull(periodsToCompare, "periodsToCompare");
        this.periodsToCompare = periodsToCompare;
        return this;
    }
     ...
     * The month the report starts from.
     */
    public GetBalanceSheetRequest withStartMonth(String startMonth) {
        Utils.checkNotNull(startMonth, "startMonth");
     ...
     * The month the report starts from.
     */
    public GetBalanceSheetRequest withStartMonth(Optional<? extends String> startMonth) {
        Utils.checkNotNull(startMonth, "startMonth");
        this.startMonth = startMonth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetBalanceSheetRequest other = (GetBalanceSheetRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetBalanceSheetRequest.class,
                "companyId", companyId,
    ...
    public final static class Builder {
        ...
        public GetBalanceSheetRequest build() {
            return new GetBalanceSheetRequest(
                companyId,
                periodLength,
                periodsToCompare,
                startMonth);
