...
public class ListCustomersResponse {
     ...
     * Success
     */
    private Optional<? extends io.codat.accounting.models.components.Customers> customers;
    ...
    public ListCustomersResponse(
            String contentType,
            Optional<? extends io.codat.accounting.models.components.Customers> customers,
     ...
     * Success
     */
    public Optional<? extends io.codat.accounting.models.components.Customers> customers() {
        return customers;
    }
     ...
     * Success
     */
    public ListCustomersResponse withCustomers(io.codat.accounting.models.components.Customers customers) {
        Utils.checkNotNull(customers, "customers");
     ...
     * Success
     */
    public ListCustomersResponse withCustomers(Optional<? extends io.codat.accounting.models.components.Customers> customers) {
        Utils.checkNotNull(customers, "customers");
        this.customers = customers;
        return this;
    }
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListCustomersResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListCustomersResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.accounting.models.components.Customers> customers = Optional.empty();
         ...
         * Success
         */
        public Builder customers(io.codat.accounting.models.components.Customers customers) {
            Utils.checkNotNull(customers, "customers");
            this.customers = Optional.ofNullable(customers);
            return this;
        }
         ...
         * Success
         */
        public Builder customers(Optional<? extends io.codat.accounting.models.components.Customers> customers) {
            Utils.checkNotNull(customers, "customers");
            this.customers = customers;
            return this;
        }
