...
public class CreateInvoiceRequestBuilder {
    ...
    public CreateInvoiceRequestBuilder request(CreateInvoiceRequest request) {
    ...
    public CreateInvoiceRequestBuilder retryConfig(Optional<io.codat.accounting.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
