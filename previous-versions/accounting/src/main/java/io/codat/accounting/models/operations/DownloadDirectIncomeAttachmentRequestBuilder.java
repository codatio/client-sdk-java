...
public class DownloadDirectIncomeAttachmentRequestBuilder {
    ...
    public DownloadDirectIncomeAttachmentRequestBuilder request(DownloadDirectIncomeAttachmentRequest request) {
    ...
    public DownloadDirectIncomeAttachmentRequestBuilder retryConfig(Optional<io.codat.accounting.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
