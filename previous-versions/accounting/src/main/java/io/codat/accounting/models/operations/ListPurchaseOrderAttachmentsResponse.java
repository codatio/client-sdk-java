...
public class ListPurchaseOrderAttachmentsResponse {
    ...
    public ListPurchaseOrderAttachmentsResponse(
     ...
     * Success
     */
    public ListPurchaseOrderAttachmentsResponse withAttachmentsDataset(io.codat.accounting.models.components.AttachmentsDataset attachmentsDataset) {
        Utils.checkNotNull(attachmentsDataset, "attachmentsDataset");
     ...
     * Success
     */
    public ListPurchaseOrderAttachmentsResponse withAttachmentsDataset(Optional<? extends io.codat.accounting.models.components.AttachmentsDataset> attachmentsDataset) {
        Utils.checkNotNull(attachmentsDataset, "attachmentsDataset");
        this.attachmentsDataset = attachmentsDataset;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public ListPurchaseOrderAttachmentsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public ListPurchaseOrderAttachmentsResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public ListPurchaseOrderAttachmentsResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public ListPurchaseOrderAttachmentsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListPurchaseOrderAttachmentsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListPurchaseOrderAttachmentsResponse other = (ListPurchaseOrderAttachmentsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListPurchaseOrderAttachmentsResponse.class,
    ...
    public final static class Builder {
        ...
        public ListPurchaseOrderAttachmentsResponse build() {
            return new ListPurchaseOrderAttachmentsResponse(
                attachmentsDataset,
                contentType,
                errorMessage,
                statusCode,
