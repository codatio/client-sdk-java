...
public class CreateJournalResponse {
     ...
     * Success
     */
    private Optional<? extends io.codat.accounting.models.components.CreateJournalResponse> createJournalResponse;
    ...
    public CreateJournalResponse(
            String contentType,
            Optional<? extends io.codat.accounting.models.components.CreateJournalResponse> createJournalResponse,
     ...
     * Success
     */
    public Optional<? extends io.codat.accounting.models.components.CreateJournalResponse> createJournalResponse() {
     ...
     * Success
     */
    public CreateJournalResponse withCreateJournalResponse(io.codat.accounting.models.components.CreateJournalResponse createJournalResponse) {
        Utils.checkNotNull(createJournalResponse, "createJournalResponse");
     ...
     * Success
     */
    public CreateJournalResponse withCreateJournalResponse(Optional<? extends io.codat.accounting.models.components.CreateJournalResponse> createJournalResponse) {
        Utils.checkNotNull(createJournalResponse, "createJournalResponse");
        this.createJournalResponse = createJournalResponse;
        return this;
    }
     ...
     * The request made is not valid.
     */
    public CreateJournalResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * The request made is not valid.
     */
    public CreateJournalResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.accounting.models.components.CreateJournalResponse> createJournalResponse = Optional.empty();
         ...
         * Success
         */
        public Builder createJournalResponse(io.codat.accounting.models.components.CreateJournalResponse createJournalResponse) {
            Utils.checkNotNull(createJournalResponse, "createJournalResponse");
            this.createJournalResponse = Optional.ofNullable(createJournalResponse);
            return this;
        }
         ...
         * Success
         */
        public Builder createJournalResponse(Optional<? extends io.codat.accounting.models.components.CreateJournalResponse> createJournalResponse) {
            Utils.checkNotNull(createJournalResponse, "createJournalResponse");
            this.createJournalResponse = createJournalResponse;
            return this;
        }
