...
public class CreateBillCreditNoteResponse {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("data")
    private JsonNullable<? extends AccountingBillCreditNote> data;
    ...
    public CreateBillCreditNoteResponse(
            ...
            @JsonProperty("data") JsonNullable<? extends AccountingBillCreditNote> data,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<AccountingBillCreditNote> data() {
        return (JsonNullable<AccountingBillCreditNote>) data;
    }
     ...
     * Contains a single entry that communicates which record has changed and the manner in which it changed. 
     */
    public CreateBillCreditNoteResponse withChanges(List<PushOperationChange> changes) {
        Utils.checkNotNull(changes, "changes");
     ...
     * Contains a single entry that communicates which record has changed and the manner in which it changed. 
     */
    public CreateBillCreditNoteResponse withChanges(JsonNullable<? extends List<PushOperationChange>> changes) {
        Utils.checkNotNull(changes, "changes");
        this.changes = changes;
        return this;
    }
     ...
     * Unique identifier for your SMB in Codat.
     */
    public CreateBillCreditNoteResponse withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CreateBillCreditNoteResponse withCompletedOnUtc(String completedOnUtc) {
        Utils.checkNotNull(completedOnUtc, "completedOnUtc");
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CreateBillCreditNoteResponse withCompletedOnUtc(Optional<String> completedOnUtc) {
        Utils.checkNotNull(completedOnUtc, "completedOnUtc");
        this.completedOnUtc = completedOnUtc;
        return this;
    }

    public CreateBillCreditNoteResponse withData(AccountingBillCreditNote data) {
        Utils.checkNotNull(data, "data");
        this.data = JsonNullable.of(data);
        return this;
    }

    public CreateBillCreditNoteResponse withData(JsonNullable<? extends AccountingBillCreditNote> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Unique identifier for a company's data connection.
     */
    public CreateBillCreditNoteResponse withDataConnectionKey(String dataConnectionKey) {
        Utils.checkNotNull(dataConnectionKey, "dataConnectionKey");
        this.dataConnectionKey = dataConnectionKey;
        return this;
    }
     ...
     * Available data types
     */
    public CreateBillCreditNoteResponse withDataType(DataType dataType) {
        Utils.checkNotNull(dataType, "dataType");
     ...
     * Available data types
     */
    public CreateBillCreditNoteResponse withDataType(Optional<? extends DataType> dataType) {
        Utils.checkNotNull(dataType, "dataType");
        this.dataType = dataType;
        return this;
    }
     ...
     * A message about the error.
     */
    public CreateBillCreditNoteResponse withErrorMessage(String errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * A message about the error.
     */
    public CreateBillCreditNoteResponse withErrorMessage(JsonNullable<String> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * A unique identifier generated by Codat to represent this single push operation. This identifier can be used to track the status of the push, and should be persisted.
     */
    public CreateBillCreditNoteResponse withPushOperationKey(String pushOperationKey) {
        Utils.checkNotNull(pushOperationKey, "pushOperationKey");
        this.pushOperationKey = pushOperationKey;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CreateBillCreditNoteResponse withRequestedOnUtc(String requestedOnUtc) {
        Utils.checkNotNull(requestedOnUtc, "requestedOnUtc");
        this.requestedOnUtc = requestedOnUtc;
        return this;
    }
     ...
     * The current status of the push operation.
     */
    public CreateBillCreditNoteResponse withStatus(PushOperationStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Number of minutes the push operation must complete within before it times out.
     */
    public CreateBillCreditNoteResponse withTimeoutInMinutes(int timeoutInMinutes) {
        Utils.checkNotNull(timeoutInMinutes, "timeoutInMinutes");
     ...
     * Number of minutes the push operation must complete within before it times out.
     */
    public CreateBillCreditNoteResponse withTimeoutInMinutes(JsonNullable<Integer> timeoutInMinutes) {
        Utils.checkNotNull(timeoutInMinutes, "timeoutInMinutes");
        this.timeoutInMinutes = timeoutInMinutes;
        return this;
    }
     ...
     */
    @Deprecated
    public CreateBillCreditNoteResponse withTimeoutInSeconds(int timeoutInSeconds) {
        Utils.checkNotNull(timeoutInSeconds, "timeoutInSeconds");
     ...
     */
    @Deprecated
    public CreateBillCreditNoteResponse withTimeoutInSeconds(JsonNullable<Integer> timeoutInSeconds) {
        Utils.checkNotNull(timeoutInSeconds, "timeoutInSeconds");
        this.timeoutInSeconds = timeoutInSeconds;
        return this;
    }
     ...
     * A human-readable object describing validation decisions Codat has made when pushing data into the platform. If a push has failed because of validation errors, they will be detailed here.
     */
    public CreateBillCreditNoteResponse withValidation(Validation validation) {
        Utils.checkNotNull(validation, "validation");
     ...
     * A human-readable object describing validation decisions Codat has made when pushing data into the platform. If a push has failed because of validation errors, they will be detailed here.
     */
    public CreateBillCreditNoteResponse withValidation(Optional<? extends Validation> validation) {
        Utils.checkNotNull(validation, "validation");
        this.validation = validation;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends AccountingBillCreditNote> data = JsonNullable.undefined();
        ...
        public Builder data(AccountingBillCreditNote data) {
            Utils.checkNotNull(data, "data");
            this.data = JsonNullable.of(data);
            return this;
        }

        public Builder data(JsonNullable<? extends AccountingBillCreditNote> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
