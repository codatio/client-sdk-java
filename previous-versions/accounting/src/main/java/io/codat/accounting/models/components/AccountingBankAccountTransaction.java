...
public class AccountingBankAccountTransaction {
    ...
    @JsonCreator
    public AccountingBankAccountTransaction(
     ...
     * Unique identifier to the `accountId` the bank transactions originates from.
     */
    public AccountingBankAccountTransaction withAccountId(String accountId) {
        Utils.checkNotNull(accountId, "accountId");
     ...
     * Unique identifier to the `accountId` the bank transactions originates from.
     */
    public AccountingBankAccountTransaction withAccountId(JsonNullable<String> accountId) {
        Utils.checkNotNull(accountId, "accountId");
        this.accountId = accountId;
        return this;
    }
     ...
     * The amount transacted in the bank transaction.
     */
    public AccountingBankAccountTransaction withAmount(BigDecimal amount) {
        Utils.checkNotNull(amount, "amount");
         ...
         * The amount transacted in the bank transaction.
         */
    public AccountingBankAccountTransaction withAmount(double amount) {
     ...
     * The amount transacted in the bank transaction.
     */
    public AccountingBankAccountTransaction withAmount(Optional<? extends BigDecimal> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The remaining balance in the account with ID `accountId`.
     */
    public AccountingBankAccountTransaction withBalance(BigDecimal balance) {
        Utils.checkNotNull(balance, "balance");
         ...
         * The remaining balance in the account with ID `accountId`.
         */
    public AccountingBankAccountTransaction withBalance(double balance) {
     ...
     * The remaining balance in the account with ID `accountId`.
     */
    public AccountingBankAccountTransaction withBalance(Optional<? extends BigDecimal> balance) {
        Utils.checkNotNull(balance, "balance");
        this.balance = balance;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public AccountingBankAccountTransaction withClearedOnDate(String clearedOnDate) {
        Utils.checkNotNull(clearedOnDate, "clearedOnDate");
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public AccountingBankAccountTransaction withClearedOnDate(Optional<String> clearedOnDate) {
        Utils.checkNotNull(clearedOnDate, "clearedOnDate");
        this.clearedOnDate = clearedOnDate;
        return this;
    }
     ...
     * Description of the bank transaction.
     */
    public AccountingBankAccountTransaction withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * Description of the bank transaction.
     */
    public AccountingBankAccountTransaction withDescription(JsonNullable<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * Identifier for the bank transaction, unique to the company in the accounting software.
     */
    public AccountingBankAccountTransaction withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Identifier for the bank transaction, unique to the company in the accounting software.
     */
    public AccountingBankAccountTransaction withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public AccountingBankAccountTransaction withModifiedDate(String modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = Optional.ofNullable(modifiedDate);
        return this;
    }

    public AccountingBankAccountTransaction withModifiedDate(Optional<String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * `True` if the bank transaction has been [reconciled](https://www.xero.com/uk/guides/what-is-bank-reconciliation/) in the accounting software.
     */
    public AccountingBankAccountTransaction withReconciled(boolean reconciled) {
        Utils.checkNotNull(reconciled, "reconciled");
     ...
     * `True` if the bank transaction has been [reconciled](https://www.xero.com/uk/guides/what-is-bank-reconciliation/) in the accounting software.
     */
    public AccountingBankAccountTransaction withReconciled(Optional<Boolean> reconciled) {
        Utils.checkNotNull(reconciled, "reconciled");
        this.reconciled = reconciled;
        return this;
    }

    public AccountingBankAccountTransaction withSourceModifiedDate(String sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = Optional.ofNullable(sourceModifiedDate);
        return this;
    }

    public AccountingBankAccountTransaction withSourceModifiedDate(Optional<String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * Type of transaction for the bank statement line.
     */
    public AccountingBankAccountTransaction withTransactionType(BankTransactionType transactionType) {
        Utils.checkNotNull(transactionType, "transactionType");
     ...
     * Type of transaction for the bank statement line.
     */
    public AccountingBankAccountTransaction withTransactionType(Optional<? extends BankTransactionType> transactionType) {
        Utils.checkNotNull(transactionType, "transactionType");
        this.transactionType = transactionType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountingBankAccountTransaction other = (AccountingBankAccountTransaction) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AccountingBankAccountTransaction.class,
                "accountId", accountId,
                "amount", amount,
                "balance", balance,
    ...
    public final static class Builder {
        ...
        public AccountingBankAccountTransaction build() {
            return new AccountingBankAccountTransaction(
                accountId,
                amount,
                balance,
                clearedOnDate,
