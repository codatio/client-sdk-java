...
public class DirectCost {
    ...
    private List<DirectCostAccountingPaymentAllocation> paymentAllocations;
    ...
    public DirectCost(
            ...
            @JsonProperty("paymentAllocations") List<DirectCostAccountingPaymentAllocation> paymentAllocations,
    ...
    public DirectCost(
            ...
            List<DirectCostAccountingPaymentAllocation> paymentAllocations,
            BigDecimal subTotal,
     ...
     */
    @JsonIgnore
    public List<DirectCostAccountingPaymentAllocation> paymentAllocations() {
    ...
    public DirectCost withContactRef(ContactRef contactRef) {
        Utils.checkNotNull(contactRef, "contactRef");
        this.contactRef = Optional.ofNullable(contactRef);
        return this;
    }

    public DirectCost withContactRef(Optional<? extends ContactRef> contactRef) {
        Utils.checkNotNull(contactRef, "contactRef");
        this.contactRef = contactRef;
        return this;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public DirectCost withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
     */
    public DirectCost withCurrencyRate(BigDecimal currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
         ...
         * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
         */
    public DirectCost withCurrencyRate(double currencyRate) {
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
     */
    public DirectCost withCurrencyRate(JsonNullable<? extends BigDecimal> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }
     ...
     * Identifier of the direct cost, unique for the company.
     */
    public DirectCost withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Identifier of the direct cost, unique for the company.
     */
    public DirectCost withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public DirectCost withIssueDate(String issueDate) {
        Utils.checkNotNull(issueDate, "issueDate");
        this.issueDate = issueDate;
        return this;
    }
     ...
     * An array of line items.
     */
    public DirectCost withLineItems(List<DirectCostLineItem> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = lineItems;
        return this;
    }

    public DirectCost withMetadata(Metadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = Optional.ofNullable(metadata);
        return this;
    }

    public DirectCost withMetadata(Optional<? extends Metadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }

    public DirectCost withModifiedDate(String modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = Optional.ofNullable(modifiedDate);
        return this;
    }

    public DirectCost withModifiedDate(Optional<String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * A note attached to the direct cost.
     */
    public DirectCost withNote(String note) {
        Utils.checkNotNull(note, "note");
     ...
     * A note attached to the direct cost.
     */
    public DirectCost withNote(JsonNullable<String> note) {
        Utils.checkNotNull(note, "note");
        this.note = note;
        return this;
    }
     ...
     * An array of payment allocations.
     */
    public DirectCost withPaymentAllocations(List<DirectCostAccountingPaymentAllocation> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
        this.paymentAllocations = paymentAllocations;
        return this;
    }
     ...
     * User-friendly reference for the direct cost.
     */
    public DirectCost withReference(String reference) {
        Utils.checkNotNull(reference, "reference");
     ...
     * User-friendly reference for the direct cost.
     */
    public DirectCost withReference(JsonNullable<String> reference) {
        Utils.checkNotNull(reference, "reference");
        this.reference = reference;
        return this;
    }

    public DirectCost withSourceModifiedDate(String sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = Optional.ofNullable(sourceModifiedDate);
        return this;
    }

    public DirectCost withSourceModifiedDate(Optional<String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
         ...
         * The total amount of the direct costs, excluding any taxes.
         */
    public DirectCost withSubTotal(double subTotal) {
     ...
     * The total amount of the direct costs, excluding any taxes.
     */
    public DirectCost withSubTotal(BigDecimal subTotal) {
        Utils.checkNotNull(subTotal, "subTotal");
        this.subTotal = subTotal;
        return this;
    }
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting software. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public DirectCost withSupplementalData(SupplementalData supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting software. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public DirectCost withSupplementalData(Optional<? extends SupplementalData> supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
        this.supplementalData = supplementalData;
        return this;
    }
         ...
         * The total amount of tax on the direct costs.
         */
    public DirectCost withTaxAmount(double taxAmount) {
     ...
     * The total amount of tax on the direct costs.
     */
    public DirectCost withTaxAmount(BigDecimal taxAmount) {
        Utils.checkNotNull(taxAmount, "taxAmount");
        this.taxAmount = taxAmount;
        return this;
    }
         ...
         * The amount of the direct costs, inclusive of tax.
         */
    public DirectCost withTotalAmount(double totalAmount) {
     ...
     * The amount of the direct costs, inclusive of tax.
     */
    public DirectCost withTotalAmount(BigDecimal totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(DirectCost.class,
    ...
    public final static class Builder {
         ...
         * An array of payment allocations.
         */
        public Builder paymentAllocations(List<DirectCostAccountingPaymentAllocation> paymentAllocations) {
            Utils.checkNotNull(paymentAllocations, "paymentAllocations");
            this.paymentAllocations = paymentAllocations;
            return this;
        }
