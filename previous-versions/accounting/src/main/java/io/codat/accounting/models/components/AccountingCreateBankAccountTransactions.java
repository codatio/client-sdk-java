...
public class AccountingCreateBankAccountTransactions {
     ...
     * Unique identifier for a bank account.
     */
    public AccountingCreateBankAccountTransactions withAccountId(Optional<String> accountId) {
        Utils.checkNotNull(accountId, "accountId");
        this.accountId = accountId;
        return this;
    }

    public AccountingCreateBankAccountTransactions withTransactions(List<CreateBankAccountTransaction> transactions) {
        Utils.checkNotNull(transactions, "transactions");
        this.transactions = Optional.ofNullable(transactions);
        return this;
    }

    public AccountingCreateBankAccountTransactions withTransactions(Optional<? extends List<CreateBankAccountTransaction>> transactions) {
        Utils.checkNotNull(transactions, "transactions");
        this.transactions = transactions;
        return this;
    }
