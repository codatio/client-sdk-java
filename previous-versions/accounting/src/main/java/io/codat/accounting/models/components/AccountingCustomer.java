...
public class AccountingCustomer {
     ...
     * An array of Addresses.
     */
    public AccountingCustomer withAddresses(java.util.List<Items> addresses) {
        Utils.checkNotNull(addresses, "addresses");
     ...
     * An array of Addresses.
     */
    public AccountingCustomer withAddresses(JsonNullable<? extends java.util.List<Items>> addresses) {
        Utils.checkNotNull(addresses, "addresses");
        this.addresses = addresses;
        return this;
    }
