...
public class UpdatePurchaseOrderResponseAccountingPurchaseOrder {
     ...
     * The user who created the purchase order in the accounting system
     */
    public Optional<? extends UpdatePurchaseOrderResponseUser> createdBy() {
        return createdBy;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public UpdatePurchaseOrderResponseAccountingPurchaseOrder withCurrency(Optional<? extends String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, include the required currency rate in the expense transaction.  |
     */
    public UpdatePurchaseOrderResponseAccountingPurchaseOrder withCurrencyRate(JsonNullable<? extends Double> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public UpdatePurchaseOrderResponseAccountingPurchaseOrder withDeliveryDate(Optional<? extends String> deliveryDate) {
        Utils.checkNotNull(deliveryDate, "deliveryDate");
        this.deliveryDate = deliveryDate;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public UpdatePurchaseOrderResponseAccountingPurchaseOrder withExpectedDeliveryDate(Optional<? extends String> expectedDeliveryDate) {
        Utils.checkNotNull(expectedDeliveryDate, "expectedDeliveryDate");
        this.expectedDeliveryDate = expectedDeliveryDate;
        return this;
    }
     ...
     * Identifier for the purchase order, unique for the company in the accounting platform.
     */
    public UpdatePurchaseOrderResponseAccountingPurchaseOrder withId(Optional<? extends String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public UpdatePurchaseOrderResponseAccountingPurchaseOrder withIssueDate(Optional<? extends String> issueDate) {
        Utils.checkNotNull(issueDate, "issueDate");
        this.issueDate = issueDate;
        return this;
    }
     ...
     * Array of line items.
     */
    public UpdatePurchaseOrderResponseAccountingPurchaseOrder withLineItems(java.util.List<PurchaseOrderLineItem> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
     ...
     * Array of line items.
     */
    public UpdatePurchaseOrderResponseAccountingPurchaseOrder withLineItems(JsonNullable<? extends java.util.List<PurchaseOrderLineItem>> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = lineItems;
        return this;
    }
    ...
    public UpdatePurchaseOrderResponseAccountingPurchaseOrder withModifiedDate(Optional<? extends String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Any additional information associated with the purchase order.
     */
    public UpdatePurchaseOrderResponseAccountingPurchaseOrder withNote(JsonNullable<? extends String> note) {
        Utils.checkNotNull(note, "note");
        this.note = note;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public UpdatePurchaseOrderResponseAccountingPurchaseOrder withPaymentDueDate(Optional<? extends String> paymentDueDate) {
        Utils.checkNotNull(paymentDueDate, "paymentDueDate");
        this.paymentDueDate = paymentDueDate;
        return this;
    }
     ...
     * Friendly reference for the purchase order, commonly generated by the accounting platform.
     */
    public UpdatePurchaseOrderResponseAccountingPurchaseOrder withPurchaseOrderNumber(JsonNullable<? extends String> purchaseOrderNumber) {
        Utils.checkNotNull(purchaseOrderNumber, "purchaseOrderNumber");
        this.purchaseOrderNumber = purchaseOrderNumber;
        return this;
    }
    ...
    public UpdatePurchaseOrderResponseAccountingPurchaseOrder withSourceModifiedDate(Optional<? extends String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * Total amount of the purchase order, including discounts but excluding tax.
     */
    public UpdatePurchaseOrderResponseAccountingPurchaseOrder withSubTotal(Optional<? extends Double> subTotal) {
        Utils.checkNotNull(subTotal, "subTotal");
        this.subTotal = subTotal;
        return this;
    }
     ...
     * Total amount of the purchase order, including discounts and tax.
     */
    public UpdatePurchaseOrderResponseAccountingPurchaseOrder withTotalAmount(Optional<? extends Double> totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
     ...
     * Total value of any discounts applied to the purchase order.
     */
    public UpdatePurchaseOrderResponseAccountingPurchaseOrder withTotalDiscount(Optional<? extends Double> totalDiscount) {
        Utils.checkNotNull(totalDiscount, "totalDiscount");
        this.totalDiscount = totalDiscount;
        return this;
    }
     ...
     * Total amount of tax included in the purchase order.
     */
    public UpdatePurchaseOrderResponseAccountingPurchaseOrder withTotalTaxAmount(Optional<? extends Double> totalTaxAmount) {
        Utils.checkNotNull(totalTaxAmount, "totalTaxAmount");
        this.totalTaxAmount = totalTaxAmount;
        return this;
    }
