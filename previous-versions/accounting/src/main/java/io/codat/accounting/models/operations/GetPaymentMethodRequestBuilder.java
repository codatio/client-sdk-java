...
public class GetPaymentMethodRequestBuilder {
    ...
    public GetPaymentMethodRequestBuilder request(GetPaymentMethodRequest request) {
    ...
    public GetPaymentMethodRequestBuilder retryConfig(Optional<io.codat.accounting.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
