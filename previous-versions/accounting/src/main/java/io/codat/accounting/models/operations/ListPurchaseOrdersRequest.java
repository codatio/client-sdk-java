...
public class ListPurchaseOrdersRequest {
     ...
     * Unique identifier for a company.
     */
    public ListPurchaseOrdersRequest withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * Field to order results by. [Read more](https://docs.codat.io/using-the-api/ordering-results).
     */
    public ListPurchaseOrdersRequest withOrderBy(String orderBy) {
        Utils.checkNotNull(orderBy, "orderBy");
     ...
     * Field to order results by. [Read more](https://docs.codat.io/using-the-api/ordering-results).
     */
    public ListPurchaseOrdersRequest withOrderBy(Optional<? extends String> orderBy) {
        Utils.checkNotNull(orderBy, "orderBy");
        this.orderBy = orderBy;
        return this;
    }
     ...
     * Page number. [Read more](https://docs.codat.io/using-the-api/paging).
     */
    public ListPurchaseOrdersRequest withPage(int page) {
        Utils.checkNotNull(page, "page");
     ...
     * Page number. [Read more](https://docs.codat.io/using-the-api/paging).
     */
    public ListPurchaseOrdersRequest withPage(Optional<? extends Integer> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * Number of records to return in a page. [Read more](https://docs.codat.io/using-the-api/paging).
     */
    public ListPurchaseOrdersRequest withPageSize(int pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * Number of records to return in a page. [Read more](https://docs.codat.io/using-the-api/paging).
     */
    public ListPurchaseOrdersRequest withPageSize(Optional<? extends Integer> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * Codat query string. [Read more](https://docs.codat.io/using-the-api/querying).
     */
    public ListPurchaseOrdersRequest withQuery(String query) {
        Utils.checkNotNull(query, "query");
     ...
     * Codat query string. [Read more](https://docs.codat.io/using-the-api/querying).
     */
    public ListPurchaseOrdersRequest withQuery(Optional<? extends String> query) {
        Utils.checkNotNull(query, "query");
        this.query = query;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListPurchaseOrdersRequest other = (ListPurchaseOrdersRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListPurchaseOrdersRequest.class,
                "companyId", companyId,
                "orderBy", orderBy,
                "page", page,
                "pageSize", pageSize,
