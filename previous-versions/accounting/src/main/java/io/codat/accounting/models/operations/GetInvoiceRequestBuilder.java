...
public class GetInvoiceRequestBuilder {
    ...
    public GetInvoiceRequestBuilder request(GetInvoiceRequest request) {
    ...
    public GetInvoiceRequestBuilder retryConfig(Optional<io.codat.accounting.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
