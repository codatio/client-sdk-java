...
public class ListDirectIncomeAttachmentsResponse {
    ...
    public ListDirectIncomeAttachmentsResponse(
     ...
     * Success
     */
    public ListDirectIncomeAttachmentsResponse withAttachmentsDataset(io.codat.accounting.models.components.AttachmentsDataset attachmentsDataset) {
        Utils.checkNotNull(attachmentsDataset, "attachmentsDataset");
     ...
     * Success
     */
    public ListDirectIncomeAttachmentsResponse withAttachmentsDataset(Optional<? extends io.codat.accounting.models.components.AttachmentsDataset> attachmentsDataset) {
        Utils.checkNotNull(attachmentsDataset, "attachmentsDataset");
        this.attachmentsDataset = attachmentsDataset;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public ListDirectIncomeAttachmentsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public ListDirectIncomeAttachmentsResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public ListDirectIncomeAttachmentsResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public ListDirectIncomeAttachmentsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListDirectIncomeAttachmentsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListDirectIncomeAttachmentsResponse other = (ListDirectIncomeAttachmentsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListDirectIncomeAttachmentsResponse.class,
    ...
    public final static class Builder {
        ...
        public ListDirectIncomeAttachmentsResponse build() {
            return new ListDirectIncomeAttachmentsResponse(
                attachmentsDataset,
                contentType,
                errorMessage,
                statusCode,
