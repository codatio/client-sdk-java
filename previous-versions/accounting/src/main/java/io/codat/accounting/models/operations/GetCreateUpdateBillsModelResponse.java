...
public class GetCreateUpdateBillsModelResponse {
    ...
    public GetCreateUpdateBillsModelResponse(
            String contentType,
     ...
     * HTTP response content type for this operation
     */
    public GetCreateUpdateBillsModelResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public GetCreateUpdateBillsModelResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public GetCreateUpdateBillsModelResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * OK
     */
    public GetCreateUpdateBillsModelResponse withPushOption(io.codat.accounting.models.components.PushOption pushOption) {
        Utils.checkNotNull(pushOption, "pushOption");
     ...
     * OK
     */
    public GetCreateUpdateBillsModelResponse withPushOption(Optional<? extends io.codat.accounting.models.components.PushOption> pushOption) {
        Utils.checkNotNull(pushOption, "pushOption");
        this.pushOption = pushOption;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetCreateUpdateBillsModelResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetCreateUpdateBillsModelResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCreateUpdateBillsModelResponse other = (GetCreateUpdateBillsModelResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCreateUpdateBillsModelResponse.class,
    ...
    public final static class Builder {
        ...
        public GetCreateUpdateBillsModelResponse build() {
            return new GetCreateUpdateBillsModelResponse(
                contentType,
                errorMessage,
                pushOption,
                statusCode,
