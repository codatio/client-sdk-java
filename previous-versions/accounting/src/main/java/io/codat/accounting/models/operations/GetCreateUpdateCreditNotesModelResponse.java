...
public class GetCreateUpdateCreditNotesModelResponse {
    ...
    public GetCreateUpdateCreditNotesModelResponse(
            String contentType,
     ...
     * HTTP response content type for this operation
     */
    public GetCreateUpdateCreditNotesModelResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public GetCreateUpdateCreditNotesModelResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public GetCreateUpdateCreditNotesModelResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * OK
     */
    public GetCreateUpdateCreditNotesModelResponse withPushOption(io.codat.accounting.models.components.PushOption pushOption) {
        Utils.checkNotNull(pushOption, "pushOption");
     ...
     * OK
     */
    public GetCreateUpdateCreditNotesModelResponse withPushOption(Optional<? extends io.codat.accounting.models.components.PushOption> pushOption) {
        Utils.checkNotNull(pushOption, "pushOption");
        this.pushOption = pushOption;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetCreateUpdateCreditNotesModelResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetCreateUpdateCreditNotesModelResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCreateUpdateCreditNotesModelResponse other = (GetCreateUpdateCreditNotesModelResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCreateUpdateCreditNotesModelResponse.class,
    ...
    public final static class Builder {
        ...
        public GetCreateUpdateCreditNotesModelResponse build() {
            return new GetCreateUpdateCreditNotesModelResponse(
                contentType,
                errorMessage,
                pushOption,
                statusCode,
