...
public class UpdateBillCreditNoteResponseAccountingBillCreditNote {
    ...
    @JsonCreator
    public UpdateBillCreditNoteResponseAccountingBillCreditNote(
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withAllocatedOnDate(String allocatedOnDate) {
        Utils.checkNotNull(allocatedOnDate, "allocatedOnDate");
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withAllocatedOnDate(Optional<String> allocatedOnDate) {
        Utils.checkNotNull(allocatedOnDate, "allocatedOnDate");
        this.allocatedOnDate = allocatedOnDate;
        return this;
    }
     ...
     * Friendly reference for the bill credit note.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withBillCreditNoteNumber(String billCreditNoteNumber) {
        Utils.checkNotNull(billCreditNoteNumber, "billCreditNoteNumber");
     ...
     * Friendly reference for the bill credit note.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withBillCreditNoteNumber(JsonNullable<String> billCreditNoteNumber) {
        Utils.checkNotNull(billCreditNoteNumber, "billCreditNoteNumber");
        this.billCreditNoteNumber = billCreditNoteNumber;
        return this;
    }
     ...
     * An array of records the credit note was created from.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withCreatedFromRefs(List<InvoiceTo> createdFromRefs) {
        Utils.checkNotNull(createdFromRefs, "createdFromRefs");
     ...
     * An array of records the credit note was created from.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withCreatedFromRefs(JsonNullable<? extends List<InvoiceTo>> createdFromRefs) {
        Utils.checkNotNull(createdFromRefs, "createdFromRefs");
        this.createdFromRefs = createdFromRefs;
        return this;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withCurrency(Optional<String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withCurrencyRate(BigDecimal currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
         ...
         * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
         */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withCurrencyRate(double currencyRate) {
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withCurrencyRate(JsonNullable<? extends BigDecimal> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }
         ...
         * Percentage rate of any discount applied to the bill credit note.
         */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withDiscountPercentage(double discountPercentage) {
     ...
     * Percentage rate of any discount applied to the bill credit note.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withDiscountPercentage(BigDecimal discountPercentage) {
        Utils.checkNotNull(discountPercentage, "discountPercentage");
        this.discountPercentage = discountPercentage;
        return this;
    }
     ...
     * Identifier for the bill credit note that is unique to a company in the accounting software.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Identifier for the bill credit note that is unique to a company in the accounting software.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withIssueDate(String issueDate) {
        Utils.checkNotNull(issueDate, "issueDate");
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withIssueDate(Optional<String> issueDate) {
        Utils.checkNotNull(issueDate, "issueDate");
        this.issueDate = issueDate;
        return this;
    }
     ...
     * An array of line 
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withLineItems(List<BillCreditNoteLineItem> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
     ...
     * An array of line 
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withLineItems(JsonNullable<? extends List<BillCreditNoteLineItem>> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = lineItems;
        return this;
    }

    public UpdateBillCreditNoteResponseAccountingBillCreditNote withMetadata(Metadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = Optional.ofNullable(metadata);
        return this;
    }

    public UpdateBillCreditNoteResponseAccountingBillCreditNote withMetadata(Optional<? extends Metadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }

    public UpdateBillCreditNoteResponseAccountingBillCreditNote withModifiedDate(String modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = Optional.ofNullable(modifiedDate);
        return this;
    }

    public UpdateBillCreditNoteResponseAccountingBillCreditNote withModifiedDate(Optional<String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Any additional information about the bill credit note.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withNote(String note) {
        Utils.checkNotNull(note, "note");
     ...
     * Any additional information about the bill credit note.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withNote(JsonNullable<String> note) {
        Utils.checkNotNull(note, "note");
        this.note = note;
        return this;
    }
     ...
     * An array of payment allocations.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withPaymentAllocations(List<PaymentAllocationItems> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
     ...
     * An array of payment allocations.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withPaymentAllocations(JsonNullable<? extends List<PaymentAllocationItems>> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
        this.paymentAllocations = paymentAllocations;
        return this;
    }
     ...
     * Amount of the bill credit note that is still outstanding.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withRemainingCredit(BigDecimal remainingCredit) {
        Utils.checkNotNull(remainingCredit, "remainingCredit");
         ...
         * Amount of the bill credit note that is still outstanding.
         */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withRemainingCredit(double remainingCredit) {
     ...
     * Amount of the bill credit note that is still outstanding.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withRemainingCredit(Optional<? extends BigDecimal> remainingCredit) {
        Utils.checkNotNull(remainingCredit, "remainingCredit");
        this.remainingCredit = remainingCredit;
        return this;
    }

    public UpdateBillCreditNoteResponseAccountingBillCreditNote withSourceModifiedDate(String sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = Optional.ofNullable(sourceModifiedDate);
        return this;
    }

    public UpdateBillCreditNoteResponseAccountingBillCreditNote withSourceModifiedDate(Optional<String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * Current state of the bill credit note
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withStatus(BillCreditNoteStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
         ...
         * Total amount of the bill credit note, including discounts but excluding tax.
         */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withSubTotal(double subTotal) {
     ...
     * Total amount of the bill credit note, including discounts but excluding tax.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withSubTotal(BigDecimal subTotal) {
        Utils.checkNotNull(subTotal, "subTotal");
        this.subTotal = subTotal;
        return this;
    }
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting software. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withSupplementalData(SupplementalData supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting software. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withSupplementalData(Optional<? extends SupplementalData> supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
        this.supplementalData = supplementalData;
        return this;
    }
     ...
     * Reference to the supplier the record relates to.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withSupplierRef(SupplierRef supplierRef) {
        Utils.checkNotNull(supplierRef, "supplierRef");
     ...
     * Reference to the supplier the record relates to.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withSupplierRef(Optional<? extends SupplierRef> supplierRef) {
        Utils.checkNotNull(supplierRef, "supplierRef");
        this.supplierRef = supplierRef;
        return this;
    }
         ...
         * Total amount of credit that has been applied to the business' account with the supplier, including discounts and tax.
         */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withTotalAmount(double totalAmount) {
     ...
     * Total amount of credit that has been applied to the business' account with the supplier, including discounts and tax.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withTotalAmount(BigDecimal totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
         ...
         * Total value of any discounts applied.
         */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withTotalDiscount(double totalDiscount) {
     ...
     * Total value of any discounts applied.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withTotalDiscount(BigDecimal totalDiscount) {
        Utils.checkNotNull(totalDiscount, "totalDiscount");
        this.totalDiscount = totalDiscount;
        return this;
    }
         ...
         * Amount of tax included in the bill credit note.
         */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withTotalTaxAmount(double totalTaxAmount) {
     ...
     * Amount of tax included in the bill credit note.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withTotalTaxAmount(BigDecimal totalTaxAmount) {
        Utils.checkNotNull(totalTaxAmount, "totalTaxAmount");
        this.totalTaxAmount = totalTaxAmount;
        return this;
    }

    public UpdateBillCreditNoteResponseAccountingBillCreditNote withWithholdingTax(List<WithholdingTaxItems> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = JsonNullable.of(withholdingTax);
        return this;
    }

    public UpdateBillCreditNoteResponseAccountingBillCreditNote withWithholdingTax(JsonNullable<? extends List<WithholdingTaxItems>> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = withholdingTax;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateBillCreditNoteResponseAccountingBillCreditNote other = (UpdateBillCreditNoteResponseAccountingBillCreditNote) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateBillCreditNoteResponseAccountingBillCreditNote.class,
    ...
    public final static class Builder {
        ...
        public UpdateBillCreditNoteResponseAccountingBillCreditNote build() {
            return new UpdateBillCreditNoteResponseAccountingBillCreditNote(
                allocatedOnDate,
                billCreditNoteNumber,
                createdFromRefs,
                currency,
