...
public class UpdateBillCreditNoteResponseAccountingBillCreditNote {
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withAllocatedOnDate(Optional<? extends String> allocatedOnDate) {
        Utils.checkNotNull(allocatedOnDate, "allocatedOnDate");
        this.allocatedOnDate = allocatedOnDate;
        return this;
    }
     ...
     * Friendly reference for the bill credit note.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withBillCreditNoteNumber(JsonNullable<? extends String> billCreditNoteNumber) {
        Utils.checkNotNull(billCreditNoteNumber, "billCreditNoteNumber");
        this.billCreditNoteNumber = billCreditNoteNumber;
        return this;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withCurrency(Optional<? extends String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, include the required currency rate in the expense transaction.  |
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withCurrencyRate(JsonNullable<? extends Double> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }
     ...
     * Identifier for the bill credit note that is unique to a company in the accounting platform.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withId(Optional<? extends String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withIssueDate(Optional<? extends String> issueDate) {
        Utils.checkNotNull(issueDate, "issueDate");
        this.issueDate = issueDate;
        return this;
    }
     ...
     * An array of line 
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withLineItems(java.util.List<BillCreditNoteLineItem> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
     ...
     * An array of line 
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withLineItems(JsonNullable<? extends java.util.List<BillCreditNoteLineItem>> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = lineItems;
        return this;
    }
    ...
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withModifiedDate(Optional<? extends String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Any additional information about the bill credit note.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withNote(JsonNullable<? extends String> note) {
        Utils.checkNotNull(note, "note");
        this.note = note;
        return this;
    }
     ...
     * An array of payment allocations.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withPaymentAllocations(java.util.List<PaymentAllocationItems> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
     ...
     * An array of payment allocations.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withPaymentAllocations(JsonNullable<? extends java.util.List<PaymentAllocationItems>> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
        this.paymentAllocations = paymentAllocations;
        return this;
    }
     ...
     * Amount of the bill credit note that is still outstanding.
     */
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withRemainingCredit(Optional<? extends Double> remainingCredit) {
        Utils.checkNotNull(remainingCredit, "remainingCredit");
        this.remainingCredit = remainingCredit;
        return this;
    }
    ...
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withSourceModifiedDate(Optional<? extends String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
    ...
    public UpdateBillCreditNoteResponseAccountingBillCreditNote withWithholdingTax(java.util.List<WithholdingTaxItems> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = JsonNullable.of(withholdingTax);
        return this;
    }

    public UpdateBillCreditNoteResponseAccountingBillCreditNote withWithholdingTax(JsonNullable<? extends java.util.List<WithholdingTaxItems>> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = withholdingTax;
        return this;
    }
