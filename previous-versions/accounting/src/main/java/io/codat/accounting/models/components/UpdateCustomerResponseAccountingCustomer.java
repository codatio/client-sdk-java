...
public class UpdateCustomerResponseAccountingCustomer {
     ...
     * An array of Addresses.
     */
    public UpdateCustomerResponseAccountingCustomer withAddresses(java.util.List<Items> addresses) {
        Utils.checkNotNull(addresses, "addresses");
     ...
     * An array of Addresses.
     */
    public UpdateCustomerResponseAccountingCustomer withAddresses(JsonNullable<? extends java.util.List<Items>> addresses) {
        Utils.checkNotNull(addresses, "addresses");
        this.addresses = addresses;
        return this;
    }
