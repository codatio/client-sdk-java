...
public class AccountingDirectCost {
    ...
    private Optional<? extends CreateDirectCostResponseContactReference> contactRef;
    ...
    private java.util.List<CreateDirectCostResponseAccountingPaymentAllocation> paymentAllocations;
    ...
    public AccountingDirectCost(
            @JsonProperty("contactRef") Optional<? extends CreateDirectCostResponseContactReference> contactRef,
            ...
            @JsonProperty("paymentAllocations") java.util.List<CreateDirectCostResponseAccountingPaymentAllocation> paymentAllocations,
     ...
     * A customer or supplier associated with the direct cost.
     */
    public Optional<? extends CreateDirectCostResponseContactReference> contactRef() {
        return contactRef;
    }
     ...
     * An array of payment allocations.
     */
    public java.util.List<CreateDirectCostResponseAccountingPaymentAllocation> paymentAllocations() {
     ...
     * A customer or supplier associated with the direct cost.
     */
    public AccountingDirectCost withContactRef(CreateDirectCostResponseContactReference contactRef) {
        Utils.checkNotNull(contactRef, "contactRef");
     ...
     * A customer or supplier associated with the direct cost.
     */
    public AccountingDirectCost withContactRef(Optional<? extends CreateDirectCostResponseContactReference> contactRef) {
        Utils.checkNotNull(contactRef, "contactRef");
        this.contactRef = contactRef;
        return this;
    }
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, include the required currency rate in the expense transaction.  |
     */
    public AccountingDirectCost withCurrencyRate(JsonNullable<? extends Double> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }
     ...
     * Identifier of the direct cost, unique for the company.
     */
    public AccountingDirectCost withId(Optional<? extends String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * An array of line items.
     */
    public AccountingDirectCost withLineItems(java.util.List<DirectCostLineItem> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = lineItems;
        return this;
    }
    ...
    public AccountingDirectCost withModifiedDate(Optional<? extends String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * A note attached to the direct cost.
     */
    public AccountingDirectCost withNote(JsonNullable<? extends String> note) {
        Utils.checkNotNull(note, "note");
        this.note = note;
        return this;
    }
     ...
     * An array of payment allocations.
     */
    public AccountingDirectCost withPaymentAllocations(java.util.List<CreateDirectCostResponseAccountingPaymentAllocation> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
        this.paymentAllocations = paymentAllocations;
        return this;
    }
     ...
     * User-friendly reference for the direct cost.
     */
    public AccountingDirectCost withReference(JsonNullable<? extends String> reference) {
        Utils.checkNotNull(reference, "reference");
        this.reference = reference;
        return this;
    }
    ...
    public AccountingDirectCost withSourceModifiedDate(Optional<? extends String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends CreateDirectCostResponseContactReference> contactRef = Optional.empty();
         ...
         * A customer or supplier associated with the direct cost.
         */
        public Builder contactRef(CreateDirectCostResponseContactReference contactRef) {
            Utils.checkNotNull(contactRef, "contactRef");
            this.contactRef = Optional.ofNullable(contactRef);
            return this;
        }
         ...
         * A customer or supplier associated with the direct cost.
         */
        public Builder contactRef(Optional<? extends CreateDirectCostResponseContactReference> contactRef) {
            Utils.checkNotNull(contactRef, "contactRef");
            this.contactRef = contactRef;
            return this;
        }
         ...
         * An array of payment allocations.
         */
        public Builder paymentAllocations(java.util.List<CreateDirectCostResponseAccountingPaymentAllocation> paymentAllocations) {
            Utils.checkNotNull(paymentAllocations, "paymentAllocations");
            this.paymentAllocations = paymentAllocations;
            return this;
        }
