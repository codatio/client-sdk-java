...
public class TaxRate {
    ...
    private JsonNullable<? extends List<TaxRateComponent>> components;
    ...
    public TaxRate(
            ...
            @JsonProperty("components") JsonNullable<? extends List<TaxRateComponent>> components,
            ...
            @JsonProperty("validDatatypeLinks") JsonNullable<? extends List<ValidDataTypeLinks>> validDatatypeLinks) {
    ...
    public TaxRate() {
        this(JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), Optional.empty(), Optional.empty(), Optional.empty(), JsonNullable.undefined(), Optional.empty(), Optional.empty(), Optional.empty(), JsonNullable.undefined(), JsonNullable.undefined());
    }
    ...
    @JsonIgnore
    public JsonNullable<List<TaxRateComponent>> components() {
        return (JsonNullable<List<TaxRateComponent>>) components;
    }
    ...
    public JsonNullable<List<ValidDataTypeLinks>> validDatatypeLinks() {
        return (JsonNullable<List<ValidDataTypeLinks>>) validDatatypeLinks;
    }
    ...
    public TaxRate withComponents(List<TaxRateComponent> components) {
        Utils.checkNotNull(components, "components");
        this.components = JsonNullable.of(components);
        return this;
    }

    public TaxRate withComponents(JsonNullable<? extends List<TaxRateComponent>> components) {
        Utils.checkNotNull(components, "components");
        this.components = components;
        return this;
    }
     ...
     * See Effective tax rates description.
     */
    public TaxRate withEffectiveTaxRate(BigDecimal effectiveTaxRate) {
        Utils.checkNotNull(effectiveTaxRate, "effectiveTaxRate");
     ...
     * See Effective tax rates description.
     */
    public TaxRate withEffectiveTaxRate(JsonNullable<? extends BigDecimal> effectiveTaxRate) {
        Utils.checkNotNull(effectiveTaxRate, "effectiveTaxRate");
        this.effectiveTaxRate = effectiveTaxRate;
        return this;
    }
     ...
     * Identifier for the tax rate, unique for the company in the accounting software.
     */
    public TaxRate withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
    ...
    public TaxRate withModifiedDate(Optional<String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Codat-augmented name of the tax rate in the accounting software.
     */
    public TaxRate withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
    ...
    public TaxRate withSourceModifiedDate(Optional<String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * Total (not compounded) sum of the components of a tax rate.
     */
    public TaxRate withTotalTaxRate(BigDecimal totalTaxRate) {
        Utils.checkNotNull(totalTaxRate, "totalTaxRate");
     ...
     * Total (not compounded) sum of the components of a tax rate.
     */
    public TaxRate withTotalTaxRate(JsonNullable<? extends BigDecimal> totalTaxRate) {
        Utils.checkNotNull(totalTaxRate, "totalTaxRate");
        this.totalTaxRate = totalTaxRate;
        return this;
    }

    public TaxRate withValidDatatypeLinks(List<ValidDataTypeLinks> validDatatypeLinks) {
        Utils.checkNotNull(validDatatypeLinks, "validDatatypeLinks");
        this.validDatatypeLinks = JsonNullable.of(validDatatypeLinks);
        return this;
    }

    public TaxRate withValidDatatypeLinks(JsonNullable<? extends List<ValidDataTypeLinks>> validDatatypeLinks) {
        Utils.checkNotNull(validDatatypeLinks, "validDatatypeLinks");
        this.validDatatypeLinks = validDatatypeLinks;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends List<TaxRateComponent>> components = JsonNullable.undefined();
        ...
        public Builder components(List<TaxRateComponent> components) {
            Utils.checkNotNull(components, "components");
            this.components = JsonNullable.of(components);
            return this;
        }

        public Builder components(JsonNullable<? extends List<TaxRateComponent>> components) {
            Utils.checkNotNull(components, "components");
            this.components = components;
            return this;
        }
        ...
        public Builder validDatatypeLinks(List<ValidDataTypeLinks> validDatatypeLinks) {
            Utils.checkNotNull(validDatatypeLinks, "validDatatypeLinks");
            this.validDatatypeLinks = JsonNullable.of(validDatatypeLinks);
            return this;
        }

        public Builder validDatatypeLinks(JsonNullable<? extends List<ValidDataTypeLinks>> validDatatypeLinks) {
            Utils.checkNotNull(validDatatypeLinks, "validDatatypeLinks");
            this.validDatatypeLinks = validDatatypeLinks;
            return this;
        }
