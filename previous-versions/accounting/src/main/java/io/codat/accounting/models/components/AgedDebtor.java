...
public class AgedDebtor {
    ...
    private Optional<? extends java.util.List<AgedCurrencyOutstandingItems>> agedCurrencyOutstanding;
    ...
    public AgedDebtor(
            @JsonProperty("agedCurrencyOutstanding") Optional<? extends java.util.List<AgedCurrencyOutstandingItems>> agedCurrencyOutstanding,
     ...
     * Array of aged debtors by currency.
     */
    public Optional<? extends java.util.List<AgedCurrencyOutstandingItems>> agedCurrencyOutstanding() {
     ...
     * Array of aged debtors by currency.
     */
    public AgedDebtor withAgedCurrencyOutstanding(java.util.List<AgedCurrencyOutstandingItems> agedCurrencyOutstanding) {
        Utils.checkNotNull(agedCurrencyOutstanding, "agedCurrencyOutstanding");
     ...
     * Array of aged debtors by currency.
     */
    public AgedDebtor withAgedCurrencyOutstanding(Optional<? extends java.util.List<AgedCurrencyOutstandingItems>> agedCurrencyOutstanding) {
        Utils.checkNotNull(agedCurrencyOutstanding, "agedCurrencyOutstanding");
        this.agedCurrencyOutstanding = agedCurrencyOutstanding;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends java.util.List<AgedCurrencyOutstandingItems>> agedCurrencyOutstanding = Optional.empty();
         ...
         * Array of aged debtors by currency.
         */
        public Builder agedCurrencyOutstanding(java.util.List<AgedCurrencyOutstandingItems> agedCurrencyOutstanding) {
            Utils.checkNotNull(agedCurrencyOutstanding, "agedCurrencyOutstanding");
            this.agedCurrencyOutstanding = Optional.ofNullable(agedCurrencyOutstanding);
            return this;
        }
         ...
         * Array of aged debtors by currency.
         */
        public Builder agedCurrencyOutstanding(Optional<? extends java.util.List<AgedCurrencyOutstandingItems>> agedCurrencyOutstanding) {
            Utils.checkNotNull(agedCurrencyOutstanding, "agedCurrencyOutstanding");
            this.agedCurrencyOutstanding = agedCurrencyOutstanding;
            return this;
        }
