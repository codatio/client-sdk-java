...
public class GetInvoiceAttachmentResponse {
    ...
    public GetInvoiceAttachmentResponse(
     ...
     * Success
     */
    public GetInvoiceAttachmentResponse withAttachment(io.codat.accounting.models.components.Attachment attachment) {
        Utils.checkNotNull(attachment, "attachment");
     ...
     * Success
     */
    public GetInvoiceAttachmentResponse withAttachment(JsonNullable<? extends io.codat.accounting.models.components.Attachment> attachment) {
        Utils.checkNotNull(attachment, "attachment");
        this.attachment = attachment;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public GetInvoiceAttachmentResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public GetInvoiceAttachmentResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public GetInvoiceAttachmentResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetInvoiceAttachmentResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetInvoiceAttachmentResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetInvoiceAttachmentResponse other = (GetInvoiceAttachmentResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetInvoiceAttachmentResponse.class,
    ...
    public final static class Builder {
        ...
        public GetInvoiceAttachmentResponse build() {
            return new GetInvoiceAttachmentResponse(
                attachment,
                contentType,
                errorMessage,
                statusCode,
