...
public class ListJournalEntriesResponse {
     ...
     * Success
     */
    private Optional<? extends io.codat.accounting.models.components.JournalEntries> journalEntries;
    ...
    public ListJournalEntriesResponse(
            ...
            Optional<? extends io.codat.accounting.models.components.JournalEntries> journalEntries,
            int statusCode,
     ...
     * Success
     */
    public Optional<? extends io.codat.accounting.models.components.JournalEntries> journalEntries() {
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListJournalEntriesResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListJournalEntriesResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * Success
     */
    public ListJournalEntriesResponse withJournalEntries(io.codat.accounting.models.components.JournalEntries journalEntries) {
        Utils.checkNotNull(journalEntries, "journalEntries");
     ...
     * Success
     */
    public ListJournalEntriesResponse withJournalEntries(Optional<? extends io.codat.accounting.models.components.JournalEntries> journalEntries) {
        Utils.checkNotNull(journalEntries, "journalEntries");
        this.journalEntries = journalEntries;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.accounting.models.components.JournalEntries> journalEntries = Optional.empty();
         ...
         * Success
         */
        public Builder journalEntries(io.codat.accounting.models.components.JournalEntries journalEntries) {
            Utils.checkNotNull(journalEntries, "journalEntries");
            this.journalEntries = Optional.ofNullable(journalEntries);
            return this;
        }
         ...
         * Success
         */
        public Builder journalEntries(Optional<? extends io.codat.accounting.models.components.JournalEntries> journalEntries) {
            Utils.checkNotNull(journalEntries, "journalEntries");
            this.journalEntries = journalEntries;
            return this;
        }
