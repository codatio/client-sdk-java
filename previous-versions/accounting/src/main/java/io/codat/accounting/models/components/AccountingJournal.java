...
public class AccountingJournal {
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public AccountingJournal withCreatedOn(String createdOn) {
        Utils.checkNotNull(createdOn, "createdOn");
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public AccountingJournal withCreatedOn(Optional<? extends String> createdOn) {
        Utils.checkNotNull(createdOn, "createdOn");
        this.createdOn = createdOn;
        return this;
    }
     ...
     * If the journal has child journals, this value is true. If it doesn’t, it is false.
     */
    public AccountingJournal withHasChildren(boolean hasChildren) {
        Utils.checkNotNull(hasChildren, "hasChildren");
     ...
     * If the journal has child journals, this value is true. If it doesn’t, it is false.
     */
    public AccountingJournal withHasChildren(Optional<? extends Boolean> hasChildren) {
        Utils.checkNotNull(hasChildren, "hasChildren");
        this.hasChildren = hasChildren;
        return this;
    }
     ...
     * Journal ID.
     */
    public AccountingJournal withId(Optional<? extends String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Native journal number or code.
     */
    public AccountingJournal withJournalCode(String journalCode) {
        Utils.checkNotNull(journalCode, "journalCode");
     ...
     * Native journal number or code.
     */
    public AccountingJournal withJournalCode(JsonNullable<? extends String> journalCode) {
        Utils.checkNotNull(journalCode, "journalCode");
        this.journalCode = journalCode;
        return this;
    }

    public AccountingJournal withMetadata(Metadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = Optional.ofNullable(metadata);
        return this;
    }
    
    public AccountingJournal withMetadata(Optional<? extends Metadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }

    public AccountingJournal withModifiedDate(String modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = Optional.ofNullable(modifiedDate);
        return this;
    }
    
    public AccountingJournal withModifiedDate(Optional<? extends String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * The maximum length for a journal name is 256 characters. All characters above that number will be truncated.
     */
    public AccountingJournal withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * The maximum length for a journal name is 256 characters. All characters above that number will be truncated.
     */
    public AccountingJournal withName(JsonNullable<? extends String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * If the journal is a parent journal, this value is not present.
     */
    public AccountingJournal withParentId(String parentId) {
        Utils.checkNotNull(parentId, "parentId");
     ...
     * If the journal is a parent journal, this value is not present.
     */
    public AccountingJournal withParentId(JsonNullable<? extends String> parentId) {
        Utils.checkNotNull(parentId, "parentId");
        this.parentId = parentId;
        return this;
    }

    public AccountingJournal withSourceModifiedDate(String sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = Optional.ofNullable(sourceModifiedDate);
        return this;
    }
    
    public AccountingJournal withSourceModifiedDate(Optional<? extends String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * Current journal status.
     */
    public AccountingJournal withStatus(JournalStatus status) {
        Utils.checkNotNull(status, "status");
     ...
     * Current journal status.
     */
    public AccountingJournal withStatus(Optional<? extends JournalStatus> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The type of the journal.
     */
    public AccountingJournal withType(String type) {
        Utils.checkNotNull(type, "type");
     ...
     * The type of the journal.
     */
    public AccountingJournal withType(JsonNullable<? extends String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
