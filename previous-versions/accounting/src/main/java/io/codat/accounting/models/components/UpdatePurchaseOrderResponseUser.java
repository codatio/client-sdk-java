...
public class UpdatePurchaseOrderResponseUser {
    ...
    public UpdatePurchaseOrderResponseUser(
     ...
     * Email address of the user.
     */
    public UpdatePurchaseOrderResponseUser withEmail(String email) {
        Utils.checkNotNull(email, "email");
     ...
     * Email address of the user.
     */
    public UpdatePurchaseOrderResponseUser withEmail(JsonNullable<? extends String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * First name of the user.
     */
    public UpdatePurchaseOrderResponseUser withFirstName(String firstName) {
        Utils.checkNotNull(firstName, "firstName");
     ...
     * First name of the user.
     */
    public UpdatePurchaseOrderResponseUser withFirstName(JsonNullable<? extends String> firstName) {
        Utils.checkNotNull(firstName, "firstName");
        this.firstName = firstName;
        return this;
    }
     ...
     * Last name of the user.
     */
    public UpdatePurchaseOrderResponseUser withLastName(String lastName) {
        Utils.checkNotNull(lastName, "lastName");
     ...
     * Last name of the user.
     */
    public UpdatePurchaseOrderResponseUser withLastName(JsonNullable<? extends String> lastName) {
        Utils.checkNotNull(lastName, "lastName");
        this.lastName = lastName;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdatePurchaseOrderResponseUser other = (UpdatePurchaseOrderResponseUser) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdatePurchaseOrderResponseUser.class,
                "email", email,
                "firstName", firstName,
                "lastName", lastName);
    }
    ...
    public final static class Builder {
        ...
        public UpdatePurchaseOrderResponseUser build() {
            return new UpdatePurchaseOrderResponseUser(
                email,
                firstName,
                lastName);
        }
