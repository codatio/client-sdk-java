...
public class AccountingBill {
    ...
    private JsonNullable<? extends java.util.List<CreateBillResponseWithholdingTax>> withholdingTax;
    ...
    public AccountingBill(
            ...
            @JsonProperty("withholdingTax") JsonNullable<? extends java.util.List<CreateBillResponseWithholdingTax>> withholdingTax) {
    ...
    public JsonNullable<? extends java.util.List<CreateBillResponseWithholdingTax>> withholdingTax() {
     ...
     * An array of payment allocations.
     */
    public AccountingBill withPaymentAllocations(java.util.List<PaymentAllocationItems> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
     ...
     * An array of payment allocations.
     */
    public AccountingBill withPaymentAllocations(JsonNullable<? extends java.util.List<PaymentAllocationItems>> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
        this.paymentAllocations = paymentAllocations;
        return this;
    }

    public AccountingBill withPurchaseOrderRefs(java.util.List<PurchaseOrderRef> purchaseOrderRefs) {
        Utils.checkNotNull(purchaseOrderRefs, "purchaseOrderRefs");
        this.purchaseOrderRefs = JsonNullable.of(purchaseOrderRefs);
        return this;
    }

    public AccountingBill withPurchaseOrderRefs(JsonNullable<? extends java.util.List<PurchaseOrderRef>> purchaseOrderRefs) {
        Utils.checkNotNull(purchaseOrderRefs, "purchaseOrderRefs");
        this.purchaseOrderRefs = purchaseOrderRefs;
        return this;
    }
    ...
    public AccountingBill withWithholdingTax(java.util.List<CreateBillResponseWithholdingTax> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = JsonNullable.of(withholdingTax);
        return this;
    }

    public AccountingBill withWithholdingTax(JsonNullable<? extends java.util.List<CreateBillResponseWithholdingTax>> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = withholdingTax;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends java.util.List<CreateBillResponseWithholdingTax>> withholdingTax = JsonNullable.undefined();  
        ...
        public Builder withholdingTax(java.util.List<CreateBillResponseWithholdingTax> withholdingTax) {
            Utils.checkNotNull(withholdingTax, "withholdingTax");
            this.withholdingTax = JsonNullable.of(withholdingTax);
            return this;
        }

        public Builder withholdingTax(JsonNullable<? extends java.util.List<CreateBillResponseWithholdingTax>> withholdingTax) {
            Utils.checkNotNull(withholdingTax, "withholdingTax");
            this.withholdingTax = withholdingTax;
            return this;
        }
