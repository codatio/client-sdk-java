...
public class ListDirectCostsRequestBuilder {
    ...
    public ListDirectCostsRequestBuilder request(io.codat.accounting.models.operations.ListDirectCostsRequest request) {
    ...
    public ListDirectCostsRequestBuilder retryConfig(java.util.Optional<io.codat.accounting.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
