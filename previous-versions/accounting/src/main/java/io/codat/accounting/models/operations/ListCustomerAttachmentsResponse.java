...
public class ListCustomerAttachmentsResponse {
    ...
    public ListCustomerAttachmentsResponse(
     ...
     * Success
     */
    public ListCustomerAttachmentsResponse withAttachmentsDataset(io.codat.accounting.models.components.AttachmentsDataset attachmentsDataset) {
        Utils.checkNotNull(attachmentsDataset, "attachmentsDataset");
     ...
     * Success
     */
    public ListCustomerAttachmentsResponse withAttachmentsDataset(Optional<? extends io.codat.accounting.models.components.AttachmentsDataset> attachmentsDataset) {
        Utils.checkNotNull(attachmentsDataset, "attachmentsDataset");
        this.attachmentsDataset = attachmentsDataset;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public ListCustomerAttachmentsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public ListCustomerAttachmentsResponse withErrorMessage(io.codat.accounting.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public ListCustomerAttachmentsResponse withErrorMessage(Optional<? extends io.codat.accounting.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public ListCustomerAttachmentsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListCustomerAttachmentsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListCustomerAttachmentsResponse other = (ListCustomerAttachmentsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListCustomerAttachmentsResponse.class,
    ...
    public final static class Builder {
        ...
        public ListCustomerAttachmentsResponse build() {
            return new ListCustomerAttachmentsResponse(
                attachmentsDataset,
                contentType,
                errorMessage,
                statusCode,
