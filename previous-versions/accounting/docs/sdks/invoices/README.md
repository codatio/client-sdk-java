        ...
        try {
            ...
            CreateInvoiceRequest req = CreateInvoiceRequest.builder()
                ...
                .invoice(Invoice.builder()
                    .amountDue(new BigDecimal("4865.89"))
                    .issueDate("2022-10-23T00:00:00Z")
                    .status(InvoiceStatus.VOID)
                    .totalAmount(new BigDecimal("4174.58"))
                    .totalTaxAmount(new BigDecimal("2884.08"))
                    .currency("EUR")
...
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| `request`                                                               | [CreateInvoiceRequest](../../models/operations/CreateInvoiceRequest.md) | :heavy_check_mark:                                                      | The request object to use for the request.                              |
...
| Parameter                                                               | Type                                                                    | Required                                                                | Description                                                             |
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| `request`                                                               | [DeleteInvoiceRequest](../../models/operations/DeleteInvoiceRequest.md) | :heavy_check_mark:                                                      | The request object to use for the request.                              |
...
| Parameter                                                                                       | Type                                                                                            | Required                                                                                        | Description                                                                                     |
| ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| `request`                                                                                       | [DownloadInvoiceAttachmentRequest](../../models/operations/DownloadInvoiceAttachmentRequest.md) | :heavy_check_mark:                                                                              | The request object to use for the request.                                                      |

### Response

**[DownloadInvoiceAttachmentResponse](../../models/operations/DownloadInvoiceAttachmentResponse.md)**
...
| Parameter                                                                         | Type                                                                              | Required                                                                          | Description                                                                       |
| --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| `request`                                                                         | [DownloadInvoicePdfRequest](../../models/operations/DownloadInvoicePdfRequest.md) | :heavy_check_mark:                                                                | The request object to use for the request.                                        |

### Response

**[DownloadInvoicePdfResponse](../../models/operations/DownloadInvoicePdfResponse.md)**
...
| Parameter                                                         | Type                                                              | Required                                                          | Description                                                       |
| ----------------------------------------------------------------- | ----------------------------------------------------------------- | ----------------------------------------------------------------- | ----------------------------------------------------------------- |
| `request`                                                         | [GetInvoiceRequest](../../models/operations/GetInvoiceRequest.md) | :heavy_check_mark:                                                | The request object to use for the request.                        |
...
| Parameter                                                                             | Type                                                                                  | Required                                                                              | Description                                                                           |
| ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| `request`                                                                             | [GetInvoiceAttachmentRequest](../../models/operations/GetInvoiceAttachmentRequest.md) | :heavy_check_mark:                                                                    | The request object to use for the request.                                            |

### Response

**[GetInvoiceAttachmentResponse](../../models/operations/GetInvoiceAttachmentResponse.md)**
...
| Parameter                                                                                             | Type                                                                                                  | Required                                                                                              | Description                                                                                           |
| ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| `request`                                                                                             | [GetCreateUpdateInvoicesModelRequest](../../models/operations/GetCreateUpdateInvoicesModelRequest.md) | :heavy_check_mark:                                                                                    | The request object to use for the request.                                                            |

### Response

**[GetCreateUpdateInvoicesModelResponse](../../models/operations/GetCreateUpdateInvoicesModelResponse.md)**
...
| Parameter                                                                                 | Type                                                                                      | Required                                                                                  | Description                                                                               |
| ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| `request`                                                                                 | [ListInvoiceAttachmentsRequest](../../models/operations/ListInvoiceAttachmentsRequest.md) | :heavy_check_mark:                                                                        | The request object to use for the request.                                                |

### Response

**[ListInvoiceAttachmentsResponse](../../models/operations/ListInvoiceAttachmentsResponse.md)**
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            UpdateInvoiceRequest req = UpdateInvoiceRequest.builder()
                ...
                .invoiceId("<value>")
                .invoice(Invoice.builder()
                    .amountDue(new BigDecimal("8574.78"))
                    .issueDate("2022-10-23T00:00:00Z")
                    .status(InvoiceStatus.UNKNOWN)
                    .totalAmount(new BigDecimal("3446.2"))
                    .totalTaxAmount(new BigDecimal("7084.55"))
                    .currency("GBP")
                    .dueDate("2022-10-23T00:00:00Z")
                    .lineItems(List.of(
                    ))
...
| Parameter                                                               | Type                                                                    | Required                                                                | Description                                                             |
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| `request`                                                               | [UpdateInvoiceRequest](../../models/operations/UpdateInvoiceRequest.md) | :heavy_check_mark:                                                      | The request object to use for the request.                              |
...
| Parameter                                                                                   | Type                                                                                        | Required                                                                                    | Description                                                                                 |
| ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| `request`                                                                                   | [UploadInvoiceAttachmentRequest](../../models/operations/UploadInvoiceAttachmentRequest.md) | :heavy_check_mark:                                                                          | The request object to use for the request.                                                  |

### Response

**[UploadInvoiceAttachmentResponse](../../models/operations/UploadInvoiceAttachmentResponse.md)**
