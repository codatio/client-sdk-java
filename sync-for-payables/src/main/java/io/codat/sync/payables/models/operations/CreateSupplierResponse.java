...
public class CreateSupplierResponse implements io.codat.sync.payables.utils.Response {
     ...
     * Success
     */
    private Optional<? extends io.codat.sync.payables.models.components.Supplier> supplier;
    ...
    public CreateSupplierResponse(
            ...
            Optional<? extends io.codat.sync.payables.models.components.Supplier> supplier) {
     ...
     * Success
     */
    public Optional<? extends io.codat.sync.payables.models.components.Supplier> supplier() {
        return supplier;
    }
     ...
     * The request made is not valid.
     */
    public CreateSupplierResponse withErrorMessage(io.codat.sync.payables.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * The request made is not valid.
     */
    public CreateSupplierResponse withErrorMessage(Optional<? extends io.codat.sync.payables.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * Success
     */
    public CreateSupplierResponse withSupplier(io.codat.sync.payables.models.components.Supplier supplier) {
        Utils.checkNotNull(supplier, "supplier");
     ...
     * Success
     */
    public CreateSupplierResponse withSupplier(Optional<? extends io.codat.sync.payables.models.components.Supplier> supplier) {
        Utils.checkNotNull(supplier, "supplier");
        this.supplier = supplier;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.sync.payables.models.components.Supplier> supplier = Optional.empty();  
         ...
         * Success
         */
        public Builder supplier(io.codat.sync.payables.models.components.Supplier supplier) {
            Utils.checkNotNull(supplier, "supplier");
            this.supplier = Optional.ofNullable(supplier);
            return this;
        }
         ...
         * Success
         */
        public Builder supplier(Optional<? extends io.codat.sync.payables.models.components.Supplier> supplier) {
            Utils.checkNotNull(supplier, "supplier");
            this.supplier = supplier;
            return this;
        }
