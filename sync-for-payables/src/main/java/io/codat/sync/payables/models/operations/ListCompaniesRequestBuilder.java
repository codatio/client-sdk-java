...
public class ListCompaniesRequestBuilder {
    ...
    public ListCompaniesRequestBuilder request(io.codat.sync.payables.models.operations.ListCompaniesRequest request) {
    ...
    public ListCompaniesRequestBuilder retryConfig(java.util.Optional<io.codat.sync.payables.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
