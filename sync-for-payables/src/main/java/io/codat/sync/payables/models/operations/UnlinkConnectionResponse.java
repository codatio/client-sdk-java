...
public class UnlinkConnectionResponse implements io.codat.sync.payables.utils.Response {
     ...
     * OK
     */
    public UnlinkConnectionResponse withConnection(io.codat.sync.payables.models.components.Connection connection) {
        Utils.checkNotNull(connection, "connection");
     ...
     * OK
     */
    public UnlinkConnectionResponse withConnection(Optional<? extends io.codat.sync.payables.models.components.Connection> connection) {
        Utils.checkNotNull(connection, "connection");
        this.connection = connection;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public UnlinkConnectionResponse withErrorMessage(io.codat.sync.payables.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public UnlinkConnectionResponse withErrorMessage(Optional<? extends io.codat.sync.payables.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
