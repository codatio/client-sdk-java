...
public class CreateBillResponse implements io.codat.sync.payables.utils.Response {
     ...
     * The request made is not valid.
     */
    public CreateBillResponse withErrorMessage(io.codat.sync.payables.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * The request made is not valid.
     */
    public CreateBillResponse withErrorMessage(Optional<? extends io.codat.sync.payables.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
