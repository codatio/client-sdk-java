...
public class ListBillAttachmentsResponse implements io.codat.sync.payables.utils.Response {

    /**
     * Success
     */
    private JsonNullable<? extends io.codat.sync.payables.models.components.Attachment> attachment;
    ...
    public ListBillAttachmentsResponse(
            JsonNullable<? extends io.codat.sync.payables.models.components.Attachment> attachment,
            String contentType,
     ...
     * Success
     */
    public JsonNullable<? extends io.codat.sync.payables.models.components.Attachment> attachment() {
        return attachment;
    }
     ...
     * Success
     */
    public ListBillAttachmentsResponse withAttachment(io.codat.sync.payables.models.components.Attachment attachment) {
        Utils.checkNotNull(attachment, "attachment");
     ...
     * Success
     */
    public ListBillAttachmentsResponse withAttachment(JsonNullable<? extends io.codat.sync.payables.models.components.Attachment> attachment) {
        Utils.checkNotNull(attachment, "attachment");
        this.attachment = attachment;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public ListBillAttachmentsResponse withErrorMessage(io.codat.sync.payables.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public ListBillAttachmentsResponse withErrorMessage(Optional<? extends io.codat.sync.payables.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends io.codat.sync.payables.models.components.Attachment> attachment = JsonNullable.undefined();
         ...
         * Success
         */
        public Builder attachment(io.codat.sync.payables.models.components.Attachment attachment) {
            Utils.checkNotNull(attachment, "attachment");
            this.attachment = JsonNullable.of(attachment);
            return this;
        }
         ...
         * Success
         */
        public Builder attachment(JsonNullable<? extends io.codat.sync.payables.models.components.Attachment> attachment) {
            Utils.checkNotNull(attachment, "attachment");
            this.attachment = attachment;
            return this;
        }
