...
import io.codat.sync.payables.models.components.Suppliers;
...
public class ListSuppliersResponse implements Response {
     ...
     * Success
     */
    private Optional<? extends Suppliers> suppliers;
    ...
    public ListSuppliersResponse(
            ...
            Optional<? extends Suppliers> suppliers) {
    ...
    @JsonIgnore
    public Optional<Suppliers> suppliers() {
        return (Optional<Suppliers>) suppliers;
    }
     ...
     * Success
     */
    public ListSuppliersResponse withSuppliers(Suppliers suppliers) {
        Utils.checkNotNull(suppliers, "suppliers");
     ...
     * Success
     */
    public ListSuppliersResponse withSuppliers(Optional<? extends Suppliers> suppliers) {
        Utils.checkNotNull(suppliers, "suppliers");
        this.suppliers = suppliers;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends Suppliers> suppliers = Optional.empty();  
         ...
         * Success
         */
        public Builder suppliers(Suppliers suppliers) {
            Utils.checkNotNull(suppliers, "suppliers");
            this.suppliers = Optional.ofNullable(suppliers);
            return this;
        }
         ...
         * Success
         */
        public Builder suppliers(Optional<? extends Suppliers> suppliers) {
            Utils.checkNotNull(suppliers, "suppliers");
            this.suppliers = suppliers;
            return this;
        }
