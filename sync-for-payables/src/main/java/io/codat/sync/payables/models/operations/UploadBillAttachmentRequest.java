...
public class UploadBillAttachmentRequest {
    ...
    public UploadBillAttachmentRequest(
            ...
            String companyId,
            String connectionId) {
        this(Optional.empty(), billId, companyId, connectionId);
    }
    ...
    public UploadBillAttachmentRequest withAttachmentUpload(Optional<? extends AttachmentUpload> attachmentUpload) {
        Utils.checkNotNull(attachmentUpload, "attachmentUpload");
        this.attachmentUpload = attachmentUpload;
        return this;
    }
