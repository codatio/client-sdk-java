...
public class CreateCompanyRequestBuilder {
    ...
    public CreateCompanyRequestBuilder request(java.util.Optional<? extends io.codat.sync.payables.models.components.CompanyRequestBody> request) {
        Utils.checkNotNull(request, "request");
    ...
    public CreateCompanyRequestBuilder retryConfig(java.util.Optional<io.codat.sync.payables.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
