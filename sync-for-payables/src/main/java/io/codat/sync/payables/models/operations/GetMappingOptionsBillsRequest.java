...
public class GetMappingOptionsBillsRequest {
    ...
    @JsonCreator
    public GetMappingOptionsBillsRequest(
            String companyId,
            String connectionId,
     ...
     * Unique identifier for a company.
     */
    public GetMappingOptionsBillsRequest withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * Unique identifier for a connection.
     */
    public GetMappingOptionsBillsRequest withConnectionId(String connectionId) {
        Utils.checkNotNull(connectionId, "connectionId");
        this.connectionId = connectionId;
        return this;
    }
     ...
     * Retrieve the next page of results using the continuation token from the previous response.
     */
    public GetMappingOptionsBillsRequest withContinuationToken(String continuationToken) {
        Utils.checkNotNull(continuationToken, "continuationToken");
     ...
     * Retrieve the next page of results using the continuation token from the previous response.
     */
    public GetMappingOptionsBillsRequest withContinuationToken(Optional<String> continuationToken) {
        Utils.checkNotNull(continuationToken, "continuationToken");
        this.continuationToken = continuationToken;
        return this;
    }
     ...
     * Codat query string allows you to filter by `status` (`status=Active||status=Archived`). [Learn more](https://docs.codat.io/using-the-api/querying) about Codat's query string.
     */
    public GetMappingOptionsBillsRequest withStatusQuery(String statusQuery) {
        Utils.checkNotNull(statusQuery, "statusQuery");
     ...
     * Codat query string allows you to filter by `status` (`status=Active||status=Archived`). [Learn more](https://docs.codat.io/using-the-api/querying) about Codat's query string.
     */
    public GetMappingOptionsBillsRequest withStatusQuery(Optional<String> statusQuery) {
        Utils.checkNotNull(statusQuery, "statusQuery");
        this.statusQuery = statusQuery;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMappingOptionsBillsRequest other = (GetMappingOptionsBillsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMappingOptionsBillsRequest.class,
                "companyId", companyId,
    ...
    public final static class Builder {
        ...
        public GetMappingOptionsBillsRequest build() {
            return new GetMappingOptionsBillsRequest(
                companyId,
                connectionId,
                continuationToken,
                statusQuery);
