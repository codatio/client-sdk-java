...
public class GetConnectionRequestBuilder {
    ...
    public GetConnectionRequestBuilder retryConfig(io.codat.sync_for_payables.utils.RetryConfig retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = Optional.of(retryConfig);
        return this;
    }

    public GetConnectionRequestBuilder retryConfig(Optional<io.codat.sync_for_payables.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
