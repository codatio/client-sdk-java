...
public class CreateBillRequest {
    ...
    private Optional<? extends io.codat.sync_for_payables.models.components.BillPrototype> billPrototype;
    ...
    public CreateBillRequest(
            ...
            Optional<? extends io.codat.sync_for_payables.models.components.BillPrototype> billPrototype,
            String companyId,
            String connectionId) {
    ...
    public Optional<? extends io.codat.sync_for_payables.models.components.BillPrototype> billPrototype() {
    ...
    public CreateBillRequest withBillPrototype(io.codat.sync_for_payables.models.components.BillPrototype billPrototype) {
        Utils.checkNotNull(billPrototype, "billPrototype");
        this.billPrototype = Optional.ofNullable(billPrototype);
        return this;
    }
    
    public CreateBillRequest withBillPrototype(Optional<? extends io.codat.sync_for_payables.models.components.BillPrototype> billPrototype) {
        Utils.checkNotNull(billPrototype, "billPrototype");
        this.billPrototype = billPrototype;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.sync_for_payables.models.components.BillPrototype> billPrototype = Optional.empty();
        ...
        public Builder billPrototype(io.codat.sync_for_payables.models.components.BillPrototype billPrototype) {
            Utils.checkNotNull(billPrototype, "billPrototype");
            this.billPrototype = Optional.ofNullable(billPrototype);
            return this;
        }
        
        public Builder billPrototype(Optional<? extends io.codat.sync_for_payables.models.components.BillPrototype> billPrototype) {
            Utils.checkNotNull(billPrototype, "billPrototype");
            this.billPrototype = billPrototype;
            return this;
        }
