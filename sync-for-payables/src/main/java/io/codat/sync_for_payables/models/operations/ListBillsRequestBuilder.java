...
public class ListBillsRequestBuilder {
    ...
    public ListBillsRequestBuilder retryConfig(io.codat.sync_for_payables.utils.RetryConfig retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = Optional.of(retryConfig);
        return this;
    }

    public ListBillsRequestBuilder retryConfig(Optional<io.codat.sync_for_payables.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
