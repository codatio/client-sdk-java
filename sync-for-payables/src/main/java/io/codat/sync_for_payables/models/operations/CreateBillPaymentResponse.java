...
public class CreateBillPaymentResponse {
     ...
     * Success
     */
    private Optional<? extends io.codat.sync_for_payables.models.components.BillPayment> billPayment;
    ...
    public CreateBillPaymentResponse(
            Optional<? extends io.codat.sync_for_payables.models.components.BillPayment> billPayment,
            String contentType,
     ...
     * Success
     */
    public Optional<? extends io.codat.sync_for_payables.models.components.BillPayment> billPayment() {
        return billPayment;
    }
     ...
     * Success
     */
    public CreateBillPaymentResponse withBillPayment(io.codat.sync_for_payables.models.components.BillPayment billPayment) {
        Utils.checkNotNull(billPayment, "billPayment");
     ...
     * Success
     */
    public CreateBillPaymentResponse withBillPayment(Optional<? extends io.codat.sync_for_payables.models.components.BillPayment> billPayment) {
        Utils.checkNotNull(billPayment, "billPayment");
        this.billPayment = billPayment;
        return this;
    }
     ...
     * The request made is not valid.
     */
    public CreateBillPaymentResponse withErrorMessage(io.codat.sync_for_payables.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * The request made is not valid.
     */
    public CreateBillPaymentResponse withErrorMessage(Optional<? extends io.codat.sync_for_payables.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.sync_for_payables.models.components.BillPayment> billPayment = Optional.empty();
         ...
         * Success
         */
        public Builder billPayment(io.codat.sync_for_payables.models.components.BillPayment billPayment) {
            Utils.checkNotNull(billPayment, "billPayment");
            this.billPayment = Optional.ofNullable(billPayment);
            return this;
        }
         ...
         * Success
         */
        public Builder billPayment(Optional<? extends io.codat.sync_for_payables.models.components.BillPayment> billPayment) {
            Utils.checkNotNull(billPayment, "billPayment");
            this.billPayment = billPayment;
            return this;
        }
