...
public class CreateBillPaymentRequest {
    ...
    private Optional<? extends io.codat.sync_for_payables.models.components.BillPaymentPrototype> billPaymentPrototype;
    ...
    public CreateBillPaymentRequest(
            ...
            String billId,
            Optional<? extends io.codat.sync_for_payables.models.components.BillPaymentPrototype> billPaymentPrototype,
            String companyId,
            String connectionId) {
    ...
    public Optional<? extends io.codat.sync_for_payables.models.components.BillPaymentPrototype> billPaymentPrototype() {
    ...
    public CreateBillPaymentRequest withBillPaymentPrototype(io.codat.sync_for_payables.models.components.BillPaymentPrototype billPaymentPrototype) {
        Utils.checkNotNull(billPaymentPrototype, "billPaymentPrototype");
        this.billPaymentPrototype = Optional.ofNullable(billPaymentPrototype);
        return this;
    }
    
    public CreateBillPaymentRequest withBillPaymentPrototype(Optional<? extends io.codat.sync_for_payables.models.components.BillPaymentPrototype> billPaymentPrototype) {
        Utils.checkNotNull(billPaymentPrototype, "billPaymentPrototype");
        this.billPaymentPrototype = billPaymentPrototype;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.sync_for_payables.models.components.BillPaymentPrototype> billPaymentPrototype = Optional.empty();
        ...
        public Builder billPaymentPrototype(io.codat.sync_for_payables.models.components.BillPaymentPrototype billPaymentPrototype) {
            Utils.checkNotNull(billPaymentPrototype, "billPaymentPrototype");
            this.billPaymentPrototype = Optional.ofNullable(billPaymentPrototype);
            return this;
        }
        
        public Builder billPaymentPrototype(Optional<? extends io.codat.sync_for_payables.models.components.BillPaymentPrototype> billPaymentPrototype) {
            Utils.checkNotNull(billPaymentPrototype, "billPaymentPrototype");
            this.billPaymentPrototype = billPaymentPrototype;
            return this;
        }
