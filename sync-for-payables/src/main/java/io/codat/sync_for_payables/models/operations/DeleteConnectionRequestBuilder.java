...
public class DeleteConnectionRequestBuilder {
    ...
    public DeleteConnectionRequestBuilder retryConfig(io.codat.sync_for_payables.utils.RetryConfig retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = Optional.of(retryConfig);
        return this;
    }

    public DeleteConnectionRequestBuilder retryConfig(Optional<io.codat.sync_for_payables.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
