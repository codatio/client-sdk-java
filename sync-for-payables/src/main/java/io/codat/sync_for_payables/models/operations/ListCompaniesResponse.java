...
public class ListCompaniesResponse {
     ...
     * OK
     */
    private Optional<? extends io.codat.sync_for_payables.models.components.Companies> companies;
    ...
    public ListCompaniesResponse(
            Optional<? extends io.codat.sync_for_payables.models.components.Companies> companies,
            String contentType,
     ...
     * OK
     */
    public Optional<? extends io.codat.sync_for_payables.models.components.Companies> companies() {
        return companies;
    }
     ...
     * OK
     */
    public ListCompaniesResponse withCompanies(io.codat.sync_for_payables.models.components.Companies companies) {
        Utils.checkNotNull(companies, "companies");
     ...
     * OK
     */
    public ListCompaniesResponse withCompanies(Optional<? extends io.codat.sync_for_payables.models.components.Companies> companies) {
        Utils.checkNotNull(companies, "companies");
        this.companies = companies;
        return this;
    }
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListCompaniesResponse withErrorMessage(io.codat.sync_for_payables.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListCompaniesResponse withErrorMessage(Optional<? extends io.codat.sync_for_payables.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.sync_for_payables.models.components.Companies> companies = Optional.empty();
         ...
         * OK
         */
        public Builder companies(io.codat.sync_for_payables.models.components.Companies companies) {
            Utils.checkNotNull(companies, "companies");
            this.companies = Optional.ofNullable(companies);
            return this;
        }
         ...
         * OK
         */
        public Builder companies(Optional<? extends io.codat.sync_for_payables.models.components.Companies> companies) {
            Utils.checkNotNull(companies, "companies");
            this.companies = companies;
            return this;
        }
