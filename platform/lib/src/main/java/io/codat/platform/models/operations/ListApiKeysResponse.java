...
public class ListApiKeysResponse {
     ...
     * Success
     */
    private Optional<? extends io.codat.platform.models.shared.ApiKeys> apiKeys;
    ...
    public ListApiKeysResponse(
            Optional<? extends io.codat.platform.models.shared.ApiKeys> apiKeys,
            String contentType,
     ...
     * Success
     */
    public Optional<? extends io.codat.platform.models.shared.ApiKeys> apiKeys() {
        return apiKeys;
    }
     ...
     * Success
     */
    public ListApiKeysResponse withApiKeys(io.codat.platform.models.shared.ApiKeys apiKeys) {
        Utils.checkNotNull(apiKeys, "apiKeys");
     ...
     * Success
     */
    public ListApiKeysResponse withApiKeys(Optional<? extends io.codat.platform.models.shared.ApiKeys> apiKeys) {
        Utils.checkNotNull(apiKeys, "apiKeys");
        this.apiKeys = apiKeys;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public ListApiKeysResponse withErrorMessage(io.codat.platform.models.shared.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public ListApiKeysResponse withErrorMessage(Optional<? extends io.codat.platform.models.shared.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.platform.models.shared.ApiKeys> apiKeys = Optional.empty();
         ...
         * Success
         */
        public Builder apiKeys(io.codat.platform.models.shared.ApiKeys apiKeys) {
            Utils.checkNotNull(apiKeys, "apiKeys");
            this.apiKeys = Optional.ofNullable(apiKeys);
            return this;
        }
         ...
         * Success
         */
        public Builder apiKeys(Optional<? extends io.codat.platform.models.shared.ApiKeys> apiKeys) {
            Utils.checkNotNull(apiKeys, "apiKeys");
            this.apiKeys = apiKeys;
            return this;
        }
