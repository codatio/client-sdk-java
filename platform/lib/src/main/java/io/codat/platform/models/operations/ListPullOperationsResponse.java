...
public class ListPullOperationsResponse {
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListPullOperationsResponse withErrorMessage(io.codat.platform.models.shared.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListPullOperationsResponse withErrorMessage(Optional<? extends io.codat.platform.models.shared.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
