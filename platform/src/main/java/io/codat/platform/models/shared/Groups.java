...
public class Groups {
    ...
    private Optional<? extends java.util.List<Group>> results;

    public Groups(
            @JsonProperty("results") Optional<? extends java.util.List<Group>> results) {
    ...
    public Groups withResults(java.util.List<Group> results) {
        Utils.checkNotNull(results, "results");
    ...
    public final static class Builder {
        ...
        private Optional<? extends java.util.List<Group>> results = Optional.empty();  
        
        private Builder() {
          // force use of static builder() method
        }

        public Builder results(java.util.List<Group> results) {
            Utils.checkNotNull(results, "results");
            this.results = Optional.ofNullable(results);
            return this;
        }
