...
public class DatasetStatusChangedErrorWebhook {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("Data")
    private Optional<? extends DatasetStatusChangedErrorWebhookData> data;
    ...
    public DatasetStatusChangedErrorWebhook(
            ...
            @JsonProperty("Data") Optional<? extends DatasetStatusChangedErrorWebhookData> data,
    ...
    public Optional<? extends DatasetStatusChangedErrorWebhookData> data() {
        return data;
    }
     ...
     * Unique identifier of the webhook event.
     */
    public DatasetStatusChangedErrorWebhook withAlertId(String alertId) {
        Utils.checkNotNull(alertId, "alertId");
     ...
     * Unique identifier of the webhook event.
     */
    public DatasetStatusChangedErrorWebhook withAlertId(Optional<? extends String> alertId) {
        Utils.checkNotNull(alertId, "alertId");
        this.alertId = alertId;
        return this;
    }
     ...
     * Unique identifier for your client in Codat.
     */
    public DatasetStatusChangedErrorWebhook withClientId(String clientId) {
        Utils.checkNotNull(clientId, "clientId");
     ...
     * Unique identifier for your client in Codat.
     */
    public DatasetStatusChangedErrorWebhook withClientId(Optional<? extends String> clientId) {
        Utils.checkNotNull(clientId, "clientId");
        this.clientId = clientId;
        return this;
    }
     ...
     * Name of your client in Codat.
     */
    public DatasetStatusChangedErrorWebhook withClientName(String clientName) {
        Utils.checkNotNull(clientName, "clientName");
     ...
     * Name of your client in Codat.
     */
    public DatasetStatusChangedErrorWebhook withClientName(Optional<? extends String> clientName) {
        Utils.checkNotNull(clientName, "clientName");
        this.clientName = clientName;
        return this;
    }
     ...
     * Unique identifier for your SMB in Codat.
     */
    public DatasetStatusChangedErrorWebhook withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * Unique identifier for your SMB in Codat.
     */
    public DatasetStatusChangedErrorWebhook withCompanyId(Optional<? extends String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }

    public DatasetStatusChangedErrorWebhook withData(DatasetStatusChangedErrorWebhookData data) {
        Utils.checkNotNull(data, "data");
        this.data = Optional.ofNullable(data);
        return this;
    }

    public DatasetStatusChangedErrorWebhook withData(Optional<? extends DatasetStatusChangedErrorWebhookData> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Unique identifier for a company's data connection.
     */
    public DatasetStatusChangedErrorWebhook withDataConnectionId(String dataConnectionId) {
        Utils.checkNotNull(dataConnectionId, "dataConnectionId");
     ...
     * Unique identifier for a company's data connection.
     */
    public DatasetStatusChangedErrorWebhook withDataConnectionId(Optional<? extends String> dataConnectionId) {
        Utils.checkNotNull(dataConnectionId, "dataConnectionId");
        this.dataConnectionId = dataConnectionId;
        return this;
    }
     ...
     * A human-readable message about the webhook.
     */
    public DatasetStatusChangedErrorWebhook withMessage(String message) {
        Utils.checkNotNull(message, "message");
     ...
     * A human-readable message about the webhook.
     */
    public DatasetStatusChangedErrorWebhook withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * Unique identifier for the rule.
     */
    public DatasetStatusChangedErrorWebhook withRuleId(String ruleId) {
        Utils.checkNotNull(ruleId, "ruleId");
     ...
     * Unique identifier for the rule.
     */
    public DatasetStatusChangedErrorWebhook withRuleId(Optional<? extends String> ruleId) {
        Utils.checkNotNull(ruleId, "ruleId");
        this.ruleId = ruleId;
        return this;
    }
     ...
     * The type of rule.
     */
    public DatasetStatusChangedErrorWebhook withRuleType(String ruleType) {
        Utils.checkNotNull(ruleType, "ruleType");
     ...
     * The type of rule.
     */
    public DatasetStatusChangedErrorWebhook withRuleType(Optional<? extends String> ruleType) {
        Utils.checkNotNull(ruleType, "ruleType");
        this.ruleType = ruleType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DatasetStatusChangedErrorWebhook other = (DatasetStatusChangedErrorWebhook) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DatasetStatusChangedErrorWebhook.class,
                "alertId", alertId,
                "clientId", clientId,
    ...
    public final static class Builder {
        ...
        private Optional<? extends DatasetStatusChangedErrorWebhookData> data = Optional.empty();
        ...
        public Builder data(DatasetStatusChangedErrorWebhookData data) {
            Utils.checkNotNull(data, "data");
            this.data = Optional.ofNullable(data);
            return this;
        }

        public Builder data(Optional<? extends DatasetStatusChangedErrorWebhookData> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public DatasetStatusChangedErrorWebhook build() {
            return new DatasetStatusChangedErrorWebhook(
                alertId,
                clientId,
                clientName,
                companyId,
