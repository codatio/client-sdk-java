...
public class GetCompanyPushHistoryResponse implements Response {
     ...
     * OK
     */
    public GetCompanyPushHistoryResponse withPushOperations(PushOperations pushOperations) {
        Utils.checkNotNull(pushOperations, "pushOperations");
     ...
     * OK
     */
    public GetCompanyPushHistoryResponse withPushOperations(Optional<? extends PushOperations> pushOperations) {
        Utils.checkNotNull(pushOperations, "pushOperations");
        this.pushOperations = pushOperations;
        return this;
    }
