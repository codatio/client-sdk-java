...
public class DatasetDataChangedWebhook {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("Data")
    private Optional<? extends DatasetDataChangedWebhookData> data;
    ...
    public DatasetDataChangedWebhook(
            ...
            @JsonProperty("Data") Optional<? extends DatasetDataChangedWebhookData> data,
    ...
    @JsonIgnore
    public Optional<DatasetDataChangedWebhookData> data() {
        return (Optional<DatasetDataChangedWebhookData>) data;
    }
     ...
     * Unique identifier of the webhook event.
     */
    public DatasetDataChangedWebhook withAlertId(String alertId) {
        Utils.checkNotNull(alertId, "alertId");
     ...
     * Unique identifier of the webhook event.
     */
    public DatasetDataChangedWebhook withAlertId(Optional<String> alertId) {
        Utils.checkNotNull(alertId, "alertId");
        this.alertId = alertId;
        return this;
    }
     ...
     * Unique identifier for your client in Codat.
     */
    public DatasetDataChangedWebhook withClientId(String clientId) {
        Utils.checkNotNull(clientId, "clientId");
     ...
     * Unique identifier for your client in Codat.
     */
    public DatasetDataChangedWebhook withClientId(Optional<String> clientId) {
        Utils.checkNotNull(clientId, "clientId");
        this.clientId = clientId;
        return this;
    }
     ...
     * Name of your client in Codat.
     */
    public DatasetDataChangedWebhook withClientName(String clientName) {
        Utils.checkNotNull(clientName, "clientName");
     ...
     * Name of your client in Codat.
     */
    public DatasetDataChangedWebhook withClientName(Optional<String> clientName) {
        Utils.checkNotNull(clientName, "clientName");
        this.clientName = clientName;
        return this;
    }
     ...
     * Unique identifier for your SMB in Codat.
     */
    public DatasetDataChangedWebhook withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
     ...
     * Unique identifier for your SMB in Codat.
     */
    public DatasetDataChangedWebhook withCompanyId(Optional<String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }

    public DatasetDataChangedWebhook withData(DatasetDataChangedWebhookData data) {
        Utils.checkNotNull(data, "data");
        this.data = Optional.ofNullable(data);
        return this;
    }

    public DatasetDataChangedWebhook withData(Optional<? extends DatasetDataChangedWebhookData> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Unique identifier for a company's data connection.
     */
    public DatasetDataChangedWebhook withDataConnectionId(String dataConnectionId) {
        Utils.checkNotNull(dataConnectionId, "dataConnectionId");
     ...
     * Unique identifier for a company's data connection.
     */
    public DatasetDataChangedWebhook withDataConnectionId(Optional<String> dataConnectionId) {
        Utils.checkNotNull(dataConnectionId, "dataConnectionId");
        this.dataConnectionId = dataConnectionId;
        return this;
    }
     ...
     * A human-readable message about the webhook.
     */
    public DatasetDataChangedWebhook withMessage(String message) {
        Utils.checkNotNull(message, "message");
     ...
     * A human-readable message about the webhook.
     */
    public DatasetDataChangedWebhook withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     */
    @Deprecated
    public DatasetDataChangedWebhook withRuleId(Optional<String> ruleId) {
        Utils.checkNotNull(ruleId, "ruleId");
        this.ruleId = ruleId;
        return this;
    }
     ...
     * The type of rule.
     */
    public DatasetDataChangedWebhook withRuleType(String ruleType) {
        Utils.checkNotNull(ruleType, "ruleType");
     ...
     * The type of rule.
     */
    public DatasetDataChangedWebhook withRuleType(Optional<String> ruleType) {
        Utils.checkNotNull(ruleType, "ruleType");
        this.ruleType = ruleType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DatasetDataChangedWebhook other = (DatasetDataChangedWebhook) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DatasetDataChangedWebhook.class,
                "alertId", alertId,
                "clientId", clientId,
    ...
    public final static class Builder {
        ...
        private Optional<? extends DatasetDataChangedWebhookData> data = Optional.empty();
        ...
        public Builder data(DatasetDataChangedWebhookData data) {
            Utils.checkNotNull(data, "data");
            this.data = Optional.ofNullable(data);
            return this;
        }

        public Builder data(Optional<? extends DatasetDataChangedWebhookData> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public DatasetDataChangedWebhook build() {
            return new DatasetDataChangedWebhook(
                alertId,
                clientId,
                clientName,
                companyId,
