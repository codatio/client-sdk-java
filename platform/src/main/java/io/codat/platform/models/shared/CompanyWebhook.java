...
public class CompanyWebhook {
    ...
    private Optional<? extends CompanyDetails> payload;

    @JsonCreator
    public CompanyWebhook(
            @JsonProperty("eventType") Optional<String> eventType,
            @JsonProperty("generatedDate") Optional<String> generatedDate,
            @JsonProperty("id") Optional<String> id,
            @JsonProperty("payload") Optional<? extends CompanyDetails> payload) {
    ...
    @JsonIgnore
    public Optional<CompanyDetails> payload() {
        return (Optional<CompanyDetails>) payload;
    }
     ...
     * The type of event.
     */
    public CompanyWebhook withEventType(String eventType) {
        Utils.checkNotNull(eventType, "eventType");
     ...
     * The type of event.
     */
    public CompanyWebhook withEventType(Optional<String> eventType) {
        Utils.checkNotNull(eventType, "eventType");
        this.eventType = eventType;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CompanyWebhook withGeneratedDate(String generatedDate) {
        Utils.checkNotNull(generatedDate, "generatedDate");
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CompanyWebhook withGeneratedDate(Optional<String> generatedDate) {
        Utils.checkNotNull(generatedDate, "generatedDate");
        this.generatedDate = generatedDate;
        return this;
    }
     ...
     * Unique identifier of the event
     */
    public CompanyWebhook withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Unique identifier of the event
     */
    public CompanyWebhook withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public CompanyWebhook withPayload(CompanyDetails payload) {
        Utils.checkNotNull(payload, "payload");
        this.payload = Optional.ofNullable(payload);
        return this;
    }

    public CompanyWebhook withPayload(Optional<? extends CompanyDetails> payload) {
        Utils.checkNotNull(payload, "payload");
        this.payload = payload;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CompanyWebhook other = (CompanyWebhook) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CompanyWebhook.class,
                "eventType", eventType,
    ...
    public final static class Builder {
        ...
        private Optional<? extends CompanyDetails> payload = Optional.empty();  
        ...
        public Builder payload(CompanyDetails payload) {
            Utils.checkNotNull(payload, "payload");
            this.payload = Optional.ofNullable(payload);
            return this;
        }

        public Builder payload(Optional<? extends CompanyDetails> payload) {
            Utils.checkNotNull(payload, "payload");
            this.payload = payload;
            return this;
        }
        
        public CompanyWebhook build() {
