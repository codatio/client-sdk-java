...
public class UnlinkConnectionRequestBuilder {
    ...
    public UnlinkConnectionRequestBuilder request(io.codat.platform.models.operations.UnlinkConnectionRequest request) {
    ...
    public UnlinkConnectionRequestBuilder retryConfig(java.util.Optional<io.codat.platform.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
