...
public class CreateApiKeyRequestBuilder {
    ...
    private Optional<? extends io.codat.platform.models.shared.CreateApiKey> request = Optional.empty();
    ...
    public CreateApiKeyRequestBuilder request(Optional<? extends io.codat.platform.models.shared.CreateApiKey> request) {
        Utils.checkNotNull(request, "request");
    ...
    public CreateApiKeyRequestBuilder retryConfig(Optional<io.codat.platform.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
