...
public class ListCompaniesRequestBuilder {
    ...
    public ListCompaniesRequestBuilder request(io.codat.platform.models.operations.ListCompaniesRequest request) {
    ...
    public ListCompaniesRequestBuilder retryConfig(java.util.Optional<io.codat.platform.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
