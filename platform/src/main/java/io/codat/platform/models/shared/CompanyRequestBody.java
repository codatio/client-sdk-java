...
public class CompanyRequestBody {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("groups")
    private Optional<? extends List<GroupRef>> groups;
    ...
    public CompanyRequestBody(
            ...
            @JsonProperty("groups") Optional<? extends List<GroupRef>> groups,
    ...
    @JsonIgnore
    public Optional<List<GroupRef>> groups() {
        return (Optional<List<GroupRef>>) groups;
    }
     ...
     * Reference to the groups that the company is assigned to.
     */
    public CompanyRequestBody withGroups(List<GroupRef> groups) {
        Utils.checkNotNull(groups, "groups");
     ...
     * Reference to the groups that the company is assigned to.
     */
    public CompanyRequestBody withGroups(Optional<? extends List<GroupRef>> groups) {
        Utils.checkNotNull(groups, "groups");
        this.groups = groups;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<GroupRef>> groups = Optional.empty();
         ...
         * Reference to the groups that the company is assigned to.
         */
        public Builder groups(List<GroupRef> groups) {
            Utils.checkNotNull(groups, "groups");
            this.groups = Optional.ofNullable(groups);
            return this;
        }
         ...
         * Reference to the groups that the company is assigned to.
         */
        public Builder groups(Optional<? extends List<GroupRef>> groups) {
            Utils.checkNotNull(groups, "groups");
            this.groups = groups;
            return this;
        }
