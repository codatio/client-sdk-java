...
public class NewCompanySynchronizedWebhook {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("Data")
    private Optional<? extends NewCompanySynchronizedWebhookData> data;
    ...
    public NewCompanySynchronizedWebhook(
            ...
            @JsonProperty("Data") Optional<? extends NewCompanySynchronizedWebhookData> data,
    ...
    public Optional<? extends NewCompanySynchronizedWebhookData> data() {
        return data;
    }
     ...
     * Unique identifier of the webhook event.
     */
    public NewCompanySynchronizedWebhook withAlertId(Optional<? extends String> alertId) {
        Utils.checkNotNull(alertId, "alertId");
        this.alertId = alertId;
        return this;
    }
     ...
     * Unique identifier for your client in Codat.
     */
    public NewCompanySynchronizedWebhook withClientId(Optional<? extends String> clientId) {
        Utils.checkNotNull(clientId, "clientId");
        this.clientId = clientId;
        return this;
    }
     ...
     * Name of your client in Codat.
     */
    public NewCompanySynchronizedWebhook withClientName(Optional<? extends String> clientName) {
        Utils.checkNotNull(clientName, "clientName");
        this.clientName = clientName;
        return this;
    }
     ...
     * Unique identifier for your SMB in Codat.
     */
    public NewCompanySynchronizedWebhook withCompanyId(Optional<? extends String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }

    public NewCompanySynchronizedWebhook withData(NewCompanySynchronizedWebhookData data) {
        Utils.checkNotNull(data, "data");
        this.data = Optional.ofNullable(data);
        return this;
    }

    public NewCompanySynchronizedWebhook withData(Optional<? extends NewCompanySynchronizedWebhookData> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Unique identifier for a company's data connection.
     */
    public NewCompanySynchronizedWebhook withDataConnectionId(Optional<? extends String> dataConnectionId) {
        Utils.checkNotNull(dataConnectionId, "dataConnectionId");
        this.dataConnectionId = dataConnectionId;
        return this;
    }
     ...
     * A human-readable message about the webhook.
     */
    public NewCompanySynchronizedWebhook withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * Unique identifier for the rule.
     */
    public NewCompanySynchronizedWebhook withRuleId(Optional<? extends String> ruleId) {
        Utils.checkNotNull(ruleId, "ruleId");
        this.ruleId = ruleId;
        return this;
    }
     ...
     * The type of rule.
     */
    public NewCompanySynchronizedWebhook withRuleType(Optional<? extends String> ruleType) {
        Utils.checkNotNull(ruleType, "ruleType");
        this.ruleType = ruleType;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends NewCompanySynchronizedWebhookData> data = Optional.empty();
        ...
        public Builder data(NewCompanySynchronizedWebhookData data) {
            Utils.checkNotNull(data, "data");
            this.data = Optional.ofNullable(data);
            return this;
        }

        public Builder data(Optional<? extends NewCompanySynchronizedWebhookData> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
