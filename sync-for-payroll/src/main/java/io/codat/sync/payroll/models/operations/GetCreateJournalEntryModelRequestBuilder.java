...
public class GetCreateJournalEntryModelRequestBuilder {
    ...
    public GetCreateJournalEntryModelRequestBuilder request(GetCreateJournalEntryModelRequest request) {
    ...
    public GetCreateJournalEntryModelRequestBuilder retryConfig(Optional<io.codat.sync.payroll.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
