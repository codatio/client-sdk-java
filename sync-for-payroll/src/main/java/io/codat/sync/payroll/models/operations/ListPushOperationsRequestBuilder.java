...
public class ListPushOperationsRequestBuilder {
    ...
    public ListPushOperationsRequestBuilder request(io.codat.sync.payroll.models.operations.ListPushOperationsRequest request) {
    ...
    public ListPushOperationsRequestBuilder retryConfig(java.util.Optional<io.codat.sync.payroll.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
