...
public class GetCreateJournalModelResponse {
    ...
    public GetCreateJournalModelResponse(
            String contentType,
     ...
     * HTTP response content type for this operation
     */
    public GetCreateJournalModelResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public GetCreateJournalModelResponse withErrorMessage(io.codat.sync.payroll.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public GetCreateJournalModelResponse withErrorMessage(Optional<? extends io.codat.sync.payroll.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * OK
     */
    public GetCreateJournalModelResponse withPushOption(io.codat.sync.payroll.models.components.PushOption pushOption) {
        Utils.checkNotNull(pushOption, "pushOption");
     ...
     * OK
     */
    public GetCreateJournalModelResponse withPushOption(Optional<? extends io.codat.sync.payroll.models.components.PushOption> pushOption) {
        Utils.checkNotNull(pushOption, "pushOption");
        this.pushOption = pushOption;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetCreateJournalModelResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetCreateJournalModelResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCreateJournalModelResponse other = (GetCreateJournalModelResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCreateJournalModelResponse.class,
    ...
    public final static class Builder {
        ...
        public GetCreateJournalModelResponse build() {
            return new GetCreateJournalModelResponse(
                contentType,
                errorMessage,
                pushOption,
                statusCode,
