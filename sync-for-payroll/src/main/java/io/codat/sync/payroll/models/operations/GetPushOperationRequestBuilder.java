...
public class GetPushOperationRequestBuilder {
    ...
    public GetPushOperationRequestBuilder request(io.codat.sync.payroll.models.operations.GetPushOperationRequest request) {
    ...
    public GetPushOperationRequestBuilder retryConfig(java.util.Optional<io.codat.sync.payroll.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
