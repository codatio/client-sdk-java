...
public class GetDataStatusResponse {
     ...
     * OK
     */
    private Optional<? extends java.util.Map<String, io.codat.sync.payroll.models.components.DataStatus>> dataStatuses;
    ...
    public GetDataStatusResponse(
            String contentType,
            Optional<? extends java.util.Map<String, io.codat.sync.payroll.models.components.DataStatus>> dataStatuses,
     ...
     * OK
     */
    public Optional<? extends java.util.Map<String, io.codat.sync.payroll.models.components.DataStatus>> dataStatuses() {
        return dataStatuses;
    }
     ...
     * OK
     */
    public GetDataStatusResponse withDataStatuses(java.util.Map<String, io.codat.sync.payroll.models.components.DataStatus> dataStatuses) {
        Utils.checkNotNull(dataStatuses, "dataStatuses");
     ...
     * OK
     */
    public GetDataStatusResponse withDataStatuses(Optional<? extends java.util.Map<String, io.codat.sync.payroll.models.components.DataStatus>> dataStatuses) {
        Utils.checkNotNull(dataStatuses, "dataStatuses");
        this.dataStatuses = dataStatuses;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public GetDataStatusResponse withErrorMessage(io.codat.sync.payroll.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public GetDataStatusResponse withErrorMessage(Optional<? extends io.codat.sync.payroll.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends java.util.Map<String, io.codat.sync.payroll.models.components.DataStatus>> dataStatuses = Optional.empty();
         ...
         * OK
         */
        public Builder dataStatuses(java.util.Map<String, io.codat.sync.payroll.models.components.DataStatus> dataStatuses) {
            Utils.checkNotNull(dataStatuses, "dataStatuses");
            this.dataStatuses = Optional.ofNullable(dataStatuses);
            return this;
        }
         ...
         * OK
         */
        public Builder dataStatuses(Optional<? extends java.util.Map<String, io.codat.sync.payroll.models.components.DataStatus>> dataStatuses) {
            Utils.checkNotNull(dataStatuses, "dataStatuses");
            this.dataStatuses = dataStatuses;
            return this;
        }
