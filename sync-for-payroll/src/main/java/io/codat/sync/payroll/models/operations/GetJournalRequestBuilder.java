...
public class GetJournalRequestBuilder {
    ...
    public GetJournalRequestBuilder request(GetJournalRequest request) {
    ...
    public GetJournalRequestBuilder retryConfig(Optional<io.codat.sync.payroll.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
