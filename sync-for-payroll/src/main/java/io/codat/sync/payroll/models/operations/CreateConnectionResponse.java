...
public class CreateConnectionResponse {
     ...
     * OK
     */
    private Optional<? extends io.codat.sync.payroll.models.components.Connection> connection;
    ...
    public CreateConnectionResponse(
            Optional<? extends io.codat.sync.payroll.models.components.Connection> connection,
            String contentType,
     ...
     * OK
     */
    public Optional<? extends io.codat.sync.payroll.models.components.Connection> connection() {
        return connection;
    }
     ...
     * OK
     */
    public CreateConnectionResponse withConnection(io.codat.sync.payroll.models.components.Connection connection) {
        Utils.checkNotNull(connection, "connection");
     ...
     * OK
     */
    public CreateConnectionResponse withConnection(Optional<? extends io.codat.sync.payroll.models.components.Connection> connection) {
        Utils.checkNotNull(connection, "connection");
        this.connection = connection;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public CreateConnectionResponse withErrorMessage(io.codat.sync.payroll.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public CreateConnectionResponse withErrorMessage(Optional<? extends io.codat.sync.payroll.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.sync.payroll.models.components.Connection> connection = Optional.empty();
         ...
         * OK
         */
        public Builder connection(io.codat.sync.payroll.models.components.Connection connection) {
            Utils.checkNotNull(connection, "connection");
            this.connection = Optional.ofNullable(connection);
            return this;
        }
         ...
         * OK
         */
        public Builder connection(Optional<? extends io.codat.sync.payroll.models.components.Connection> connection) {
            Utils.checkNotNull(connection, "connection");
            this.connection = connection;
            return this;
        }
