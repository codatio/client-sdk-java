...
import io.codat.sync.payroll.models.operations.GetTrackingCategoryRequestBuilder;
...
import io.codat.sync.payroll.models.operations.ListTrackingCategoriesRequestBuilder;
...
public class TrackingCategories implements
    ...
    public ListTrackingCategoriesResponse list(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                io.codat.sync.payroll.models.components.TrackingCategories _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
