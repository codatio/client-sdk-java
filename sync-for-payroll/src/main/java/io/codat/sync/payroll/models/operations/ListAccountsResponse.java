...
public class ListAccountsResponse {
     ...
     * Success
     */
    private Optional<? extends io.codat.sync.payroll.models.components.Accounts> accounts;
    ...
    public ListAccountsResponse(
            Optional<? extends io.codat.sync.payroll.models.components.Accounts> accounts,
            String contentType,
     ...
     * Success
     */
    public Optional<? extends io.codat.sync.payroll.models.components.Accounts> accounts() {
        return accounts;
    }
     ...
     * Success
     */
    public ListAccountsResponse withAccounts(io.codat.sync.payroll.models.components.Accounts accounts) {
        Utils.checkNotNull(accounts, "accounts");
     ...
     * Success
     */
    public ListAccountsResponse withAccounts(Optional<? extends io.codat.sync.payroll.models.components.Accounts> accounts) {
        Utils.checkNotNull(accounts, "accounts");
        this.accounts = accounts;
        return this;
    }
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListAccountsResponse withErrorMessage(io.codat.sync.payroll.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListAccountsResponse withErrorMessage(Optional<? extends io.codat.sync.payroll.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.sync.payroll.models.components.Accounts> accounts = Optional.empty();
         ...
         * Success
         */
        public Builder accounts(io.codat.sync.payroll.models.components.Accounts accounts) {
            Utils.checkNotNull(accounts, "accounts");
            this.accounts = Optional.ofNullable(accounts);
            return this;
        }
         ...
         * Success
         */
        public Builder accounts(Optional<? extends io.codat.sync.payroll.models.components.Accounts> accounts) {
            Utils.checkNotNull(accounts, "accounts");
            this.accounts = accounts;
            return this;
        }
