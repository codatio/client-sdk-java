...
import io.codat.sync.payroll.models.components.Connection;
...
import io.codat.sync.payroll.models.operations.CreateConnectionRequestBuilder;
...
import io.codat.sync.payroll.models.operations.DeleteConnectionRequestBuilder;
...
import io.codat.sync.payroll.models.operations.GetConnectionRequestBuilder;
...
import io.codat.sync.payroll.models.operations.ListConnectionsRequestBuilder;
...
import io.codat.sync.payroll.models.operations.UnlinkConnectionRequestBuilder;
...
public class Connections implements
    ...
    public ListConnectionsResponse list(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                io.codat.sync.payroll.models.components.Connections _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
