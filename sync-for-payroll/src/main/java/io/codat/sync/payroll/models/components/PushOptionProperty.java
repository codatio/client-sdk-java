...
public class PushOptionProperty {
    ...
    public PushOptionProperty withOptions(List<PushOptionChoice> options) {
        Utils.checkNotNull(options, "options");
        this.options = JsonNullable.of(options);
        return this;
    }

    public PushOptionProperty withOptions(JsonNullable<? extends List<PushOptionChoice>> options) {
        Utils.checkNotNull(options, "options");
        this.options = options;
        return this;
    }

    public PushOptionProperty withProperties(Map<String, PushOptionProperty> properties) {
        Utils.checkNotNull(properties, "properties");
        this.properties = JsonNullable.of(properties);
        return this;
    }

    public PushOptionProperty withProperties(JsonNullable<? extends Map<String, PushOptionProperty>> properties) {
        Utils.checkNotNull(properties, "properties");
        this.properties = properties;
        return this;
    }
