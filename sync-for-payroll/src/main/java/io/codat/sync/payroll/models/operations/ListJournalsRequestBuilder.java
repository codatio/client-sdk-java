...
public class ListJournalsRequestBuilder {
    ...
    public ListJournalsRequestBuilder request(ListJournalsRequest request) {
    ...
    public ListJournalsRequestBuilder retryConfig(Optional<io.codat.sync.payroll.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
