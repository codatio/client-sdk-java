...
import io.codat.sync.payroll.models.components.Company;
...
import io.codat.sync.payroll.models.operations.CreateCompanyRequestBuilder;
...
import io.codat.sync.payroll.models.operations.DeleteCompanyRequestBuilder;
...
import io.codat.sync.payroll.models.operations.GetCompanyRequestBuilder;
...
import io.codat.sync.payroll.models.operations.ListCompaniesRequestBuilder;
...
import io.codat.sync.payroll.models.operations.UpdateCompanyRequestBuilder;
...
public class Companies implements
    ...
    public ListCompaniesResponse list(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                io.codat.sync.payroll.models.components.Companies _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
