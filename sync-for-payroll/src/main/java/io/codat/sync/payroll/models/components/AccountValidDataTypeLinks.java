...
public class AccountValidDataTypeLinks {
     ...
     * Supported `dataTypes` that the record can be linked to.
     */
    public AccountValidDataTypeLinks withLinks(java.util.List<String> links) {
        Utils.checkNotNull(links, "links");
     ...
     * Supported `dataTypes` that the record can be linked to.
     */
    public AccountValidDataTypeLinks withLinks(JsonNullable<? extends java.util.List<String>> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
     ...
     * The property from the account that can be linked.
     */
    public AccountValidDataTypeLinks withProperty(JsonNullable<? extends String> property) {
        Utils.checkNotNull(property, "property");
        this.property = property;
        return this;
    }
