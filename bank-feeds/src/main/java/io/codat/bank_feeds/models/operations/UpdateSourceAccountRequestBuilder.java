...
public class UpdateSourceAccountRequestBuilder {
    ...
    public UpdateSourceAccountRequestBuilder request(UpdateSourceAccountRequest request) {
    ...
    public UpdateSourceAccountRequestBuilder retryConfig(Optional<io.codat.bank_feeds.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
