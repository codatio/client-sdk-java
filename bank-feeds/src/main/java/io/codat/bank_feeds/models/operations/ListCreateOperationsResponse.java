...
public class ListCreateOperationsResponse {
     ...
     * OK
     */
    private Optional<? extends io.codat.bank_feeds.models.components.PushOperations> pushOperations;
    ...
    public ListCreateOperationsResponse(
            ...
            Optional<? extends io.codat.bank_feeds.models.components.PushOperations> pushOperations,
            int statusCode,
     ...
     * OK
     */
    public Optional<? extends io.codat.bank_feeds.models.components.PushOperations> pushOperations() {
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListCreateOperationsResponse withErrorMessage(io.codat.bank_feeds.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListCreateOperationsResponse withErrorMessage(Optional<? extends io.codat.bank_feeds.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * OK
     */
    public ListCreateOperationsResponse withPushOperations(io.codat.bank_feeds.models.components.PushOperations pushOperations) {
        Utils.checkNotNull(pushOperations, "pushOperations");
     ...
     * OK
     */
    public ListCreateOperationsResponse withPushOperations(Optional<? extends io.codat.bank_feeds.models.components.PushOperations> pushOperations) {
        Utils.checkNotNull(pushOperations, "pushOperations");
        this.pushOperations = pushOperations;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.bank_feeds.models.components.PushOperations> pushOperations = Optional.empty();
         ...
         * OK
         */
        public Builder pushOperations(io.codat.bank_feeds.models.components.PushOperations pushOperations) {
            Utils.checkNotNull(pushOperations, "pushOperations");
            this.pushOperations = Optional.ofNullable(pushOperations);
            return this;
        }
         ...
         * OK
         */
        public Builder pushOperations(Optional<? extends io.codat.bank_feeds.models.components.PushOperations> pushOperations) {
            Utils.checkNotNull(pushOperations, "pushOperations");
            this.pushOperations = pushOperations;
            return this;
        }
