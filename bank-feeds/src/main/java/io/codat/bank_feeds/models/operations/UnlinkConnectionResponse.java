...
public class UnlinkConnectionResponse {
     ...
     * OK
     */
    private Optional<? extends io.codat.bank_feeds.models.components.Connection> connection;
    ...
    public UnlinkConnectionResponse(
            Optional<? extends io.codat.bank_feeds.models.components.Connection> connection,
            String contentType,
     ...
     * OK
     */
    public Optional<? extends io.codat.bank_feeds.models.components.Connection> connection() {
        return connection;
    }
     ...
     * OK
     */
    public UnlinkConnectionResponse withConnection(io.codat.bank_feeds.models.components.Connection connection) {
        Utils.checkNotNull(connection, "connection");
     ...
     * OK
     */
    public UnlinkConnectionResponse withConnection(Optional<? extends io.codat.bank_feeds.models.components.Connection> connection) {
        Utils.checkNotNull(connection, "connection");
        this.connection = connection;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public UnlinkConnectionResponse withErrorMessage(io.codat.bank_feeds.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public UnlinkConnectionResponse withErrorMessage(Optional<? extends io.codat.bank_feeds.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.bank_feeds.models.components.Connection> connection = Optional.empty();
         ...
         * OK
         */
        public Builder connection(io.codat.bank_feeds.models.components.Connection connection) {
            Utils.checkNotNull(connection, "connection");
            this.connection = Optional.ofNullable(connection);
            return this;
        }
         ...
         * OK
         */
        public Builder connection(Optional<? extends io.codat.bank_feeds.models.components.Connection> connection) {
            Utils.checkNotNull(connection, "connection");
            this.connection = connection;
            return this;
        }
