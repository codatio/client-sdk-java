...
public class GetCreateOperationResponse {
     ...
     * OK
     */
    private Optional<? extends io.codat.bank_feeds.models.components.PushOperation> pushOperation;
    ...
    public GetCreateOperationResponse(
            ...
            Optional<? extends io.codat.bank_feeds.models.components.PushOperation> pushOperation,
            int statusCode,
     ...
     * OK
     */
    public Optional<? extends io.codat.bank_feeds.models.components.PushOperation> pushOperation() {
     ...
     * Your API request was not properly authorized.
     */
    public GetCreateOperationResponse withErrorMessage(io.codat.bank_feeds.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public GetCreateOperationResponse withErrorMessage(Optional<? extends io.codat.bank_feeds.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * OK
     */
    public GetCreateOperationResponse withPushOperation(io.codat.bank_feeds.models.components.PushOperation pushOperation) {
        Utils.checkNotNull(pushOperation, "pushOperation");
     ...
     * OK
     */
    public GetCreateOperationResponse withPushOperation(Optional<? extends io.codat.bank_feeds.models.components.PushOperation> pushOperation) {
        Utils.checkNotNull(pushOperation, "pushOperation");
        this.pushOperation = pushOperation;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.bank_feeds.models.components.PushOperation> pushOperation = Optional.empty();
         ...
         * OK
         */
        public Builder pushOperation(io.codat.bank_feeds.models.components.PushOperation pushOperation) {
            Utils.checkNotNull(pushOperation, "pushOperation");
            this.pushOperation = Optional.ofNullable(pushOperation);
            return this;
        }
         ...
         * OK
         */
        public Builder pushOperation(Optional<? extends io.codat.bank_feeds.models.components.PushOperation> pushOperation) {
            Utils.checkNotNull(pushOperation, "pushOperation");
            this.pushOperation = pushOperation;
            return this;
        }
