...
public class ListConnectionsResponse {
     ...
     * OK
     */
    private Optional<? extends io.codat.bank_feeds.models.components.Connections> connections;
    ...
    public ListConnectionsResponse(
            Optional<? extends io.codat.bank_feeds.models.components.Connections> connections,
            String contentType,
     ...
     * OK
     */
    public Optional<? extends io.codat.bank_feeds.models.components.Connections> connections() {
        return connections;
    }
     ...
     * OK
     */
    public ListConnectionsResponse withConnections(io.codat.bank_feeds.models.components.Connections connections) {
        Utils.checkNotNull(connections, "connections");
     ...
     * OK
     */
    public ListConnectionsResponse withConnections(Optional<? extends io.codat.bank_feeds.models.components.Connections> connections) {
        Utils.checkNotNull(connections, "connections");
        this.connections = connections;
        return this;
    }
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListConnectionsResponse withErrorMessage(io.codat.bank_feeds.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your `query` parameter was not correctly formed
     */
    public ListConnectionsResponse withErrorMessage(Optional<? extends io.codat.bank_feeds.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.bank_feeds.models.components.Connections> connections = Optional.empty();
         ...
         * OK
         */
        public Builder connections(io.codat.bank_feeds.models.components.Connections connections) {
            Utils.checkNotNull(connections, "connections");
            this.connections = Optional.ofNullable(connections);
            return this;
        }
         ...
         * OK
         */
        public Builder connections(Optional<? extends io.codat.bank_feeds.models.components.Connections> connections) {
            Utils.checkNotNull(connections, "connections");
            this.connections = connections;
            return this;
        }
