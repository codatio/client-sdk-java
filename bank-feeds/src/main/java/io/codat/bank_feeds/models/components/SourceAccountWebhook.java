...
public class SourceAccountWebhook {
    ...
    public SourceAccountWebhook(
            ...
            @JsonProperty("payload") Optional<? extends SourceAccountWebhookPayload> payload) {
    ...
    public Optional<SourceAccountWebhookPayload> payload() {
        return (Optional<SourceAccountWebhookPayload>) payload;
    }
     ...
     * The type of event.
     */
    public SourceAccountWebhook withEventType(String eventType) {
        Utils.checkNotNull(eventType, "eventType");
     ...
     * The type of event.
     */
    public SourceAccountWebhook withEventType(Optional<String> eventType) {
        Utils.checkNotNull(eventType, "eventType");
        this.eventType = eventType;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public SourceAccountWebhook withGeneratedDate(String generatedDate) {
        Utils.checkNotNull(generatedDate, "generatedDate");
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public SourceAccountWebhook withGeneratedDate(Optional<String> generatedDate) {
        Utils.checkNotNull(generatedDate, "generatedDate");
        this.generatedDate = generatedDate;
        return this;
    }
     ...
     * Unique identifier of the event.
     */
    public SourceAccountWebhook withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Unique identifier of the event.
     */
    public SourceAccountWebhook withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public SourceAccountWebhook withPayload(SourceAccountWebhookPayload payload) {
        Utils.checkNotNull(payload, "payload");
        this.payload = Optional.ofNullable(payload);
        return this;
    }

    public SourceAccountWebhook withPayload(Optional<? extends SourceAccountWebhookPayload> payload) {
        Utils.checkNotNull(payload, "payload");
        this.payload = payload;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SourceAccountWebhook other = (SourceAccountWebhook) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SourceAccountWebhook.class,
                "eventType", eventType,
    ...
    public final static class Builder {
        ...
        public Builder payload(SourceAccountWebhookPayload payload) {
            Utils.checkNotNull(payload, "payload");
            this.payload = Optional.ofNullable(payload);
            return this;
        }

        public Builder payload(Optional<? extends SourceAccountWebhookPayload> payload) {
            Utils.checkNotNull(payload, "payload");
            this.payload = payload;
            return this;
        }
        ...
        public SourceAccountWebhook build() {
            return new SourceAccountWebhook(
                eventType,
                generatedDate,
                id,
                payload);
