...
public class DeleteSourceAccountResponse {
    ...
    public DeleteSourceAccountResponse(
            String contentType,
     ...
     * HTTP response content type for this operation
     */
    public DeleteSourceAccountResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public DeleteSourceAccountResponse withErrorMessage(io.codat.bank_feeds.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public DeleteSourceAccountResponse withErrorMessage(Optional<? extends io.codat.bank_feeds.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public DeleteSourceAccountResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteSourceAccountResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteSourceAccountResponse other = (DeleteSourceAccountResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteSourceAccountResponse.class,
    ...
    public final static class Builder {
        ...
        public DeleteSourceAccountResponse build() {
