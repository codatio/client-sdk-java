...
public class SetConfigurationResponse {
     ...
     * Success
     */
    public SetConfigurationResponse withConfiguration(io.codat.bank_feeds.models.components.Configuration configuration) {
        Utils.checkNotNull(configuration, "configuration");
     ...
     * Success
     */
    public SetConfigurationResponse withConfiguration(Optional<? extends io.codat.bank_feeds.models.components.Configuration> configuration) {
        Utils.checkNotNull(configuration, "configuration");
        this.configuration = configuration;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public SetConfigurationResponse withErrorMessage(io.codat.bank_feeds.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public SetConfigurationResponse withErrorMessage(Optional<? extends io.codat.bank_feeds.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
