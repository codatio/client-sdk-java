...
public class BankAccountsSupplementalData {
    ...
    public BankAccountsSupplementalData withContent(java.util.Map<String, java.util.Map<String, java.lang.Object>> content) {
        Utils.checkNotNull(content, "content");
        this.content = JsonNullable.of(content);
        return this;
    }

    public BankAccountsSupplementalData withContent(JsonNullable<? extends java.util.Map<String, java.util.Map<String, java.lang.Object>>> content) {
        Utils.checkNotNull(content, "content");
        this.content = content;
        return this;
    }
