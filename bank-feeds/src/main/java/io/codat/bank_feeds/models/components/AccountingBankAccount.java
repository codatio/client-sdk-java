...
public class AccountingBankAccount {
    ...
    private Optional<? extends BankAccountCreateResponseBankAccountType> accountType;
    ...
    public AccountingBankAccount(
            ...
            @JsonProperty("accountType") Optional<? extends BankAccountCreateResponseBankAccountType> accountType,
    ...
    @JsonIgnore
    public Optional<BankAccountCreateResponseBankAccountType> accountType() {
        return (Optional<BankAccountCreateResponseBankAccountType>) accountType;
    }
     ...
     * For Debit accounts, positive balances are assets, and positive transactions **increase** assets.
     */
    public AccountingBankAccount withAccountType(BankAccountCreateResponseBankAccountType accountType) {
        Utils.checkNotNull(accountType, "accountType");
     ...
     * For Debit accounts, positive balances are assets, and positive transactions **increase** assets.
     */
    public AccountingBankAccount withAccountType(Optional<? extends BankAccountCreateResponseBankAccountType> accountType) {
        Utils.checkNotNull(accountType, "accountType");
        this.accountType = accountType;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends BankAccountCreateResponseBankAccountType> accountType = Optional.empty();
         ...
         * For Debit accounts, positive balances are assets, and positive transactions **increase** assets.
         */
        public Builder accountType(BankAccountCreateResponseBankAccountType accountType) {
            Utils.checkNotNull(accountType, "accountType");
            this.accountType = Optional.ofNullable(accountType);
            return this;
        }
         ...
         * For Debit accounts, positive balances are assets, and positive transactions **increase** assets.
         */
        public Builder accountType(Optional<? extends BankAccountCreateResponseBankAccountType> accountType) {
            Utils.checkNotNull(accountType, "accountType");
            this.accountType = accountType;
            return this;
        }
