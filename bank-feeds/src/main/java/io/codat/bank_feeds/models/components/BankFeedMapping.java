...
public class BankFeedMapping {
    ...
    private JsonNullable<? extends java.util.List<TargetAccountOption>> targetAccountOptions;
    ...
    public BankFeedMapping(
            ...
            @JsonProperty("sourceAccountName") Optional<? extends String> sourceAccountName,
            @JsonProperty("sourceAccountNumber") Optional<? extends String> sourceAccountNumber,
            @JsonProperty("sourceBalance") Optional<? extends String> sourceBalance,
            @JsonProperty("sourceCurrency") Optional<? extends String> sourceCurrency,
            ...
            @JsonProperty("targetAccountName") Optional<? extends String> targetAccountName,
            @JsonProperty("targetAccountOptions") JsonNullable<? extends java.util.List<TargetAccountOption>> targetAccountOptions) {
     ...
     * An array of potential target accounts.
     */
    public JsonNullable<? extends java.util.List<TargetAccountOption>> targetAccountOptions() {
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public BankFeedMapping withFeedStartDate(Optional<? extends String> feedStartDate) {
        Utils.checkNotNull(feedStartDate, "feedStartDate");
        this.feedStartDate = feedStartDate;
        return this;
    }
     ...
     * Unique ID for the source account.
     */
    public BankFeedMapping withSourceAccountId(Optional<? extends String> sourceAccountId) {
        Utils.checkNotNull(sourceAccountId, "sourceAccountId");
        this.sourceAccountId = sourceAccountId;
        return this;
    }
     ...
     * Name for the source account.
     */
    public BankFeedMapping withSourceAccountName(Optional<? extends String> sourceAccountName) {
        Utils.checkNotNull(sourceAccountName, "sourceAccountName");
        this.sourceAccountName = sourceAccountName;
        return this;
    }
     ...
     * Account number for the source account.
     */
    public BankFeedMapping withSourceAccountNumber(Optional<? extends String> sourceAccountNumber) {
        Utils.checkNotNull(sourceAccountNumber, "sourceAccountNumber");
        this.sourceAccountNumber = sourceAccountNumber;
        return this;
    }
     ...
     * Balance for the source account.
     */
    public BankFeedMapping withSourceBalance(Optional<? extends String> sourceBalance) {
        Utils.checkNotNull(sourceBalance, "sourceBalance");
        this.sourceBalance = sourceBalance;
        return this;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public BankFeedMapping withSourceCurrency(Optional<? extends String> sourceCurrency) {
        Utils.checkNotNull(sourceCurrency, "sourceCurrency");
        this.sourceCurrency = sourceCurrency;
        return this;
    }
     ...
     * The status.
     */
    public BankFeedMapping withStatus(Optional<? extends String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Unique ID for the target account in the accounting platform.
     */
    public BankFeedMapping withTargetAccountId(JsonNullable<? extends String> targetAccountId) {
        Utils.checkNotNull(targetAccountId, "targetAccountId");
        this.targetAccountId = targetAccountId;
        return this;
    }
     ...
     * Name for the target account in the accounting platform.
     */
    public BankFeedMapping withTargetAccountName(Optional<? extends String> targetAccountName) {
        Utils.checkNotNull(targetAccountName, "targetAccountName");
        this.targetAccountName = targetAccountName;
        return this;
    }
     ...
     * An array of potential target accounts.
     */
    public BankFeedMapping withTargetAccountOptions(java.util.List<TargetAccountOption> targetAccountOptions) {
        Utils.checkNotNull(targetAccountOptions, "targetAccountOptions");
     ...
     * An array of potential target accounts.
     */
    public BankFeedMapping withTargetAccountOptions(JsonNullable<? extends java.util.List<TargetAccountOption>> targetAccountOptions) {
        Utils.checkNotNull(targetAccountOptions, "targetAccountOptions");
        this.targetAccountOptions = targetAccountOptions;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            java.util.Objects.deepEquals(this.sourceAccountName, other.sourceAccountName) &&
            java.util.Objects.deepEquals(this.sourceAccountNumber, other.sourceAccountNumber) &&
            java.util.Objects.deepEquals(this.sourceBalance, other.sourceBalance) &&
            java.util.Objects.deepEquals(this.sourceCurrency, other.sourceCurrency) &&
            java.util.Objects.deepEquals(this.status, other.status) &&
            java.util.Objects.deepEquals(this.targetAccountId, other.targetAccountId) &&
            java.util.Objects.deepEquals(this.targetAccountName, other.targetAccountName) &&
            java.util.Objects.deepEquals(this.targetAccountOptions, other.targetAccountOptions);
    }
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends java.util.List<TargetAccountOption>> targetAccountOptions = JsonNullable.undefined();  
         ...
         * Name for the source account.
         */
        public Builder sourceAccountName(Optional<? extends String> sourceAccountName) {
            Utils.checkNotNull(sourceAccountName, "sourceAccountName");
            this.sourceAccountName = sourceAccountName;
            return this;
        }
         ...
         * Account number for the source account.
         */
        public Builder sourceAccountNumber(Optional<? extends String> sourceAccountNumber) {
            Utils.checkNotNull(sourceAccountNumber, "sourceAccountNumber");
            this.sourceAccountNumber = sourceAccountNumber;
            return this;
        }
         ...
         * Balance for the source account.
         */
        public Builder sourceBalance(Optional<? extends String> sourceBalance) {
            Utils.checkNotNull(sourceBalance, "sourceBalance");
            this.sourceBalance = sourceBalance;
            return this;
        }
         ...
         * There are only a very small number of edge cases where this currency code is returned by the Codat system.
         */
        public Builder sourceCurrency(Optional<? extends String> sourceCurrency) {
            Utils.checkNotNull(sourceCurrency, "sourceCurrency");
            this.sourceCurrency = sourceCurrency;
            return this;
        }
         ...
         * Name for the target account in the accounting platform.
         */
        public Builder targetAccountName(Optional<? extends String> targetAccountName) {
            Utils.checkNotNull(targetAccountName, "targetAccountName");
            this.targetAccountName = targetAccountName;
            return this;
        }
         ...
         * An array of potential target accounts.
         */
        public Builder targetAccountOptions(java.util.List<TargetAccountOption> targetAccountOptions) {
            Utils.checkNotNull(targetAccountOptions, "targetAccountOptions");
            this.targetAccountOptions = JsonNullable.of(targetAccountOptions);
            return this;
        }
         ...
         * An array of potential target accounts.
         */
        public Builder targetAccountOptions(JsonNullable<? extends java.util.List<TargetAccountOption>> targetAccountOptions) {
            Utils.checkNotNull(targetAccountOptions, "targetAccountOptions");
            this.targetAccountOptions = targetAccountOptions;
            return this;
        }
