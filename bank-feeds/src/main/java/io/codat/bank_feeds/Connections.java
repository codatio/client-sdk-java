...
import io.codat.bank_feeds.models.components.Connection;
...
import io.codat.bank_feeds.models.operations.CreateConnectionRequestBuilder;
...
import io.codat.bank_feeds.models.operations.DeleteConnectionRequestBuilder;
...
import io.codat.bank_feeds.models.operations.GetConnectionRequestBuilder;
...
import io.codat.bank_feeds.models.operations.ListConnectionsRequestBuilder;
...
import io.codat.bank_feeds.models.operations.UnlinkConnectionRequestBuilder;
...
public class Connections implements
    ...
    public ListConnectionsResponse list(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                io.codat.bank_feeds.models.components.Connections _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
