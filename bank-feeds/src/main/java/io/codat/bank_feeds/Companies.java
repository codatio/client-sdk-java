...
import io.codat.bank_feeds.models.operations.CreateCompanyRequestBuilder;
...
import io.codat.bank_feeds.models.operations.ListCompaniesRequestBuilder;
...
import io.codat.bank_feeds.models.operations.UpdateCompanyRequestBuilder;
...
public class Companies implements
    ...
    public ListCompaniesResponse list(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                io.codat.bank_feeds.models.components.Companies _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
