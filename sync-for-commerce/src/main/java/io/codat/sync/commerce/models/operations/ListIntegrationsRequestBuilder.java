...
public class ListIntegrationsRequestBuilder {
    ...
    public ListIntegrationsRequestBuilder request(io.codat.sync.commerce.models.operations.ListIntegrationsRequest request) {
    ...
    public ListIntegrationsRequestBuilder retryConfig(java.util.Optional<io.codat.sync.commerce.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
