...
public class ListSyncsResponse {
     ...
     * Success
     */
    private Optional<? extends java.util.List<io.codat.sync.commerce.models.components.CompanySyncStatus>> classes;
    ...
    public ListSyncsResponse(
            ...
            Optional<? extends java.util.List<io.codat.sync.commerce.models.components.CompanySyncStatus>> classes) {
     ...
     * Success
     */
    public Optional<? extends java.util.List<io.codat.sync.commerce.models.components.CompanySyncStatus>> classes() {
        return classes;
    }
     ...
     * Your API request was not properly authorized.
     */
    public ListSyncsResponse withErrorMessage(io.codat.sync.commerce.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public ListSyncsResponse withErrorMessage(Optional<? extends io.codat.sync.commerce.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * Success
     */
    public ListSyncsResponse withClasses(java.util.List<io.codat.sync.commerce.models.components.CompanySyncStatus> classes) {
        Utils.checkNotNull(classes, "classes");
     ...
     * Success
     */
    public ListSyncsResponse withClasses(Optional<? extends java.util.List<io.codat.sync.commerce.models.components.CompanySyncStatus>> classes) {
        Utils.checkNotNull(classes, "classes");
        this.classes = classes;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends java.util.List<io.codat.sync.commerce.models.components.CompanySyncStatus>> classes = Optional.empty();  
         ...
         * Success
         */
        public Builder classes(java.util.List<io.codat.sync.commerce.models.components.CompanySyncStatus> classes) {
            Utils.checkNotNull(classes, "classes");
            this.classes = Optional.ofNullable(classes);
            return this;
        }
         ...
         * Success
         */
        public Builder classes(Optional<? extends java.util.List<io.codat.sync.commerce.models.components.CompanySyncStatus>> classes) {
            Utils.checkNotNull(classes, "classes");
            this.classes = classes;
            return this;
        }
