...
public class CreateCompanyRequestBuilder {
    ...
    private Optional<? extends io.codat.sync.commerce.models.components.CreateCompany> request = Optional.empty();
    ...
    public CreateCompanyRequestBuilder request(Optional<? extends io.codat.sync.commerce.models.components.CreateCompany> request) {
        Utils.checkNotNull(request, "request");
    ...
    public CreateCompanyRequestBuilder retryConfig(Optional<io.codat.sync.commerce.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
