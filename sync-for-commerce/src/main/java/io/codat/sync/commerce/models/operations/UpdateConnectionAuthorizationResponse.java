...
public class UpdateConnectionAuthorizationResponse implements Response {
     ...
     * OK
     */
    public UpdateConnectionAuthorizationResponse withConnection(Connection connection) {
        Utils.checkNotNull(connection, "connection");
     ...
     * OK
     */
    public UpdateConnectionAuthorizationResponse withConnection(Optional<? extends Connection> connection) {
        Utils.checkNotNull(connection, "connection");
        this.connection = connection;
        return this;
    }
