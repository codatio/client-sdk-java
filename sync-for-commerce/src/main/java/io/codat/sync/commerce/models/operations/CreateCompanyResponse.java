...
public class CreateCompanyResponse {
     ...
     * Success
     */
    private Optional<? extends io.codat.sync.commerce.models.components.Company> company;
    ...
    public CreateCompanyResponse(
            Optional<? extends io.codat.sync.commerce.models.components.Company> company,
            String contentType,
     ...
     * Success
     */
    public Optional<? extends io.codat.sync.commerce.models.components.Company> company() {
        return company;
    }
     ...
     * Success
     */
    public CreateCompanyResponse withCompany(io.codat.sync.commerce.models.components.Company company) {
        Utils.checkNotNull(company, "company");
     ...
     * Success
     */
    public CreateCompanyResponse withCompany(Optional<? extends io.codat.sync.commerce.models.components.Company> company) {
        Utils.checkNotNull(company, "company");
        this.company = company;
        return this;
    }
     ...
     * The request made is not valid.
     */
    public CreateCompanyResponse withErrorMessage(io.codat.sync.commerce.models.components.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * The request made is not valid.
     */
    public CreateCompanyResponse withErrorMessage(Optional<? extends io.codat.sync.commerce.models.components.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.sync.commerce.models.components.Company> company = Optional.empty();
         ...
         * Success
         */
        public Builder company(io.codat.sync.commerce.models.components.Company company) {
            Utils.checkNotNull(company, "company");
            this.company = Optional.ofNullable(company);
            return this;
        }
         ...
         * Success
         */
        public Builder company(Optional<? extends io.codat.sync.commerce.models.components.Company> company) {
            Utils.checkNotNull(company, "company");
            this.company = company;
            return this;
        }
