...
public class GetSyncByIdRequestBuilder {
    ...
    public GetSyncByIdRequestBuilder request(io.codat.sync.commerce.models.operations.GetSyncByIdRequest request) {
    ...
    public GetSyncByIdRequestBuilder retryConfig(java.util.Optional<io.codat.sync.commerce.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
