...
public class ListConnectionsRequestBuilder {
    ...
    public ListConnectionsRequestBuilder request(io.codat.sync.commerce.models.operations.ListConnectionsRequest request) {
    ...
    public ListConnectionsRequestBuilder retryConfig(java.util.Optional<io.codat.sync.commerce.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
