...
import io.codat.lending.models.operations.GetCommerceProductCategoryRequestBuilder;
...
import io.codat.lending.models.operations.ListCommerceProductCategoriesRequestBuilder;
...
public class ProductCategories implements
     ...
     */
    public GetCommerceProductCategoryRequestBuilder get() {
        return new GetCommerceProductCategoryRequestBuilder(this);
    }
     ...
     */
    public GetCommerceProductCategoryResponse get(
            GetCommerceProductCategoryRequest request) throws Exception {
    ...
    public GetCommerceProductCategoryResponse get(
        ...
        String _url = Utils.generateURL(
                GetCommerceProductCategoryRequest.class,
                _baseUrl,
        ...
        GetCommerceProductCategoryResponse.Builder _resBuilder = 
        ...
        GetCommerceProductCategoryResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                CommerceProductCategory _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<CommerceProductCategory>() {});
                _res.withCommerceProductCategory(JsonNullable.of(_out));
                return _res;
            } else {
                throw new SDKError(
                    _httpRes, 
     ...
     * @return The call builder
     */
    public ListCommerceProductCategoriesRequestBuilder list() {
        return new ListCommerceProductCategoriesRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public ListCommerceProductCategoriesResponse list(
            ListCommerceProductCategoriesRequest request) throws Exception {
    ...
    public ListCommerceProductCategoriesResponse list(
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                ListCommerceProductCategoriesRequest.class,
                _baseUrl,
            ...
            .action(() -> {
                ...
                try {
                    _r = sdkConfiguration.hooks()
                        .beforeRequest(
                            new BeforeRequestContextImpl(
                                "list-commerce-product-categories", 
                                Optional.of(List.of()), 
                                _hookSecuritySource),
                            _finalReq.build());
                } catch (Exception _e) {
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ListCommerceProductCategoriesResponse.Builder _resBuilder = 
        ...
        ListCommerceProductCategoriesResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                CommerceProductCategories _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<CommerceProductCategories>() {});
                _res.withCommerceProductCategories(Optional.ofNullable(_out));
                return _res;
            } else {
                throw new SDKError(
                    _httpRes, 
