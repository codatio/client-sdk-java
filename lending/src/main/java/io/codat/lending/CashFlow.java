...
import io.codat.lending.models.operations.GetAccountingCashFlowStatementRequestBuilder;
...
public class CashFlow implements
     ...
     */
    public GetAccountingCashFlowStatementRequestBuilder get() {
        return new GetAccountingCashFlowStatementRequestBuilder(this);
    }
     ...
     */
    public GetAccountingCashFlowStatementResponse get(
            GetAccountingCashFlowStatementRequest request) throws Exception {
    ...
    public GetAccountingCashFlowStatementResponse get(
        ...
        GetAccountingCashFlowStatementResponse.Builder _resBuilder = 
        ...
        GetAccountingCashFlowStatementResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                AccountingCashFlowStatement _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<AccountingCashFlowStatement>() {});
                _res.withAccountingCashFlowStatement(Optional.ofNullable(_out));
                return _res;
            } else {
                throw new SDKError(
                    _httpRes, 
