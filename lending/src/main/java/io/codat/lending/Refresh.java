...
import io.codat.lending.models.operations.RefreshAllDataTypesRequestBuilder;
...
import io.codat.lending.models.operations.RefreshDataTypeRequestBuilder;
...
public class Refresh implements
     ...
     */
    public RefreshAllDataTypesRequestBuilder allDataTypes() {
     ...
     */
    public RefreshAllDataTypesResponse allDataTypes(
            RefreshAllDataTypesRequest request) throws Exception {
        return allDataTypes(request, Optional.empty());
    }
     ...
     * @return The call builder
     */
    public RefreshDataTypeRequestBuilder dataType() {
     ...
     * @throws Exception if the API call fails
     */
    public RefreshDataTypeResponse dataType(
            RefreshDataTypeRequest request) throws Exception {
        return dataType(request, Optional.empty());
    }
