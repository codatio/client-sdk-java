...
import io.codat.lending.models.operations.CreateBankTransactionsRequestBuilder;
...
import io.codat.lending.models.operations.GetCreateBankTransactionsModelRequestBuilder;
    ...
    public CreateBankTransactionsResponse create(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                AccountingCreateBankTransactionsResponse _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<AccountingCreateBankTransactionsResponse>() {});
                _res.withAccountingCreateBankTransactionsResponse(Optional.ofNullable(_out));
                return _res;
            } else {
                throw new SDKError(
                    _httpRes, 
