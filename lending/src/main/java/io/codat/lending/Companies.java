...
import io.codat.lending.models.operations.CreateCompanyRequestBuilder;
...
import io.codat.lending.models.operations.DeleteCompanyRequestBuilder;
...
import io.codat.lending.models.operations.GetCompanyRequestBuilder;
...
import io.codat.lending.models.operations.ListCompaniesRequestBuilder;
...
import io.codat.lending.models.operations.UpdateCompanyRequestBuilder;
...
public class Companies implements
    ...
    public ListCompaniesResponse list(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                io.codat.lending.models.shared.Companies _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
