...
public class CodatLendingPayments implements
    ...
    public io.codat.lending.models.operations.CreatePaymentRequestBuilder create() {
     ...
     */
    public io.codat.lending.models.operations.CreatePaymentResponse create(
    ...
    public io.codat.lending.models.operations.GetCreatePaymentModelRequestBuilder getCreateModel() {
     ...
     * @throws Exception if the API call fails
     */
    public io.codat.lending.models.operations.GetCreatePaymentModelResponse getCreateModel(
