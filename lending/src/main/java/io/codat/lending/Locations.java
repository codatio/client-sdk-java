...
import io.codat.lending.models.operations.GetCommerceLocationRequestBuilder;
...
import io.codat.lending.models.operations.ListCommerceLocationsRequestBuilder;
...
public class Locations implements
     ...
     */
    public GetCommerceLocationRequestBuilder get() {
     ...
     */
    public GetCommerceLocationResponse get(
    ...
    public GetCommerceLocationResponse get(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                ...
                _res.withCommerceLocation(JsonNullable.of(_out));
                return _res;
            } else {
                throw new SDKError(
                    _httpRes, 
     ...
     * @return The call builder
     */
    public ListCommerceLocationsRequestBuilder list() {
     ...
     * @throws Exception if the API call fails
     */
    public ListCommerceLocationsResponse list(
    ...
    public ListCommerceLocationsResponse list(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                CommerceLocations _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<CommerceLocations>() {});
