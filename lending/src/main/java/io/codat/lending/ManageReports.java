...
import io.codat.lending.models.operations.GenerateReportRequestBuilder;
...
import io.codat.lending.models.operations.ListReportsRequestBuilder;
 ...
 */
public class ManageReports implements
            MethodCallGenerateReport,
            MethodCallListReports {

    private final SDKConfiguration sdkConfiguration;

    ManageReports(SDKConfiguration sdkConfiguration) {
     ...
     */
    public GenerateReportRequestBuilder generateReport() {
        return new GenerateReportRequestBuilder(this);
    }
    ...
    public GenerateReportResponse generateReport(
        ...
        return generateReport(request, Optional.empty());
    }
    ...
    public GenerateReportResponse generateReport(
        ...
        GenerateReportResponse.Builder _resBuilder = 
        ...
        GenerateReportResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "202")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                ReportOperation _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<ReportOperation>() {});
                _res.withReportOperation(Optional.ofNullable(_out));
                return _res;
            } else {
                throw new SDKError(
                    _httpRes, 
     ...
     * @return The call builder
     */
    public ListReportsRequestBuilder listReports() {
    ...
    public ListReportsResponse listReports(
        ...
        return listReports(request, Optional.empty());
    }
    ...
    public ListReportsResponse listReports(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                Reports _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
