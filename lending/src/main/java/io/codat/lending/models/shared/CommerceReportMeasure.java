...
public class CommerceReportMeasure {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("units")
    private Optional<? extends String> units;
    ...
    public CommerceReportMeasure(
            ...
            @JsonProperty("units") Optional<? extends String> units) {
     ...
     * The measure's units e.g. percentage (%).
     */
    public Optional<? extends String> units() {
        return units;
    }
     ...
     * The measure's display name.
     */
    public CommerceReportMeasure withDisplayName(Optional<? extends String> displayName) {
        Utils.checkNotNull(displayName, "displayName");
        this.displayName = displayName;
        return this;
    }
     ...
     * The measure's index.
     */
    public CommerceReportMeasure withIndex(Optional<? extends Long> index) {
        Utils.checkNotNull(index, "index");
        this.index = index;
        return this;
    }
     ...
     * The measure's type.
     */
    public CommerceReportMeasure withType(Optional<? extends String> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * The measure's units e.g. percentage (%).
     */
    public CommerceReportMeasure withUnits(Optional<? extends String> units) {
        Utils.checkNotNull(units, "units");
        this.units = units;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends String> units = Optional.empty();  
         ...
         * The measure's units e.g. percentage (%).
         */
        public Builder units(Optional<? extends String> units) {
            Utils.checkNotNull(units, "units");
            this.units = units;
            return this;
        }
