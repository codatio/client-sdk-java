...
public class ListAccountingCustomersRequest {
    ...
    public ListAccountingCustomersRequest(
            String companyId,
     ...
     * Unique identifier for a company.
     */
    public ListAccountingCustomersRequest withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * Field to order results by. [Read more](https://docs.codat.io/using-the-api/ordering-results).
     */
    public ListAccountingCustomersRequest withOrderBy(String orderBy) {
        Utils.checkNotNull(orderBy, "orderBy");
     ...
     * Field to order results by. [Read more](https://docs.codat.io/using-the-api/ordering-results).
     */
    public ListAccountingCustomersRequest withOrderBy(Optional<? extends String> orderBy) {
        Utils.checkNotNull(orderBy, "orderBy");
        this.orderBy = orderBy;
        return this;
    }
     ...
     * Page number. [Read more](https://docs.codat.io/using-the-api/paging).
     */
    public ListAccountingCustomersRequest withPage(int page) {
        Utils.checkNotNull(page, "page");
     ...
     * Page number. [Read more](https://docs.codat.io/using-the-api/paging).
     */
    public ListAccountingCustomersRequest withPage(Optional<? extends Integer> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * Number of records to return in a page. [Read more](https://docs.codat.io/using-the-api/paging).
     */
    public ListAccountingCustomersRequest withPageSize(int pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * Number of records to return in a page. [Read more](https://docs.codat.io/using-the-api/paging).
     */
    public ListAccountingCustomersRequest withPageSize(Optional<? extends Integer> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * Codat query string. [Read more](https://docs.codat.io/using-the-api/querying).
     */
    public ListAccountingCustomersRequest withQuery(Optional<? extends String> query) {
        Utils.checkNotNull(query, "query");
        this.query = query;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListAccountingCustomersRequest other = (ListAccountingCustomersRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListAccountingCustomersRequest.class,
                "companyId", companyId,
                "orderBy", orderBy,
                "page", page,
                "pageSize", pageSize,
    ...
    public final static class Builder {
        ...
        public ListAccountingCustomersRequest build() {
            if (page == null) {
            ...
            return new ListAccountingCustomersRequest(
                companyId,
                orderBy,
                page,
                pageSize,
