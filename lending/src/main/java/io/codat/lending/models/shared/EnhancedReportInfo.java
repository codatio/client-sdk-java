...
public class EnhancedReportInfo {
     ...
     * Name of the company queried.
     */
    public EnhancedReportInfo withCompanyName(Optional<? extends String> companyName) {
        Utils.checkNotNull(companyName, "companyName");
        this.companyName = companyName;
        return this;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public EnhancedReportInfo withCurrency(Optional<? extends String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public EnhancedReportInfo withGeneratedDate(Optional<? extends String> generatedDate) {
        Utils.checkNotNull(generatedDate, "generatedDate");
        this.generatedDate = generatedDate;
        return this;
    }
     ...
     * The name of the report.
     */
    public EnhancedReportInfo withReportName(Optional<? extends String> reportName) {
        Utils.checkNotNull(reportName, "reportName");
        this.reportName = reportName;
        return this;
    }
