...
public class PullOperation {
     ...
     */
    @JsonProperty("status")
    private PullOperationStatus status;
    ...
    public PullOperation(
            ...
            @JsonProperty("status") PullOperationStatus status,
     ...
     * The current status of the pull operation.
     */
    public PullOperationStatus status() {
        return status;
    }
     ...
     * The current status of the pull operation.
     */
    public PullOperation withStatus(PullOperationStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * The current status of the pull operation.
         */
        public Builder status(PullOperationStatus status) {
            Utils.checkNotNull(status, "status");
            this.status = status;
            return this;
        }
