...
public class CashFlowTransaction {
     ...
     * An account reference containing the account id and name.
     */
    public CashFlowTransaction withAccountRef(AccountRef accountRef) {
        Utils.checkNotNull(accountRef, "accountRef");
     ...
     * An account reference containing the account id and name.
     */
    public CashFlowTransaction withAccountRef(Optional<? extends AccountRef> accountRef) {
        Utils.checkNotNull(accountRef, "accountRef");
        this.accountRef = accountRef;
        return this;
    }
     ...
     * The bank transaction amount.
     */
    public CashFlowTransaction withAmount(BigDecimal amount) {
        Utils.checkNotNull(amount, "amount");
         ...
         * The bank transaction amount.
         */
    public CashFlowTransaction withAmount(double amount) {
     ...
     * The bank transaction amount.
     */
    public CashFlowTransaction withAmount(Optional<? extends BigDecimal> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * An array of counterparty names involved in the transaction.
     */
    public CashFlowTransaction withCounterpartyNames(List<String> counterpartyNames) {
        Utils.checkNotNull(counterpartyNames, "counterpartyNames");
     ...
     * An array of counterparty names involved in the transaction.
     */
    public CashFlowTransaction withCounterpartyNames(Optional<? extends List<String>> counterpartyNames) {
        Utils.checkNotNull(counterpartyNames, "counterpartyNames");
        this.counterpartyNames = counterpartyNames;
        return this;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public CashFlowTransaction withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public CashFlowTransaction withCurrency(Optional<String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CashFlowTransaction withDate(String date) {
        Utils.checkNotNull(date, "date");
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CashFlowTransaction withDate(Optional<String> date) {
        Utils.checkNotNull(date, "date");
        this.date = date;
        return this;
    }
     ...
     * The description of the bank transaction.
     */
    public CashFlowTransaction withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * The description of the bank transaction.
     */
    public CashFlowTransaction withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * The unique identifier of the bank transaction.
     */
    public CashFlowTransaction withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * The unique identifier of the bank transaction.
     */
    public CashFlowTransaction withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CashFlowTransaction withModifiedDate(String modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public CashFlowTransaction withModifiedDate(Optional<String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Returns the payment processor responsible for the transaction.
     */
    public CashFlowTransaction withPlatformName(String platformName) {
        Utils.checkNotNull(platformName, "platformName");
     ...
     * Returns the payment processor responsible for the transaction.
     */
    public CashFlowTransaction withPlatformName(Optional<String> platformName) {
        Utils.checkNotNull(platformName, "platformName");
        this.platformName = platformName;
        return this;
    }
     ...
     * A source reference containing the `sourceType` object "Banking".
     */
    public CashFlowTransaction withSourceRef(SourceRef sourceRef) {
        Utils.checkNotNull(sourceRef, "sourceRef");
     ...
     * A source reference containing the `sourceType` object "Banking".
     */
    public CashFlowTransaction withSourceRef(Optional<? extends SourceRef> sourceRef) {
        Utils.checkNotNull(sourceRef, "sourceRef");
        this.sourceRef = sourceRef;
        return this;
    }

    public CashFlowTransaction withTransactionCategory(TransactionCategory transactionCategory) {
        Utils.checkNotNull(transactionCategory, "transactionCategory");
        this.transactionCategory = Optional.ofNullable(transactionCategory);
        return this;
    }

    public CashFlowTransaction withTransactionCategory(Optional<? extends TransactionCategory> transactionCategory) {
        Utils.checkNotNull(transactionCategory, "transactionCategory");
        this.transactionCategory = transactionCategory;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CashFlowTransaction other = (CashFlowTransaction) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CashFlowTransaction.class,
