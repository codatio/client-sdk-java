...
public class ValidDataTypeLinks {
     ...
     * Supported `dataTypes` that the record can be linked to.
     */
    public ValidDataTypeLinks withLinks(List<String> links) {
        Utils.checkNotNull(links, "links");
     ...
     * Supported `dataTypes` that the record can be linked to.
     */
    public ValidDataTypeLinks withLinks(JsonNullable<? extends List<String>> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
     ...
     * The property from the account that can be linked.
     */
    public ValidDataTypeLinks withProperty(JsonNullable<String> property) {
        Utils.checkNotNull(property, "property");
        this.property = property;
        return this;
    }
