...
public class CreateDirectCostRequest {
    ...
    private Optional<? extends io.codat.lending.models.shared.DirectCostPrototype> directCostPrototype;
    ...
    public CreateDirectCostRequest(
            ...
            String companyId,
            String connectionId,
            Optional<? extends io.codat.lending.models.shared.DirectCostPrototype> directCostPrototype,
    ...
    public Optional<? extends io.codat.lending.models.shared.DirectCostPrototype> directCostPrototype() {
     ...
     * Allow a sync upon push completion.
     */
    public CreateDirectCostRequest withAllowSyncOnPushComplete(Optional<? extends Boolean> allowSyncOnPushComplete) {
        Utils.checkNotNull(allowSyncOnPushComplete, "allowSyncOnPushComplete");
        this.allowSyncOnPushComplete = allowSyncOnPushComplete;
        return this;
    }
    ...
    public CreateDirectCostRequest withDirectCostPrototype(io.codat.lending.models.shared.DirectCostPrototype directCostPrototype) {
        Utils.checkNotNull(directCostPrototype, "directCostPrototype");
        this.directCostPrototype = Optional.ofNullable(directCostPrototype);
        return this;
    }
    
    public CreateDirectCostRequest withDirectCostPrototype(Optional<? extends io.codat.lending.models.shared.DirectCostPrototype> directCostPrototype) {
        Utils.checkNotNull(directCostPrototype, "directCostPrototype");
        this.directCostPrototype = directCostPrototype;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.lending.models.shared.DirectCostPrototype> directCostPrototype = Optional.empty();
        ...
        public Builder directCostPrototype(io.codat.lending.models.shared.DirectCostPrototype directCostPrototype) {
            Utils.checkNotNull(directCostPrototype, "directCostPrototype");
            this.directCostPrototype = Optional.ofNullable(directCostPrototype);
            return this;
        }
        
        public Builder directCostPrototype(Optional<? extends io.codat.lending.models.shared.DirectCostPrototype> directCostPrototype) {
            Utils.checkNotNull(directCostPrototype, "directCostPrototype");
            this.directCostPrototype = directCostPrototype;
            return this;
        }
