...
public class ExcelStatus {
    ...
    private JsonNullable<? extends Long> fileSize;
    ...
    private Optional<? extends Boolean> inProgress;
    ...
    private Optional<? extends String> lastGenerated;
    ...
    private Optional<? extends String> lastInvocationId;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("queued")
    private Optional<? extends String> queued;
    ...
    public ExcelStatus(
            ...
            @JsonProperty("fileSize") JsonNullable<? extends Long> fileSize,
            @JsonProperty("inProgress") Optional<? extends Boolean> inProgress,
            @JsonProperty("lastGenerated") Optional<? extends String> lastGenerated,
            @JsonProperty("lastInvocationId") Optional<? extends String> lastInvocationId,
            @JsonProperty("queued") Optional<? extends String> queued,
     ...
     * The file size in Bytes is populated upon successful generation of the report.
     */
    public JsonNullable<? extends Long> fileSize() {
        return fileSize;
    }
     ...
     * When true, the request was successful and the report is being generated. If false, the request was unsuccessful and the report is not being generated.
     */
    public Optional<? extends Boolean> inProgress() {
        return inProgress;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public Optional<? extends String> lastGenerated() {
     ...
     * A unique ID generated for this request.
     */
    public Optional<? extends String> lastInvocationId() {
     ...
     * The date and time of when a successful request was queued for the most recent report.
     */
    public Optional<? extends String> queued() {
        return queued;
    }
     ...
     * The type of the report requested in the query string.
     */
    public Optional<? extends ExcelReportTypes> reportType() {
        return reportType;
    }
     ...
     * Error details in case the report generation request was unsuccessful.
     */
    public ExcelStatus withErrorMessage(Optional<? extends String> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * The file size in Bytes is populated upon successful generation of the report.
     */
    public ExcelStatus withFileSize(JsonNullable<? extends Long> fileSize) {
        Utils.checkNotNull(fileSize, "fileSize");
        this.fileSize = fileSize;
        return this;
    }
     ...
     * When true, the request was successful and the report is being generated. If false, the request was unsuccessful and the report is not being generated.
     */
    public ExcelStatus withInProgress(Optional<? extends Boolean> inProgress) {
        Utils.checkNotNull(inProgress, "inProgress");
        this.inProgress = inProgress;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public ExcelStatus withLastGenerated(Optional<? extends String> lastGenerated) {
        Utils.checkNotNull(lastGenerated, "lastGenerated");
        this.lastGenerated = lastGenerated;
        return this;
    }
     ...
     * A unique ID generated for this request.
     */
    public ExcelStatus withLastInvocationId(Optional<? extends String> lastInvocationId) {
        Utils.checkNotNull(lastInvocationId, "lastInvocationId");
        this.lastInvocationId = lastInvocationId;
        return this;
    }
     ...
     * The date and time of when a successful request was queued for the most recent report.
     */
    public ExcelStatus withQueued(Optional<? extends String> queued) {
        Utils.checkNotNull(queued, "queued");
        this.queued = queued;
        return this;
    }
     ...
     * True if the requested report was successfully queued and false if the requested report was not able to be queued.
     */
    public ExcelStatus withSuccess(Optional<? extends Boolean> success) {
        Utils.checkNotNull(success, "success");
        this.success = success;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            java.util.Objects.deepEquals(this.inProgress, other.inProgress) &&
            java.util.Objects.deepEquals(this.lastGenerated, other.lastGenerated) &&
            java.util.Objects.deepEquals(this.lastInvocationId, other.lastInvocationId) &&
            java.util.Objects.deepEquals(this.queued, other.queued) &&
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends Long> fileSize = JsonNullable.undefined();
 
        private Optional<? extends Boolean> inProgress = Optional.empty();
 
        private Optional<? extends String> lastGenerated = Optional.empty();
 
        private Optional<? extends String> lastInvocationId = Optional.empty();
 
        private Optional<? extends String> queued = Optional.empty();
         ...
         * The file size in Bytes is populated upon successful generation of the report.
         */
        public Builder fileSize(JsonNullable<? extends Long> fileSize) {
            Utils.checkNotNull(fileSize, "fileSize");
            this.fileSize = fileSize;
            return this;
        }
         ...
         * When true, the request was successful and the report is being generated. If false, the request was unsuccessful and the report is not being generated.
         */
        public Builder inProgress(Optional<? extends Boolean> inProgress) {
            Utils.checkNotNull(inProgress, "inProgress");
            this.inProgress = inProgress;
            return this;
        }
         ...
         * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
         */
        public Builder lastGenerated(Optional<? extends String> lastGenerated) {
            Utils.checkNotNull(lastGenerated, "lastGenerated");
            this.lastGenerated = lastGenerated;
            return this;
        }
         ...
         * A unique ID generated for this request.
         */
        public Builder lastInvocationId(Optional<? extends String> lastInvocationId) {
            Utils.checkNotNull(lastInvocationId, "lastInvocationId");
            this.lastInvocationId = lastInvocationId;
            return this;
        }
         ...
         * The date and time of when a successful request was queued for the most recent report.
         */
        public Builder queued(Optional<? extends String> queued) {
            Utils.checkNotNull(queued, "queued");
            this.queued = queued;
            return this;
        }
