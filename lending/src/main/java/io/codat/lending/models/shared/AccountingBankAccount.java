...
public class AccountingBankAccount {
     ...
     * For Debit accounts, positive balances are assets, and positive transactions **increase** assets.
     */
    public AccountingBankAccount withAccountType(AccountingBankAccountType accountType) {
        Utils.checkNotNull(accountType, "accountType");
     ...
     * For Debit accounts, positive balances are assets, and positive transactions **increase** assets.
     */
    public AccountingBankAccount withAccountType(Optional<? extends AccountingBankAccountType> accountType) {
        Utils.checkNotNull(accountType, "accountType");
        this.accountType = accountType;
        return this;
    }
