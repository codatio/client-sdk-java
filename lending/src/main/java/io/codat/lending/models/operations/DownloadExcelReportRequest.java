...
public class DownloadExcelReportRequest {
     ...
     * The type of report you want to generate and download.
     */
    public DownloadExcelReportRequest withReportType(ExcelReportTypes reportType) {
        Utils.checkNotNull(reportType, "reportType");
        this.reportType = reportType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DownloadExcelReportRequest other = (DownloadExcelReportRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DownloadExcelReportRequest.class,
                "companyId", companyId,
    ...
    public final static class Builder {
        ...
        public DownloadExcelReportRequest build() {
            return new DownloadExcelReportRequest(
                companyId,
                reportType);
        }
    }
