...
public class AgedCurrencyOutstanding {
     ...
     * Array of outstanding amounts by period.
     */
    public AgedCurrencyOutstanding withAgedOutstandingAmounts(List<AgedOutstandingAmount> agedOutstandingAmounts) {
        Utils.checkNotNull(agedOutstandingAmounts, "agedOutstandingAmounts");
     ...
     * Array of outstanding amounts by period.
     */
    public AgedCurrencyOutstanding withAgedOutstandingAmounts(Optional<? extends List<AgedOutstandingAmount>> agedOutstandingAmounts) {
        Utils.checkNotNull(agedOutstandingAmounts, "agedOutstandingAmounts");
        this.agedOutstandingAmounts = agedOutstandingAmounts;
        return this;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public AgedCurrencyOutstanding withCurrency(Optional<String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
