...
public class AccountingCreateBankTransactions {
     ...
     * Unique identifier for a bank account.
     */
    public AccountingCreateBankTransactions withAccountId(Optional<? extends String> accountId) {
        Utils.checkNotNull(accountId, "accountId");
        this.accountId = accountId;
        return this;
    }

    public AccountingCreateBankTransactions withTransactions(java.util.List<CreateBankAccountTransaction> transactions) {
        Utils.checkNotNull(transactions, "transactions");
        this.transactions = Optional.ofNullable(transactions);
        return this;
    }
    
    public AccountingCreateBankTransactions withTransactions(Optional<? extends java.util.List<CreateBankAccountTransaction>> transactions) {
        Utils.checkNotNull(transactions, "transactions");
        this.transactions = transactions;
        return this;
    }
