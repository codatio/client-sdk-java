...
public class BankFeedBankAccountMappingResponse {
    ...
    @JsonCreator
    public BankFeedBankAccountMappingResponse(
     ...
     * Error returned during the post request
     */
    public BankFeedBankAccountMappingResponse withError(String error) {
        Utils.checkNotNull(error, "error");
     ...
     * Error returned during the post request
     */
    public BankFeedBankAccountMappingResponse withError(JsonNullable<String> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
     ...
     * Unique ID for the source account.
     */
    public BankFeedBankAccountMappingResponse withSourceAccountId(String sourceAccountId) {
        Utils.checkNotNull(sourceAccountId, "sourceAccountId");
     ...
     * Unique ID for the source account.
     */
    public BankFeedBankAccountMappingResponse withSourceAccountId(Optional<String> sourceAccountId) {
        Utils.checkNotNull(sourceAccountId, "sourceAccountId");
        this.sourceAccountId = sourceAccountId;
        return this;
    }
     ...
     * Status of the POST request.
     */
    public BankFeedBankAccountMappingResponse withStatus(String status) {
        Utils.checkNotNull(status, "status");
     ...
     * Status of the POST request.
     */
    public BankFeedBankAccountMappingResponse withStatus(JsonNullable<String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Unique ID for the target account.
     */
    public BankFeedBankAccountMappingResponse withTargetAccountId(String targetAccountId) {
        Utils.checkNotNull(targetAccountId, "targetAccountId");
     ...
     * Unique ID for the target account.
     */
    public BankFeedBankAccountMappingResponse withTargetAccountId(JsonNullable<String> targetAccountId) {
        Utils.checkNotNull(targetAccountId, "targetAccountId");
        this.targetAccountId = targetAccountId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BankFeedBankAccountMappingResponse other = (BankFeedBankAccountMappingResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(BankFeedBankAccountMappingResponse.class,
                "error", error,
    ...
    public final static class Builder {
        ...
        public BankFeedBankAccountMappingResponse build() {
            return new BankFeedBankAccountMappingResponse(
                error,
                sourceAccountId,
                status,
                targetAccountId);
