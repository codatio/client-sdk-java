...
public class BankingAccountBalance {
    ...
    public BankingAccountBalance(
            ...
            String date) {
        this(accountId, balance, date, Optional.empty(), Optional.empty());
    }
    ...
    public BankingAccountBalance withModifiedDate(Optional<String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
    ...
    public BankingAccountBalance withSourceModifiedDate(Optional<String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
