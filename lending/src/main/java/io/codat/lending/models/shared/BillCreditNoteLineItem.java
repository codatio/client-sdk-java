...
public class BillCreditNoteLineItem {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<ItemReference> itemRef() {
        return (Optional<ItemReference>) itemRef;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<TaxRateReference> taxRateRef() {
        return (Optional<TaxRateReference>) taxRateRef;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<AccountsPayableTracking> tracking() {
        return (Optional<AccountsPayableTracking>) tracking;
    }
