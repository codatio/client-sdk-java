...
public class AccountsReceivableTracking {
    ...
    public AccountsReceivableTracking withCategoryRefs(List<TrackingCategoryRef> categoryRefs) {
        Utils.checkNotNull(categoryRefs, "categoryRefs");
        this.categoryRefs = categoryRefs;
        return this;
    }

    public AccountsReceivableTracking withCustomerRef(AccountingCustomerRef customerRef) {
        Utils.checkNotNull(customerRef, "customerRef");
        this.customerRef = Optional.ofNullable(customerRef);
        return this;
    }

    public AccountsReceivableTracking withCustomerRef(Optional<? extends AccountingCustomerRef> customerRef) {
        Utils.checkNotNull(customerRef, "customerRef");
        this.customerRef = customerRef;
        return this;
    }
     ...
     * Defines if the bill or bill credit note is billed/rebilled to a project.
     */
    public AccountsReceivableTracking withIsBilledTo(BilledToType1 isBilledTo) {
        Utils.checkNotNull(isBilledTo, "isBilledTo");
        this.isBilledTo = isBilledTo;
        return this;
    }
     ...
     * Defines if the bill or bill credit note is billed/rebilled to a project.
     */
    public AccountsReceivableTracking withIsRebilledTo(BilledToType1 isRebilledTo) {
        Utils.checkNotNull(isRebilledTo, "isRebilledTo");
        this.isRebilledTo = isRebilledTo;
        return this;
    }

    public AccountsReceivableTracking withProjectRef(ProjectRef projectRef) {
        Utils.checkNotNull(projectRef, "projectRef");
        this.projectRef = Optional.ofNullable(projectRef);
        return this;
    }

    public AccountsReceivableTracking withProjectRef(Optional<? extends ProjectRef> projectRef) {
        Utils.checkNotNull(projectRef, "projectRef");
        this.projectRef = projectRef;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountsReceivableTracking other = (AccountsReceivableTracking) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AccountsReceivableTracking.class,
    ...
    public final static class Builder {
        ...
        public AccountsReceivableTracking build() {
            return new AccountsReceivableTracking(
                categoryRefs,
                customerRef,
                isBilledTo,
                isRebilledTo,
