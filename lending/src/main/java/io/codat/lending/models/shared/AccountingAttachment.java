...
public class AccountingAttachment {
     ...
     * Supported file types vary per platform. 
     */
    public AccountingAttachment withContentType(JsonNullable<? extends String> contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public AccountingAttachment withDateCreated(Optional<? extends String> dateCreated) {
        Utils.checkNotNull(dateCreated, "dateCreated");
        this.dateCreated = dateCreated;
        return this;
    }
     ...
     * File size in bytes. For example, if this reads **46153**, then the file size is 46kb.
     */
    public AccountingAttachment withFileSize(JsonNullable<? extends Integer> fileSize) {
        Utils.checkNotNull(fileSize, "fileSize");
        this.fileSize = fileSize;
        return this;
    }
     ...
     * Identifier for the attachment, unique for the company in the accounting platform.
     */
    public AccountingAttachment withId(Optional<? extends String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * If `true`, then the attachment is included with the associated invoice, bill or direct costs when it is printed, emailed, or sent to a customer, if the underlying accounting platform allows this.
     */
    public AccountingAttachment withIncludeWhenSent(Optional<? extends Boolean> includeWhenSent) {
        Utils.checkNotNull(includeWhenSent, "includeWhenSent");
        this.includeWhenSent = includeWhenSent;
        return this;
    }
    ...
    public AccountingAttachment withModifiedDate(Optional<? extends String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Name of the attachment file.
     */
    public AccountingAttachment withName(JsonNullable<? extends String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
    ...
    public AccountingAttachment withSourceModifiedDate(Optional<? extends String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
