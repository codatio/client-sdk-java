...
public class GetAccountingAgedDebtorsReportRequest {
     ...
     * Number of periods to include in the report.
     */
    public GetAccountingAgedDebtorsReportRequest withNumberOfPeriods(Optional<Integer> numberOfPeriods) {
        Utils.checkNotNull(numberOfPeriods, "numberOfPeriods");
        this.numberOfPeriods = numberOfPeriods;
        return this;
    }
     ...
     * The length of period in days.
     */
    public GetAccountingAgedDebtorsReportRequest withPeriodLengthDays(Optional<Integer> periodLengthDays) {
        Utils.checkNotNull(periodLengthDays, "periodLengthDays");
        this.periodLengthDays = periodLengthDays;
        return this;
    }
     ...
     * Date the report is generated up to.
     */
    public GetAccountingAgedDebtorsReportRequest withReportDate(Optional<LocalDate> reportDate) {
        Utils.checkNotNull(reportDate, "reportDate");
        this.reportDate = reportDate;
        return this;
    }
