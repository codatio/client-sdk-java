...
public class AccountingCreditNote {
     ...
     * An array of payment allocations.
     */
    public AccountingCreditNote withPaymentAllocations(List<AccountingPaymentAllocation> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
     ...
     * An array of payment allocations.
     */
    public AccountingCreditNote withPaymentAllocations(JsonNullable<? extends List<AccountingPaymentAllocation>> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
        this.paymentAllocations = paymentAllocations;
        return this;
    }
    ...
    public AccountingCreditNote withWithholdingTax(List<Items> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = JsonNullable.of(withholdingTax);
        return this;
    }

    public AccountingCreditNote withWithholdingTax(JsonNullable<? extends List<Items>> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = withholdingTax;
        return this;
    }
