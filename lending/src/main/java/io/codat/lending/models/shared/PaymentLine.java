...
public class PaymentLine {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("links")
    private JsonNullable<? extends java.util.List<PaymentLineLink>> links;

    public PaymentLine(
            @JsonProperty("allocatedOnDate") Optional<? extends String> allocatedOnDate,
            @JsonProperty("amount") double amount,
            @JsonProperty("links") JsonNullable<? extends java.util.List<PaymentLineLink>> links) {
    ...
    public JsonNullable<? extends java.util.List<PaymentLineLink>> links() {
        return links;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public PaymentLine withAllocatedOnDate(String allocatedOnDate) {
        Utils.checkNotNull(allocatedOnDate, "allocatedOnDate");
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public PaymentLine withAllocatedOnDate(Optional<? extends String> allocatedOnDate) {
        Utils.checkNotNull(allocatedOnDate, "allocatedOnDate");
        this.allocatedOnDate = allocatedOnDate;
        return this;
    }
     ...
     * Amount in the payment currency.
     */
    public PaymentLine withAmount(double amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }

    public PaymentLine withLinks(java.util.List<PaymentLineLink> links) {
        Utils.checkNotNull(links, "links");
        this.links = JsonNullable.of(links);
        return this;
    }

    public PaymentLine withLinks(JsonNullable<? extends java.util.List<PaymentLineLink>> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PaymentLine other = (PaymentLine) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PaymentLine.class,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends java.util.List<PaymentLineLink>> links = JsonNullable.undefined();  
        ...
        public Builder links(java.util.List<PaymentLineLink> links) {
            Utils.checkNotNull(links, "links");
            this.links = JsonNullable.of(links);
            return this;
        }

        public Builder links(JsonNullable<? extends java.util.List<PaymentLineLink>> links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
