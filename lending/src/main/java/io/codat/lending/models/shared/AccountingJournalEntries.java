...
public class AccountingJournalEntries {
    ...
    private Optional<? extends java.util.List<AccountingJournalEntry>> results;
    ...
    public AccountingJournalEntries(
            ...
            @JsonProperty("results") Optional<? extends java.util.List<AccountingJournalEntry>> results,
    ...
    public Optional<? extends java.util.List<AccountingJournalEntry>> results() {
        return results;
    }
    ...
    public AccountingJournalEntries withResults(java.util.List<AccountingJournalEntry> results) {
        Utils.checkNotNull(results, "results");
        this.results = Optional.ofNullable(results);
        return this;
    }
    
    public AccountingJournalEntries withResults(Optional<? extends java.util.List<AccountingJournalEntry>> results) {
        Utils.checkNotNull(results, "results");
        this.results = results;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends java.util.List<AccountingJournalEntry>> results = Optional.empty();
        ...
        public Builder results(java.util.List<AccountingJournalEntry> results) {
            Utils.checkNotNull(results, "results");
            this.results = Optional.ofNullable(results);
            return this;
        }
        
        public Builder results(Optional<? extends java.util.List<AccountingJournalEntry>> results) {
            Utils.checkNotNull(results, "results");
            this.results = results;
            return this;
        }
