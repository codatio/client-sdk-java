...
public class GetAccountingDirectIncomeRequest {
    ...
    @JsonCreator
    public GetAccountingDirectIncomeRequest(
            String companyId,
            String connectionId,
     ...
     * Unique identifier for a company.
     */
    public GetAccountingDirectIncomeRequest withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * Unique identifier for a connection.
     */
    public GetAccountingDirectIncomeRequest withConnectionId(String connectionId) {
        Utils.checkNotNull(connectionId, "connectionId");
        this.connectionId = connectionId;
        return this;
    }
     ...
     * Unique identifier for a direct income.
     */
    public GetAccountingDirectIncomeRequest withDirectIncomeId(String directIncomeId) {
        Utils.checkNotNull(directIncomeId, "directIncomeId");
        this.directIncomeId = directIncomeId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetAccountingDirectIncomeRequest other = (GetAccountingDirectIncomeRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetAccountingDirectIncomeRequest.class,
                "companyId", companyId,
    ...
    public final static class Builder {
        ...
        public GetAccountingDirectIncomeRequest build() {
            return new GetAccountingDirectIncomeRequest(
                companyId,
                connectionId,
                directIncomeId);
        }
