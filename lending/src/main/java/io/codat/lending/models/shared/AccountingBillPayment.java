...
public class AccountingBillPayment {
    ...
    public AccountingBillPayment withCurrency(Optional<String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
     */
    public AccountingBillPayment withCurrencyRate(BigDecimal currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
     */
    public AccountingBillPayment withCurrencyRate(JsonNullable<? extends BigDecimal> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }
     ...
     * Identifier for the bill payment, unique for the company in the accounting software.
     */
    public AccountingBillPayment withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * An array of bill payment lines.
     */
    public AccountingBillPayment withLines(List<BillPaymentLine> lines) {
        Utils.checkNotNull(lines, "lines");
     ...
     * An array of bill payment lines.
     */
    public AccountingBillPayment withLines(JsonNullable<? extends List<BillPaymentLine>> lines) {
        Utils.checkNotNull(lines, "lines");
        this.lines = lines;
        return this;
    }
    ...
    public AccountingBillPayment withModifiedDate(Optional<String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Additional information associated with the payment.
     */
    public AccountingBillPayment withNote(JsonNullable<String> note) {
        Utils.checkNotNull(note, "note");
        this.note = note;
        return this;
    }
     ...
     * Additional information associated with the payment.
     */
    public AccountingBillPayment withReference(JsonNullable<String> reference) {
        Utils.checkNotNull(reference, "reference");
        this.reference = reference;
        return this;
    }
    ...
    public AccountingBillPayment withSourceModifiedDate(Optional<String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * Amount of the payment in the payment currency. This value never changes and represents the amount of money that is paid into the supplier's account.
     */
    public AccountingBillPayment withTotalAmount(BigDecimal totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
     ...
     * Amount of the payment in the payment currency. This value never changes and represents the amount of money that is paid into the supplier's account.
     */
    public AccountingBillPayment withTotalAmount(Optional<? extends BigDecimal> totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
