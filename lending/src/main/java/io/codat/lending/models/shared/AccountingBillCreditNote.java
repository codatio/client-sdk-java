...
public class AccountingBillCreditNote {
     ...
     * An array of payment allocations.
     */
    public AccountingBillCreditNote withPaymentAllocations(java.util.List<AccountingPaymentAllocation> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
     ...
     * An array of payment allocations.
     */
    public AccountingBillCreditNote withPaymentAllocations(JsonNullable<? extends java.util.List<AccountingPaymentAllocation>> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
        this.paymentAllocations = paymentAllocations;
        return this;
    }
