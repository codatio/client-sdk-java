...
public class TaxRateReference {
     ...
     * Applicable tax rate.
     */
    public TaxRateReference withEffectiveTaxRate(Optional<? extends Double> effectiveTaxRate) {
        Utils.checkNotNull(effectiveTaxRate, "effectiveTaxRate");
        this.effectiveTaxRate = effectiveTaxRate;
        return this;
    }
     ...
     * Unique identifier for the tax rate in the accounting platform.
     */
    public TaxRateReference withId(Optional<? extends String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Name of the tax rate in the accounting platform.
     */
    public TaxRateReference withName(Optional<? extends String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
