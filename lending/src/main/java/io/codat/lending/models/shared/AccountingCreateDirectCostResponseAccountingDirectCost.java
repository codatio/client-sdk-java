...
public class AccountingCreateDirectCostResponseAccountingDirectCost {
    ...
    public AccountingCreateDirectCostResponseAccountingDirectCost withContactRef(ContactRef contactRef) {
        Utils.checkNotNull(contactRef, "contactRef");
        this.contactRef = Optional.ofNullable(contactRef);
        return this;
    }

    public AccountingCreateDirectCostResponseAccountingDirectCost withContactRef(Optional<? extends ContactRef> contactRef) {
        Utils.checkNotNull(contactRef, "contactRef");
        this.contactRef = contactRef;
        return this;
    }
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
     */
    public AccountingCreateDirectCostResponseAccountingDirectCost withCurrencyRate(BigDecimal currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, specify a currencyRate in the request body.  |
     */
    public AccountingCreateDirectCostResponseAccountingDirectCost withCurrencyRate(JsonNullable<? extends BigDecimal> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }
     ...
     * Identifier of the direct cost, unique for the company.
     */
    public AccountingCreateDirectCostResponseAccountingDirectCost withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * An array of line items.
     */
    public AccountingCreateDirectCostResponseAccountingDirectCost withLineItems(List<DirectCostLineItem> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = lineItems;
        return this;
    }
    ...
    public AccountingCreateDirectCostResponseAccountingDirectCost withModifiedDate(Optional<String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * A note attached to the direct cost.
     */
    public AccountingCreateDirectCostResponseAccountingDirectCost withNote(JsonNullable<String> note) {
        Utils.checkNotNull(note, "note");
        this.note = note;
        return this;
    }
     ...
     * An array of payment allocations.
     */
    public AccountingCreateDirectCostResponseAccountingDirectCost withPaymentAllocations(List<AccountingPaymentAllocation> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
        this.paymentAllocations = paymentAllocations;
        return this;
    }
     ...
     * User-friendly reference for the direct cost.
     */
    public AccountingCreateDirectCostResponseAccountingDirectCost withReference(JsonNullable<String> reference) {
        Utils.checkNotNull(reference, "reference");
        this.reference = reference;
        return this;
    }
    ...
    public AccountingCreateDirectCostResponseAccountingDirectCost withSourceModifiedDate(Optional<String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * The total amount of the direct costs, excluding any taxes.
     */
    public AccountingCreateDirectCostResponseAccountingDirectCost withSubTotal(BigDecimal subTotal) {
        Utils.checkNotNull(subTotal, "subTotal");
        this.subTotal = subTotal;
        return this;
    }
     ...
     * The total amount of tax on the direct costs.
     */
    public AccountingCreateDirectCostResponseAccountingDirectCost withTaxAmount(BigDecimal taxAmount) {
        Utils.checkNotNull(taxAmount, "taxAmount");
        this.taxAmount = taxAmount;
        return this;
    }
     ...
     * The amount of the direct costs, inclusive of tax.
     */
    public AccountingCreateDirectCostResponseAccountingDirectCost withTotalAmount(BigDecimal totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
