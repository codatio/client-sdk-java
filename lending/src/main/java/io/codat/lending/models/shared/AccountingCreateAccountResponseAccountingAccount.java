...
public class AccountingCreateAccountResponseAccountingAccount {
    ...
    private JsonNullable<? extends List<AccountingCreateAccountResponseValidDataTypeLinks>> validDatatypeLinks;

    @JsonCreator
    public AccountingCreateAccountResponseAccountingAccount(
            ...
            @JsonProperty("validDatatypeLinks") JsonNullable<? extends List<AccountingCreateAccountResponseValidDataTypeLinks>> validDatatypeLinks) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<List<AccountingCreateAccountResponseValidDataTypeLinks>> validDatatypeLinks() {
        return (JsonNullable<List<AccountingCreateAccountResponseValidDataTypeLinks>>) validDatatypeLinks;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public AccountingCreateAccountResponseAccountingAccount withCurrency(String currency) {
        Utils.checkNotNull(currency, "currency");
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public AccountingCreateAccountResponseAccountingAccount withCurrency(Optional<String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * Current balance in the account.
     */
    public AccountingCreateAccountResponseAccountingAccount withCurrentBalance(BigDecimal currentBalance) {
        Utils.checkNotNull(currentBalance, "currentBalance");
         ...
         * Current balance in the account.
         */
    public AccountingCreateAccountResponseAccountingAccount withCurrentBalance(double currentBalance) {
     ...
     * Current balance in the account.
     */
    public AccountingCreateAccountResponseAccountingAccount withCurrentBalance(JsonNullable<? extends BigDecimal> currentBalance) {
        Utils.checkNotNull(currentBalance, "currentBalance");
        this.currentBalance = currentBalance;
        return this;
    }
     ...
     * Description for the account.
     */
    public AccountingCreateAccountResponseAccountingAccount withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * Description for the account.
     */
    public AccountingCreateAccountResponseAccountingAccount withDescription(JsonNullable<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * For example, `Liability.Current` or `Income.Revenue`. To determine a list of possible categories for each integration, see our examples, follow our [Create, update, delete data](https://docs.codat.io/using-the-api/push) guide, or refer to the integration's own documentation.
     */
    public AccountingCreateAccountResponseAccountingAccount withFullyQualifiedCategory(String fullyQualifiedCategory) {
        Utils.checkNotNull(fullyQualifiedCategory, "fullyQualifiedCategory");
     ...
     * For example, `Liability.Current` or `Income.Revenue`. To determine a list of possible categories for each integration, see our examples, follow our [Create, update, delete data](https://docs.codat.io/using-the-api/push) guide, or refer to the integration's own documentation.
     */
    public AccountingCreateAccountResponseAccountingAccount withFullyQualifiedCategory(JsonNullable<String> fullyQualifiedCategory) {
        Utils.checkNotNull(fullyQualifiedCategory, "fullyQualifiedCategory");
        this.fullyQualifiedCategory = fullyQualifiedCategory;
        return this;
    }
     ...
     * - `Fixed Asset`
     */
    public AccountingCreateAccountResponseAccountingAccount withFullyQualifiedName(String fullyQualifiedName) {
        Utils.checkNotNull(fullyQualifiedName, "fullyQualifiedName");
     ...
     * - `Fixed Asset`
     */
    public AccountingCreateAccountResponseAccountingAccount withFullyQualifiedName(JsonNullable<String> fullyQualifiedName) {
        Utils.checkNotNull(fullyQualifiedName, "fullyQualifiedName");
        this.fullyQualifiedName = fullyQualifiedName;
        return this;
    }
     ...
     * Identifier for the account, unique for the company.
     */
    public AccountingCreateAccountResponseAccountingAccount withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Identifier for the account, unique for the company.
     */
    public AccountingCreateAccountResponseAccountingAccount withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Confirms whether the account is a bank account or not.
     */
    public AccountingCreateAccountResponseAccountingAccount withIsBankAccount(boolean isBankAccount) {
        Utils.checkNotNull(isBankAccount, "isBankAccount");
     ...
     * Confirms whether the account is a bank account or not.
     */
    public AccountingCreateAccountResponseAccountingAccount withIsBankAccount(Optional<Boolean> isBankAccount) {
        Utils.checkNotNull(isBankAccount, "isBankAccount");
        this.isBankAccount = isBankAccount;
        return this;
    }

    public AccountingCreateAccountResponseAccountingAccount withMetadata(Metadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = Optional.ofNullable(metadata);
        return this;
    }

    public AccountingCreateAccountResponseAccountingAccount withMetadata(Optional<? extends Metadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }

    public AccountingCreateAccountResponseAccountingAccount withModifiedDate(String modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = Optional.ofNullable(modifiedDate);
        return this;
    }

    public AccountingCreateAccountResponseAccountingAccount withModifiedDate(Optional<String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Name of the account.
     */
    public AccountingCreateAccountResponseAccountingAccount withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * Name of the account.
     */
    public AccountingCreateAccountResponseAccountingAccount withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * Reference given to each nominal account for a business. It ensures money is allocated to the correct account. This code isn't a unique identifier in the Codat system.
     */
    public AccountingCreateAccountResponseAccountingAccount withNominalCode(String nominalCode) {
        Utils.checkNotNull(nominalCode, "nominalCode");
     ...
     * Reference given to each nominal account for a business. It ensures money is allocated to the correct account. This code isn't a unique identifier in the Codat system.
     */
    public AccountingCreateAccountResponseAccountingAccount withNominalCode(JsonNullable<String> nominalCode) {
        Utils.checkNotNull(nominalCode, "nominalCode");
        this.nominalCode = nominalCode;
        return this;
    }

    public AccountingCreateAccountResponseAccountingAccount withSourceModifiedDate(String sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = Optional.ofNullable(sourceModifiedDate);
        return this;
    }

    public AccountingCreateAccountResponseAccountingAccount withSourceModifiedDate(Optional<String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * Status of the account
     */
    public AccountingCreateAccountResponseAccountingAccount withStatus(AccountStatus status) {
        Utils.checkNotNull(status, "status");
     ...
     * Status of the account
     */
    public AccountingCreateAccountResponseAccountingAccount withStatus(Optional<? extends AccountStatus> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting software. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public AccountingCreateAccountResponseAccountingAccount withSupplementalData(SupplementalData supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting software. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public AccountingCreateAccountResponseAccountingAccount withSupplementalData(Optional<? extends SupplementalData> supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
        this.supplementalData = supplementalData;
        return this;
    }
     ...
     * Type of account
     */
    public AccountingCreateAccountResponseAccountingAccount withType(AccountType type) {
        Utils.checkNotNull(type, "type");
     ...
     * Type of account
     */
    public AccountingCreateAccountResponseAccountingAccount withType(Optional<? extends AccountType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * The validDatatypeLinks can be used to determine whether an account can be correctly mapped to another object; for example, accounts with a `type` of `income` might only support being used on an Invoice and Direct Income. For more information, see [Valid Data Type Links](/lending-api#/schemas/ValidDataTypeLinks).
     */
    public AccountingCreateAccountResponseAccountingAccount withValidDatatypeLinks(List<AccountingCreateAccountResponseValidDataTypeLinks> validDatatypeLinks) {
        Utils.checkNotNull(validDatatypeLinks, "validDatatypeLinks");
     ...
     * The validDatatypeLinks can be used to determine whether an account can be correctly mapped to another object; for example, accounts with a `type` of `income` might only support being used on an Invoice and Direct Income. For more information, see [Valid Data Type Links](/lending-api#/schemas/ValidDataTypeLinks).
     */
    public AccountingCreateAccountResponseAccountingAccount withValidDatatypeLinks(JsonNullable<? extends List<AccountingCreateAccountResponseValidDataTypeLinks>> validDatatypeLinks) {
        Utils.checkNotNull(validDatatypeLinks, "validDatatypeLinks");
        this.validDatatypeLinks = validDatatypeLinks;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountingCreateAccountResponseAccountingAccount other = (AccountingCreateAccountResponseAccountingAccount) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AccountingCreateAccountResponseAccountingAccount.class,
                "currency", currency,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends List<AccountingCreateAccountResponseValidDataTypeLinks>> validDatatypeLinks = JsonNullable.undefined();  
         ...
         * The validDatatypeLinks can be used to determine whether an account can be correctly mapped to another object; for example, accounts with a `type` of `income` might only support being used on an Invoice and Direct Income. For more information, see [Valid Data Type Links](/lending-api#/schemas/ValidDataTypeLinks).
         */
        public Builder validDatatypeLinks(List<AccountingCreateAccountResponseValidDataTypeLinks> validDatatypeLinks) {
            Utils.checkNotNull(validDatatypeLinks, "validDatatypeLinks");
            this.validDatatypeLinks = JsonNullable.of(validDatatypeLinks);
            return this;
        }
         ...
         * The validDatatypeLinks can be used to determine whether an account can be correctly mapped to another object; for example, accounts with a `type` of `income` might only support being used on an Invoice and Direct Income. For more information, see [Valid Data Type Links](/lending-api#/schemas/ValidDataTypeLinks).
         */
        public Builder validDatatypeLinks(JsonNullable<? extends List<AccountingCreateAccountResponseValidDataTypeLinks>> validDatatypeLinks) {
            Utils.checkNotNull(validDatatypeLinks, "validDatatypeLinks");
            this.validDatatypeLinks = validDatatypeLinks;
            return this;
        }
        
        public AccountingCreateAccountResponseAccountingAccount build() {
            return new AccountingCreateAccountResponseAccountingAccount(
                currency,
                currentBalance,
                description,
                fullyQualifiedCategory,
