...
import io.codat.lending.models.operations.ListBankingAccountBalancesRequestBuilder;
...
public class AccountBalances implements
     ...
     */
    public ListBankingAccountBalancesRequestBuilder list() {
        return new ListBankingAccountBalancesRequestBuilder(this);
    }
     ...
     */
    public ListBankingAccountBalancesResponse list(
            ListBankingAccountBalancesRequest request) throws Exception {
    ...
    public ListBankingAccountBalancesResponse list(
        ...
        ListBankingAccountBalancesResponse.Builder _resBuilder = 
        ...
        ListBankingAccountBalancesResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                BankingAccountBalances _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<BankingAccountBalances>() {});
                _res.withBankingAccountBalances(Optional.ofNullable(_out));
                return _res;
            } else {
                throw new SDKError(
                    _httpRes, 
