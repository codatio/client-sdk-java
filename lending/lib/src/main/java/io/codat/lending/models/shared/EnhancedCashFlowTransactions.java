...
public class EnhancedCashFlowTransactions {
    ...
    private Optional<? extends java.util.List<DataSource>> dataSources;
    ...
    private Optional<? extends java.util.List<EnhancedCashFlowItem>> reportItems;

    public EnhancedCashFlowTransactions(
            @JsonProperty("dataSources") Optional<? extends java.util.List<DataSource>> dataSources,
            @JsonProperty("reportInfo") Optional<? extends ReportInfo> reportInfo,
            @JsonProperty("reportItems") Optional<? extends java.util.List<EnhancedCashFlowItem>> reportItems) {
    ...
    public Optional<? extends java.util.List<DataSource>> dataSources() {
        return dataSources;
    }
    ...
    public Optional<? extends java.util.List<EnhancedCashFlowItem>> reportItems() {
        return reportItems;
    }
    ...
    public EnhancedCashFlowTransactions withDataSources(java.util.List<DataSource> dataSources) {
        Utils.checkNotNull(dataSources, "dataSources");
        this.dataSources = Optional.ofNullable(dataSources);
        return this;
    }
    
    public EnhancedCashFlowTransactions withDataSources(Optional<? extends java.util.List<DataSource>> dataSources) {
        Utils.checkNotNull(dataSources, "dataSources");
        this.dataSources = dataSources;
        return this;
    }
    ...
    public EnhancedCashFlowTransactions withReportItems(java.util.List<EnhancedCashFlowItem> reportItems) {
        Utils.checkNotNull(reportItems, "reportItems");
        this.reportItems = Optional.ofNullable(reportItems);
        return this;
    }
    
    public EnhancedCashFlowTransactions withReportItems(Optional<? extends java.util.List<EnhancedCashFlowItem>> reportItems) {
        Utils.checkNotNull(reportItems, "reportItems");
        this.reportItems = reportItems;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            java.util.Objects.deepEquals(this.dataSources, other.dataSources) &&
    ...
    public final static class Builder {
        ...
        private Optional<? extends java.util.List<DataSource>> dataSources = Optional.empty();
 
        private Optional<? extends ReportInfo> reportInfo = Optional.empty();
 
        private Optional<? extends java.util.List<EnhancedCashFlowItem>> reportItems = Optional.empty();  
        ...
        public Builder dataSources(Optional<? extends java.util.List<DataSource>> dataSources) {
            Utils.checkNotNull(dataSources, "dataSources");
            this.dataSources = dataSources;
            return this;
        }
        ...
        public Builder reportItems(java.util.List<EnhancedCashFlowItem> reportItems) {
            Utils.checkNotNull(reportItems, "reportItems");
            this.reportItems = Optional.ofNullable(reportItems);
            return this;
        }
        
        public Builder reportItems(Optional<? extends java.util.List<EnhancedCashFlowItem>> reportItems) {
            Utils.checkNotNull(reportItems, "reportItems");
            this.reportItems = reportItems;
            return this;
        }        
