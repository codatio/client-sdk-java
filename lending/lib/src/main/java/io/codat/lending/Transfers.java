...
public class Transfers implements
    ...
    public io.codat.lending.models.operations.CreateTransferRequestBuilder create() {
     ...
     */
    public io.codat.lending.models.operations.CreateTransferResponse create(
     ...
     * @throws Exception if the API call fails
     */
    public io.codat.lending.models.operations.GetCreateTransfersModelResponse getCreateModel(
