...
public class AccountingCreatePaymentResponseAccountingPayment {
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public AccountingCreatePaymentResponseAccountingPayment withCurrency(Optional<? extends String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, include the required currency rate in the expense transaction.  |
     */
    public AccountingCreatePaymentResponseAccountingPayment withCurrencyRate(JsonNullable<? extends Double> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }
     ...
     * Identifier for the payment, unique to the company in the accounting platform.
     */
    public AccountingCreatePaymentResponseAccountingPayment withId(Optional<? extends String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * An array of payment lines.
     */
    public AccountingCreatePaymentResponseAccountingPayment withLines(java.util.List<PaymentLine> lines) {
        Utils.checkNotNull(lines, "lines");
     ...
     * An array of payment lines.
     */
    public AccountingCreatePaymentResponseAccountingPayment withLines(JsonNullable<? extends java.util.List<PaymentLine>> lines) {
        Utils.checkNotNull(lines, "lines");
        this.lines = lines;
        return this;
    }
    ...
    public AccountingCreatePaymentResponseAccountingPayment withModifiedDate(Optional<? extends String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Any additional information associated with the payment.
     */
    public AccountingCreatePaymentResponseAccountingPayment withNote(JsonNullable<? extends String> note) {
        Utils.checkNotNull(note, "note");
        this.note = note;
        return this;
    }
     ...
     * Friendly reference for the payment.
     */
    public AccountingCreatePaymentResponseAccountingPayment withReference(JsonNullable<? extends String> reference) {
        Utils.checkNotNull(reference, "reference");
        this.reference = reference;
        return this;
    }
    ...
    public AccountingCreatePaymentResponseAccountingPayment withSourceModifiedDate(Optional<? extends String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * Amount of the payment in the payment currency. This value should never change and represents the amount of money paid into the customer's account.
     */
    public AccountingCreatePaymentResponseAccountingPayment withTotalAmount(Optional<? extends Double> totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
