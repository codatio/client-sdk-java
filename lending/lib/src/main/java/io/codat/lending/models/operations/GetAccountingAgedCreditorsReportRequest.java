...
public class GetAccountingAgedCreditorsReportRequest {
     ...
     * Number of periods to include in the report.
     */
    public GetAccountingAgedCreditorsReportRequest withNumberOfPeriods(Optional<? extends Integer> numberOfPeriods) {
        Utils.checkNotNull(numberOfPeriods, "numberOfPeriods");
        this.numberOfPeriods = numberOfPeriods;
        return this;
    }
     ...
     * The length of period in days.
     */
    public GetAccountingAgedCreditorsReportRequest withPeriodLengthDays(Optional<? extends Integer> periodLengthDays) {
        Utils.checkNotNull(periodLengthDays, "periodLengthDays");
        this.periodLengthDays = periodLengthDays;
        return this;
    }
     ...
     * Date the report is generated up to.
     */
    public GetAccountingAgedCreditorsReportRequest withReportDate(Optional<? extends LocalDate> reportDate) {
        Utils.checkNotNull(reportDate, "reportDate");
        this.reportDate = reportDate;
        return this;
    }
