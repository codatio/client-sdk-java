...
public class UnlinkConnectionResponse {
     ...
     * OK
     */
    private Optional<? extends io.codat.lending.models.shared.Connection> connection;
    ...
    public UnlinkConnectionResponse(
            Optional<? extends io.codat.lending.models.shared.Connection> connection,
            String contentType,
     ...
     * OK
     */
    public Optional<? extends io.codat.lending.models.shared.Connection> connection() {
        return connection;
    }
     ...
     * OK
     */
    public UnlinkConnectionResponse withConnection(io.codat.lending.models.shared.Connection connection) {
        Utils.checkNotNull(connection, "connection");
     ...
     * OK
     */
    public UnlinkConnectionResponse withConnection(Optional<? extends io.codat.lending.models.shared.Connection> connection) {
        Utils.checkNotNull(connection, "connection");
        this.connection = connection;
        return this;
    }
     ...
     * Your API request was not properly authorized.
     */
    public UnlinkConnectionResponse withErrorMessage(io.codat.lending.models.shared.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public UnlinkConnectionResponse withErrorMessage(Optional<? extends io.codat.lending.models.shared.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends io.codat.lending.models.shared.Connection> connection = Optional.empty();
         ...
         * OK
         */
        public Builder connection(io.codat.lending.models.shared.Connection connection) {
            Utils.checkNotNull(connection, "connection");
            this.connection = Optional.ofNullable(connection);
            return this;
        }
         ...
         * OK
         */
        public Builder connection(Optional<? extends io.codat.lending.models.shared.Connection> connection) {
            Utils.checkNotNull(connection, "connection");
            this.connection = connection;
            return this;
        }
