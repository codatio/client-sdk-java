...
public class FileUpload implements
    ...
    public io.codat.lending.models.operations.DownloadFilesRequestBuilder downloadFiles() {
     ...
     */
    public io.codat.lending.models.operations.DownloadFilesResponse downloadFiles(
    ...
    public io.codat.lending.models.operations.ListFilesRequestBuilder listFiles() {
     ...
     * @throws Exception if the API call fails
     */
    public io.codat.lending.models.operations.ListFilesResponse listFiles(
    ...
    public io.codat.lending.models.operations.UploadFilesRequestBuilder uploadFiles() {
     ...
     * @throws Exception if the API call fails
     */
    public io.codat.lending.models.operations.UploadFilesResponse uploadFiles(
