...
public class GetAccountingProfitAndLossRequest {
    ...
    public GetAccountingProfitAndLossRequest(
            String companyId,
            int periodLength,
     ...
     * Unique identifier for a company.
     */
    public GetAccountingProfitAndLossRequest withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * Number of months defining the period of interest.
     */
    public GetAccountingProfitAndLossRequest withPeriodLength(int periodLength) {
        Utils.checkNotNull(periodLength, "periodLength");
        this.periodLength = periodLength;
        return this;
    }
     ...
     * Number of periods with `periodLength` to compare.
     */
    public GetAccountingProfitAndLossRequest withPeriodsToCompare(int periodsToCompare) {
        Utils.checkNotNull(periodsToCompare, "periodsToCompare");
        this.periodsToCompare = periodsToCompare;
        return this;
    }
     ...
     * The month the report starts from.
     */
    public GetAccountingProfitAndLossRequest withStartMonth(String startMonth) {
        Utils.checkNotNull(startMonth, "startMonth");
     ...
     * The month the report starts from.
     */
    public GetAccountingProfitAndLossRequest withStartMonth(Optional<? extends String> startMonth) {
        Utils.checkNotNull(startMonth, "startMonth");
        this.startMonth = startMonth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetAccountingProfitAndLossRequest other = (GetAccountingProfitAndLossRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetAccountingProfitAndLossRequest.class,
                "companyId", companyId,
    ...
    public final static class Builder {
        ...
        public GetAccountingProfitAndLossRequest build() {
            return new GetAccountingProfitAndLossRequest(
                companyId,
                periodLength,
                periodsToCompare,
                startMonth);
