...
public class ListFilesResponse {
     ...
     * Success
     */
    private Optional<? extends java.util.List<io.codat.lending.models.shared.File>> files;
    ...
    public ListFilesResponse(
            ...
            Optional<? extends java.util.List<io.codat.lending.models.shared.File>> files,
            int statusCode,
     ...
     * Success
     */
    public Optional<? extends java.util.List<io.codat.lending.models.shared.File>> files() {
        return files;
    }
     ...
     * Your API request was not properly authorized.
     */
    public ListFilesResponse withErrorMessage(io.codat.lending.models.shared.ErrorMessage errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
     ...
     * Your API request was not properly authorized.
     */
    public ListFilesResponse withErrorMessage(Optional<? extends io.codat.lending.models.shared.ErrorMessage> errorMessage) {
        Utils.checkNotNull(errorMessage, "errorMessage");
        this.errorMessage = errorMessage;
        return this;
    }
     ...
     * Success
     */
    public ListFilesResponse withFiles(java.util.List<io.codat.lending.models.shared.File> files) {
        Utils.checkNotNull(files, "files");
     ...
     * Success
     */
    public ListFilesResponse withFiles(Optional<? extends java.util.List<io.codat.lending.models.shared.File>> files) {
        Utils.checkNotNull(files, "files");
        this.files = files;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends java.util.List<io.codat.lending.models.shared.File>> files = Optional.empty();
         ...
         * Success
         */
        public Builder files(java.util.List<io.codat.lending.models.shared.File> files) {
            Utils.checkNotNull(files, "files");
            this.files = Optional.ofNullable(files);
            return this;
        }
         ...
         * Success
         */
        public Builder files(Optional<? extends java.util.List<io.codat.lending.models.shared.File>> files) {
            Utils.checkNotNull(files, "files");
            this.files = files;
            return this;
        }
