...
public class AccountingInvoice {
    ...
    private JsonNullable<? extends java.util.List<SalesOrderReference>> salesOrderRefs;
    ...
    public AccountingInvoice(
            ...
            @JsonProperty("salesOrderRefs") JsonNullable<? extends java.util.List<SalesOrderReference>> salesOrderRefs,
     ...
     * List of references to related Sales orders.
     */
    public JsonNullable<? extends java.util.List<SalesOrderReference>> salesOrderRefs() {
     ...
     * Additional tax amount applied to invoice.
     */
    public AccountingInvoice withAdditionalTaxAmount(Optional<? extends Double> additionalTaxAmount) {
        Utils.checkNotNull(additionalTaxAmount, "additionalTaxAmount");
        this.additionalTaxAmount = additionalTaxAmount;
        return this;
    }
     ...
     * Percentage rate of any additional tax applied to the invoice.
     */
    public AccountingInvoice withAdditionalTaxPercentage(Optional<? extends Double> additionalTaxPercentage) {
        Utils.checkNotNull(additionalTaxPercentage, "additionalTaxPercentage");
        this.additionalTaxPercentage = additionalTaxPercentage;
        return this;
    }
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public AccountingInvoice withCurrency(Optional<? extends String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * | QuickBooks Online | Transaction currency differs from base currency | If currency rate value is left `null`, a rate of 1 will be used by QBO by default. To override this, include the required currency rate in the expense transaction.  |
     */
    public AccountingInvoice withCurrencyRate(JsonNullable<? extends Double> currencyRate) {
        Utils.checkNotNull(currencyRate, "currencyRate");
        this.currencyRate = currencyRate;
        return this;
    }
     ...
     * Percentage rate (from 0 to 100) of discounts applied to the invoice. For example: A 5% discount will return a value of `5`, not `0.05`.
     */
    public AccountingInvoice withDiscountPercentage(JsonNullable<? extends Double> discountPercentage) {
        Utils.checkNotNull(discountPercentage, "discountPercentage");
        this.discountPercentage = discountPercentage;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public AccountingInvoice withDueDate(Optional<? extends String> dueDate) {
        Utils.checkNotNull(dueDate, "dueDate");
        this.dueDate = dueDate;
        return this;
    }
     ...
     * Identifier for the invoice, unique to the company in the accounting platform.
     */
    public AccountingInvoice withId(Optional<? extends String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Friendly reference for the invoice. If available, this appears in the file name of invoice attachments.
     */
    public AccountingInvoice withInvoiceNumber(JsonNullable<? extends String> invoiceNumber) {
        Utils.checkNotNull(invoiceNumber, "invoiceNumber");
        this.invoiceNumber = invoiceNumber;
        return this;
    }
     ...
     * An array of line items.
     */
    public AccountingInvoice withLineItems(java.util.List<InvoiceLineItem> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
     ...
     * An array of line items.
     */
    public AccountingInvoice withLineItems(JsonNullable<? extends java.util.List<InvoiceLineItem>> lineItems) {
        Utils.checkNotNull(lineItems, "lineItems");
        this.lineItems = lineItems;
        return this;
    }
    ...
    public AccountingInvoice withModifiedDate(Optional<? extends String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Any additional information about the invoice. Where possible, Codat links to a data field in the accounting platform that is publicly available. This means that the contents of the note field are included when an invoice is emailed from the accounting platform to the customer.
     */
    public AccountingInvoice withNote(JsonNullable<? extends String> note) {
        Utils.checkNotNull(note, "note");
        this.note = note;
        return this;
    }
     ...
     * &gt; Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
     */
    public AccountingInvoice withPaidOnDate(Optional<? extends String> paidOnDate) {
        Utils.checkNotNull(paidOnDate, "paidOnDate");
        this.paidOnDate = paidOnDate;
        return this;
    }
     ...
     * An array of payment allocations.
     */
    public AccountingInvoice withPaymentAllocations(java.util.List<AccountingPaymentAllocation> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
     ...
     * An array of payment allocations.
     */
    public AccountingInvoice withPaymentAllocations(JsonNullable<? extends java.util.List<AccountingPaymentAllocation>> paymentAllocations) {
        Utils.checkNotNull(paymentAllocations, "paymentAllocations");
        this.paymentAllocations = paymentAllocations;
        return this;
    }
     ...
     * List of references to related Sales orders.
     */
    public AccountingInvoice withSalesOrderRefs(java.util.List<SalesOrderReference> salesOrderRefs) {
        Utils.checkNotNull(salesOrderRefs, "salesOrderRefs");
     ...
     * List of references to related Sales orders.
     */
    public AccountingInvoice withSalesOrderRefs(JsonNullable<? extends java.util.List<SalesOrderReference>> salesOrderRefs) {
        Utils.checkNotNull(salesOrderRefs, "salesOrderRefs");
        this.salesOrderRefs = salesOrderRefs;
        return this;
    }
    ...
    public AccountingInvoice withSourceModifiedDate(Optional<? extends String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * Total amount of the invoice excluding any taxes.
     */
    public AccountingInvoice withSubTotal(JsonNullable<? extends Double> subTotal) {
        Utils.checkNotNull(subTotal, "subTotal");
        this.subTotal = subTotal;
        return this;
    }
     ...
     * Numerical value of discounts applied to the invoice.
     */
    public AccountingInvoice withTotalDiscount(JsonNullable<? extends Double> totalDiscount) {
        Utils.checkNotNull(totalDiscount, "totalDiscount");
        this.totalDiscount = totalDiscount;
        return this;
    }
    ...
    public AccountingInvoice withWithholdingTax(java.util.List<WithholdingTaxItems> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = JsonNullable.of(withholdingTax);
        return this;
    }

    public AccountingInvoice withWithholdingTax(JsonNullable<? extends java.util.List<WithholdingTaxItems>> withholdingTax) {
        Utils.checkNotNull(withholdingTax, "withholdingTax");
        this.withholdingTax = withholdingTax;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends java.util.List<SalesOrderReference>> salesOrderRefs = JsonNullable.undefined();
         ...
         * List of references to related Sales orders.
         */
        public Builder salesOrderRefs(java.util.List<SalesOrderReference> salesOrderRefs) {
            Utils.checkNotNull(salesOrderRefs, "salesOrderRefs");
            this.salesOrderRefs = JsonNullable.of(salesOrderRefs);
            return this;
        }
         ...
         * List of references to related Sales orders.
         */
        public Builder salesOrderRefs(JsonNullable<? extends java.util.List<SalesOrderReference>> salesOrderRefs) {
            Utils.checkNotNull(salesOrderRefs, "salesOrderRefs");
            this.salesOrderRefs = salesOrderRefs;
            return this;
        }
