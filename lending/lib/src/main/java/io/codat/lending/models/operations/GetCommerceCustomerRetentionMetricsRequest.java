...
public class GetCommerceCustomerRetentionMetricsRequest {
     ...
     * Shows the dimensionDisplayName and itemDisplayName in measures to make the report data human-readable.
     */
    public GetCommerceCustomerRetentionMetricsRequest withIncludeDisplayNames(Optional<? extends Boolean> includeDisplayNames) {
        Utils.checkNotNull(includeDisplayNames, "includeDisplayNames");
        this.includeDisplayNames = includeDisplayNames;
        return this;
    }
     ...
     * The period unit of time returned.
     */
    public GetCommerceCustomerRetentionMetricsRequest withPeriodUnit(io.codat.lending.models.shared.PeriodUnit periodUnit) {
        Utils.checkNotNull(periodUnit, "periodUnit");
        this.periodUnit = periodUnit;
        return this;
    }
