...
public class PaymentMethods implements
    ...
    public io.codat.lending.models.operations.GetCommercePaymentMethodRequestBuilder get() {
     ...
     */
    public io.codat.lending.models.operations.GetCommercePaymentMethodResponse get(
    ...
    public io.codat.lending.models.operations.ListCommercePaymentMethodsRequestBuilder list() {
     ...
     * @throws Exception if the API call fails
     */
    public io.codat.lending.models.operations.ListCommercePaymentMethodsResponse list(
