...
public class DirectIncomeLineItem {
     ...
     * A user-friendly name of the goods or services.
     */
    public DirectIncomeLineItem withDescription(JsonNullable<? extends String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * Discount amount for the line before tax.
     */
    public DirectIncomeLineItem withDiscountAmount(JsonNullable<? extends Double> discountAmount) {
        Utils.checkNotNull(discountAmount, "discountAmount");
        this.discountAmount = discountAmount;
        return this;
    }
     ...
     * Discount percentage for the line before tax.
     */
    public DirectIncomeLineItem withDiscountPercentage(JsonNullable<? extends Double> discountPercentage) {
        Utils.checkNotNull(discountPercentage, "discountPercentage");
        this.discountPercentage = discountPercentage;
        return this;
    }
     ...
     * The amount of the line, inclusive of discounts, but exclusive of tax.
     */
    public DirectIncomeLineItem withSubTotal(JsonNullable<? extends Double> subTotal) {
        Utils.checkNotNull(subTotal, "subTotal");
        this.subTotal = subTotal;
        return this;
    }
     ...
     * Note: If the platform does not provide this information, the quantity will be mapped as 0.00.
     */
    public DirectIncomeLineItem withTaxAmount(JsonNullable<? extends Double> taxAmount) {
        Utils.checkNotNull(taxAmount, "taxAmount");
        this.taxAmount = taxAmount;
        return this;
    }
     ...
     * The total amount of the line, including tax.
     */
    public DirectIncomeLineItem withTotalAmount(JsonNullable<? extends Double> totalAmount) {
        Utils.checkNotNull(totalAmount, "totalAmount");
        this.totalAmount = totalAmount;
        return this;
    }
     ...
     * An array of categories against which this direct cost is tracked.
     */
    public DirectIncomeLineItem withTrackingCategoryRefs(java.util.List<TrackingCategoryRef> trackingCategoryRefs) {
        Utils.checkNotNull(trackingCategoryRefs, "trackingCategoryRefs");
     ...
     * An array of categories against which this direct cost is tracked.
     */
    public DirectIncomeLineItem withTrackingCategoryRefs(JsonNullable<? extends java.util.List<TrackingCategoryRef>> trackingCategoryRefs) {
        Utils.checkNotNull(trackingCategoryRefs, "trackingCategoryRefs");
        this.trackingCategoryRefs = trackingCategoryRefs;
        return this;
    }
