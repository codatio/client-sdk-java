...
public class AccountingCreateAccountResponseAccountingAccount {
    ...
    private JsonNullable<? extends java.util.List<AccountingCreateAccountResponseValidDataTypeLinks>> validDatatypeLinks;
    ...
    public AccountingCreateAccountResponseAccountingAccount(
            ...
            @JsonProperty("validDatatypeLinks") JsonNullable<? extends java.util.List<AccountingCreateAccountResponseValidDataTypeLinks>> validDatatypeLinks) {
     ...
     * The validDatatypeLinks can be used to determine whether an account can be correctly mapped to another object; for example, accounts with a `type` of `income` might only support being used on an Invoice and Direct Income. For more information, see [Valid Data Type Links](/lending-api#/schemas/ValidDataTypeLinks).
     */
    public JsonNullable<? extends java.util.List<AccountingCreateAccountResponseValidDataTypeLinks>> validDatatypeLinks() {
     ...
     * There are only a very small number of edge cases where this currency code is returned by the Codat system.
     */
    public AccountingCreateAccountResponseAccountingAccount withCurrency(Optional<? extends String> currency) {
        Utils.checkNotNull(currency, "currency");
        this.currency = currency;
        return this;
    }
     ...
     * Current balance in the account.
     */
    public AccountingCreateAccountResponseAccountingAccount withCurrentBalance(JsonNullable<? extends Double> currentBalance) {
        Utils.checkNotNull(currentBalance, "currentBalance");
        this.currentBalance = currentBalance;
        return this;
    }
     ...
     * Description for the account.
     */
    public AccountingCreateAccountResponseAccountingAccount withDescription(JsonNullable<? extends String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * For example, `Liability.Current` or `Income.Revenue`. To determine a list of possible categories for each integration, see our examples, follow our [Create, update, delete data](https://docs.codat.io/using-the-api/push) guide, or refer to the integration's own documentation.
     */
    public AccountingCreateAccountResponseAccountingAccount withFullyQualifiedCategory(JsonNullable<? extends String> fullyQualifiedCategory) {
        Utils.checkNotNull(fullyQualifiedCategory, "fullyQualifiedCategory");
        this.fullyQualifiedCategory = fullyQualifiedCategory;
        return this;
    }
     ...
     * - `Fixed Asset`
     */
    public AccountingCreateAccountResponseAccountingAccount withFullyQualifiedName(JsonNullable<? extends String> fullyQualifiedName) {
        Utils.checkNotNull(fullyQualifiedName, "fullyQualifiedName");
        this.fullyQualifiedName = fullyQualifiedName;
        return this;
    }
     ...
     * Identifier for the account, unique for the company.
     */
    public AccountingCreateAccountResponseAccountingAccount withId(Optional<? extends String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Confirms whether the account is a bank account or not.
     */
    public AccountingCreateAccountResponseAccountingAccount withIsBankAccount(Optional<? extends Boolean> isBankAccount) {
        Utils.checkNotNull(isBankAccount, "isBankAccount");
        this.isBankAccount = isBankAccount;
        return this;
    }
    ...
    public AccountingCreateAccountResponseAccountingAccount withModifiedDate(Optional<? extends String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Name of the account.
     */
    public AccountingCreateAccountResponseAccountingAccount withName(JsonNullable<? extends String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * Reference given to each nominal account for a business. It ensures money is allocated to the correct account. This code isn't a unique identifier in the Codat system.
     */
    public AccountingCreateAccountResponseAccountingAccount withNominalCode(JsonNullable<? extends String> nominalCode) {
        Utils.checkNotNull(nominalCode, "nominalCode");
        this.nominalCode = nominalCode;
        return this;
    }
    ...
    public AccountingCreateAccountResponseAccountingAccount withSourceModifiedDate(Optional<? extends String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * The validDatatypeLinks can be used to determine whether an account can be correctly mapped to another object; for example, accounts with a `type` of `income` might only support being used on an Invoice and Direct Income. For more information, see [Valid Data Type Links](/lending-api#/schemas/ValidDataTypeLinks).
     */
    public AccountingCreateAccountResponseAccountingAccount withValidDatatypeLinks(java.util.List<AccountingCreateAccountResponseValidDataTypeLinks> validDatatypeLinks) {
        Utils.checkNotNull(validDatatypeLinks, "validDatatypeLinks");
     ...
     * The validDatatypeLinks can be used to determine whether an account can be correctly mapped to another object; for example, accounts with a `type` of `income` might only support being used on an Invoice and Direct Income. For more information, see [Valid Data Type Links](/lending-api#/schemas/ValidDataTypeLinks).
     */
    public AccountingCreateAccountResponseAccountingAccount withValidDatatypeLinks(JsonNullable<? extends java.util.List<AccountingCreateAccountResponseValidDataTypeLinks>> validDatatypeLinks) {
        Utils.checkNotNull(validDatatypeLinks, "validDatatypeLinks");
        this.validDatatypeLinks = validDatatypeLinks;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends java.util.List<AccountingCreateAccountResponseValidDataTypeLinks>> validDatatypeLinks = JsonNullable.undefined();  
         ...
         * The validDatatypeLinks can be used to determine whether an account can be correctly mapped to another object; for example, accounts with a `type` of `income` might only support being used on an Invoice and Direct Income. For more information, see [Valid Data Type Links](/lending-api#/schemas/ValidDataTypeLinks).
         */
        public Builder validDatatypeLinks(java.util.List<AccountingCreateAccountResponseValidDataTypeLinks> validDatatypeLinks) {
            Utils.checkNotNull(validDatatypeLinks, "validDatatypeLinks");
            this.validDatatypeLinks = JsonNullable.of(validDatatypeLinks);
            return this;
        }
         ...
         * The validDatatypeLinks can be used to determine whether an account can be correctly mapped to another object; for example, accounts with a `type` of `income` might only support being used on an Invoice and Direct Income. For more information, see [Valid Data Type Links](/lending-api#/schemas/ValidDataTypeLinks).
         */
        public Builder validDatatypeLinks(JsonNullable<? extends java.util.List<AccountingCreateAccountResponseValidDataTypeLinks>> validDatatypeLinks) {
            Utils.checkNotNull(validDatatypeLinks, "validDatatypeLinks");
            this.validDatatypeLinks = validDatatypeLinks;
            return this;
        }        
