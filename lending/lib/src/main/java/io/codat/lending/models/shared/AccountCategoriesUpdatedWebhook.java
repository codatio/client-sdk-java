...
public class AccountCategoriesUpdatedWebhook {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("Data")
    private Optional<? extends AccountCategoriesUpdatedWebhookData> data;
    ...
    public AccountCategoriesUpdatedWebhook(
            ...
            @JsonProperty("Data") Optional<? extends AccountCategoriesUpdatedWebhookData> data,
    ...
    public Optional<? extends AccountCategoriesUpdatedWebhookData> data() {
        return data;
    }
     ...
     * Unique identifier of the webhook event.
     */
    public AccountCategoriesUpdatedWebhook withAlertId(Optional<? extends String> alertId) {
        Utils.checkNotNull(alertId, "alertId");
        this.alertId = alertId;
        return this;
    }
     ...
     * Unique identifier for your client in Codat.
     */
    public AccountCategoriesUpdatedWebhook withClientId(Optional<? extends String> clientId) {
        Utils.checkNotNull(clientId, "clientId");
        this.clientId = clientId;
        return this;
    }
     ...
     * Name of your client in Codat.
     */
    public AccountCategoriesUpdatedWebhook withClientName(Optional<? extends String> clientName) {
        Utils.checkNotNull(clientName, "clientName");
        this.clientName = clientName;
        return this;
    }
     ...
     * Unique identifier for your SMB in Codat.
     */
    public AccountCategoriesUpdatedWebhook withCompanyId(Optional<? extends String> companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
    ...
    public AccountCategoriesUpdatedWebhook withData(Optional<? extends AccountCategoriesUpdatedWebhookData> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Unique identifier for a company's data connection.
     */
    public AccountCategoriesUpdatedWebhook withDataConnectionId(Optional<? extends String> dataConnectionId) {
        Utils.checkNotNull(dataConnectionId, "dataConnectionId");
        this.dataConnectionId = dataConnectionId;
        return this;
    }
     ...
     * A human readable message about the webhook.
     */
    public AccountCategoriesUpdatedWebhook withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * Unique identifier for the rule.
     */
    public AccountCategoriesUpdatedWebhook withRuleId(Optional<? extends String> ruleId) {
        Utils.checkNotNull(ruleId, "ruleId");
        this.ruleId = ruleId;
        return this;
    }
     ...
     * The type of rule.
     */
    public AccountCategoriesUpdatedWebhook withRuleType(Optional<? extends String> ruleType) {
        Utils.checkNotNull(ruleType, "ruleType");
        this.ruleType = ruleType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountCategoriesUpdatedWebhook other = (AccountCategoriesUpdatedWebhook) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AccountCategoriesUpdatedWebhook.class,
                "alertId", alertId,
                "clientId", clientId,
    ...
    public final static class Builder {
        ...
        private Optional<? extends AccountCategoriesUpdatedWebhookData> data = Optional.empty();
        ...
        public Builder data(AccountCategoriesUpdatedWebhookData data) {
            Utils.checkNotNull(data, "data");
            this.data = Optional.ofNullable(data);
            return this;
        }
        
        public Builder data(Optional<? extends AccountCategoriesUpdatedWebhookData> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public AccountCategoriesUpdatedWebhook build() {
            return new AccountCategoriesUpdatedWebhook(
                alertId,
                clientId,
                clientName,
                companyId,
