...
public class RecordLineReference {
    ...
    private Optional<? extends BillLineItemDataType> dataType;
    ...
    public RecordLineReference(
            @JsonProperty("dataType") Optional<? extends BillLineItemDataType> dataType,
     ...
     * Allowed name of the 'dataType'.
     */
    public Optional<? extends BillLineItemDataType> dataType() {
        return dataType;
    }
     ...
     * Allowed name of the 'dataType'.
     */
    public RecordLineReference withDataType(BillLineItemDataType dataType) {
        Utils.checkNotNull(dataType, "dataType");
     ...
     * Allowed name of the 'dataType'.
     */
    public RecordLineReference withDataType(Optional<? extends BillLineItemDataType> dataType) {
        Utils.checkNotNull(dataType, "dataType");
        this.dataType = dataType;
        return this;
    }
     ...
     * 'id' of the underlying record.
     */
    public RecordLineReference withId(Optional<? extends String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Line number of the underlying record.
     */
    public RecordLineReference withLineNumber(Optional<? extends String> lineNumber) {
        Utils.checkNotNull(lineNumber, "lineNumber");
        this.lineNumber = lineNumber;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends BillLineItemDataType> dataType = Optional.empty();
         ...
         * Allowed name of the 'dataType'.
         */
        public Builder dataType(BillLineItemDataType dataType) {
            Utils.checkNotNull(dataType, "dataType");
            this.dataType = Optional.ofNullable(dataType);
            return this;
        }
         ...
         * Allowed name of the 'dataType'.
         */
        public Builder dataType(Optional<? extends BillLineItemDataType> dataType) {
            Utils.checkNotNull(dataType, "dataType");
            this.dataType = dataType;
            return this;
        }
