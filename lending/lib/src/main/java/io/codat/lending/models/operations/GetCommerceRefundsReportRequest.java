...
public class GetCommerceRefundsReportRequest {
    ...
    public GetCommerceRefundsReportRequest(
            String companyId,
            String connectionId,
     ...
     * Unique identifier for a company.
     */
    public GetCommerceRefundsReportRequest withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * Unique identifier for a connection.
     */
    public GetCommerceRefundsReportRequest withConnectionId(String connectionId) {
        Utils.checkNotNull(connectionId, "connectionId");
        this.connectionId = connectionId;
        return this;
    }
     ...
     * Shows the dimensionDisplayName and itemDisplayName in measures to make the report data human-readable.
     */
    public GetCommerceRefundsReportRequest withIncludeDisplayNames(boolean includeDisplayNames) {
        Utils.checkNotNull(includeDisplayNames, "includeDisplayNames");
     ...
     * Shows the dimensionDisplayName and itemDisplayName in measures to make the report data human-readable.
     */
    public GetCommerceRefundsReportRequest withIncludeDisplayNames(Optional<? extends Boolean> includeDisplayNames) {
        Utils.checkNotNull(includeDisplayNames, "includeDisplayNames");
        this.includeDisplayNames = includeDisplayNames;
        return this;
    }
     ...
     * The number of periods to return. There will be no pagination as a query parameter.
     */
    public GetCommerceRefundsReportRequest withNumberOfPeriods(long numberOfPeriods) {
        Utils.checkNotNull(numberOfPeriods, "numberOfPeriods");
        this.numberOfPeriods = numberOfPeriods;
        return this;
    }
     ...
     * The number of months per period. E.g. 2 = 2 months per period.
     */
    public GetCommerceRefundsReportRequest withPeriodLength(long periodLength) {
        Utils.checkNotNull(periodLength, "periodLength");
        this.periodLength = periodLength;
        return this;
    }
     ...
     * The period unit of time returned.
     */
    public GetCommerceRefundsReportRequest withPeriodUnit(io.codat.lending.models.shared.PeriodUnit periodUnit) {
        Utils.checkNotNull(periodUnit, "periodUnit");
        this.periodUnit = periodUnit;
        return this;
    }
     ...
     * The date in which the report is created up to. Users must specify a specific date, however the response will be provided for the full month.
     */
    public GetCommerceRefundsReportRequest withReportDate(String reportDate) {
        Utils.checkNotNull(reportDate, "reportDate");
        this.reportDate = reportDate;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCommerceRefundsReportRequest other = (GetCommerceRefundsReportRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCommerceRefundsReportRequest.class,
                "companyId", companyId,
    ...
    public final static class Builder {
        ...
        public GetCommerceRefundsReportRequest build() {
            return new GetCommerceRefundsReportRequest(
                companyId,
                connectionId,
                includeDisplayNames,
                numberOfPeriods,
