...
public class Orders implements
    ...
    public io.codat.lending.models.operations.GetCommerceOrderRequestBuilder get() {
     ...
     */
    public io.codat.lending.models.operations.GetCommerceOrderResponse get(
    ...
    public io.codat.lending.models.operations.ListCommerceOrdersRequestBuilder list() {
     ...
     * @throws Exception if the API call fails
     */
    public io.codat.lending.models.operations.ListCommerceOrdersResponse list(
