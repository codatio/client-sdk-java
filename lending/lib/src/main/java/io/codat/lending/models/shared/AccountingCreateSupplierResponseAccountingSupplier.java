...
public class AccountingCreateSupplierResponseAccountingSupplier {
    ...
    public AccountingCreateSupplierResponseAccountingSupplier(
     ...
     * An array of Addresses.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withAddresses(java.util.List<AccountingAddress> addresses) {
        Utils.checkNotNull(addresses, "addresses");
     ...
     * An array of Addresses.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withAddresses(JsonNullable<? extends java.util.List<AccountingAddress>> addresses) {
        Utils.checkNotNull(addresses, "addresses");
        this.addresses = addresses;
        return this;
    }
     ...
     * Name of the main contact for the supplier.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withContactName(String contactName) {
        Utils.checkNotNull(contactName, "contactName");
     ...
     * Name of the main contact for the supplier.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withContactName(JsonNullable<? extends String> contactName) {
        Utils.checkNotNull(contactName, "contactName");
        this.contactName = contactName;
        return this;
    }
     ...
     * Default currency the supplier's transactional data is recorded in.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withDefaultCurrency(String defaultCurrency) {
        Utils.checkNotNull(defaultCurrency, "defaultCurrency");
     ...
     * Default currency the supplier's transactional data is recorded in.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withDefaultCurrency(JsonNullable<? extends String> defaultCurrency) {
        Utils.checkNotNull(defaultCurrency, "defaultCurrency");
        this.defaultCurrency = defaultCurrency;
        return this;
    }
     ...
     * Email address that the supplier may be contacted on.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withEmailAddress(String emailAddress) {
        Utils.checkNotNull(emailAddress, "emailAddress");
     ...
     * Email address that the supplier may be contacted on.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withEmailAddress(JsonNullable<? extends String> emailAddress) {
        Utils.checkNotNull(emailAddress, "emailAddress");
        this.emailAddress = emailAddress;
        return this;
    }
     ...
     * Identifier for the supplier, unique to the company in the accounting platform.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withId(String id) {
        Utils.checkNotNull(id, "id");
     ...
     * Identifier for the supplier, unique to the company in the accounting platform.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withId(Optional<? extends String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public AccountingCreateSupplierResponseAccountingSupplier withMetadata(Metadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = Optional.ofNullable(metadata);
        return this;
    }
    
    public AccountingCreateSupplierResponseAccountingSupplier withMetadata(Optional<? extends Metadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }

    public AccountingCreateSupplierResponseAccountingSupplier withModifiedDate(String modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = Optional.ofNullable(modifiedDate);
        return this;
    }
    
    public AccountingCreateSupplierResponseAccountingSupplier withModifiedDate(Optional<? extends String> modifiedDate) {
        Utils.checkNotNull(modifiedDate, "modifiedDate");
        this.modifiedDate = modifiedDate;
        return this;
    }
     ...
     * Phone number that the supplier may be contacted on.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withPhone(String phone) {
        Utils.checkNotNull(phone, "phone");
     ...
     * Phone number that the supplier may be contacted on.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withPhone(JsonNullable<? extends String> phone) {
        Utils.checkNotNull(phone, "phone");
        this.phone = phone;
        return this;
    }
     ...
     * Company number of the supplier. In the UK, this is typically the company registration number issued by Companies House.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withRegistrationNumber(String registrationNumber) {
        Utils.checkNotNull(registrationNumber, "registrationNumber");
     ...
     * Company number of the supplier. In the UK, this is typically the company registration number issued by Companies House.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withRegistrationNumber(JsonNullable<? extends String> registrationNumber) {
        Utils.checkNotNull(registrationNumber, "registrationNumber");
        this.registrationNumber = registrationNumber;
        return this;
    }

    public AccountingCreateSupplierResponseAccountingSupplier withSourceModifiedDate(String sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = Optional.ofNullable(sourceModifiedDate);
        return this;
    }
    
    public AccountingCreateSupplierResponseAccountingSupplier withSourceModifiedDate(Optional<? extends String> sourceModifiedDate) {
        Utils.checkNotNull(sourceModifiedDate, "sourceModifiedDate");
        this.sourceModifiedDate = sourceModifiedDate;
        return this;
    }
     ...
     * Status of the supplier.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withStatus(SupplierStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting platform. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withSupplementalData(SupplementalData supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
     ...
     * It is referenced as a configured dynamic key value pair that is unique to the accounting platform. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withSupplementalData(Optional<? extends SupplementalData> supplementalData) {
        Utils.checkNotNull(supplementalData, "supplementalData");
        this.supplementalData = supplementalData;
        return this;
    }
     ...
     * Name of the supplier as recorded in the accounting system, typically the company name.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withSupplierName(String supplierName) {
        Utils.checkNotNull(supplierName, "supplierName");
     ...
     * Name of the supplier as recorded in the accounting system, typically the company name.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withSupplierName(JsonNullable<? extends String> supplierName) {
        Utils.checkNotNull(supplierName, "supplierName");
        this.supplierName = supplierName;
        return this;
    }
     ...
     * Supplier's company tax number.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withTaxNumber(String taxNumber) {
        Utils.checkNotNull(taxNumber, "taxNumber");
     ...
     * Supplier's company tax number.
     */
    public AccountingCreateSupplierResponseAccountingSupplier withTaxNumber(JsonNullable<? extends String> taxNumber) {
        Utils.checkNotNull(taxNumber, "taxNumber");
        this.taxNumber = taxNumber;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountingCreateSupplierResponseAccountingSupplier other = (AccountingCreateSupplierResponseAccountingSupplier) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AccountingCreateSupplierResponseAccountingSupplier.class,
                "addresses", addresses,
    ...
    public final static class Builder {
        ...
        public AccountingCreateSupplierResponseAccountingSupplier build() {
            return new AccountingCreateSupplierResponseAccountingSupplier(
                addresses,
                contactName,
                defaultCurrency,
                emailAddress,
