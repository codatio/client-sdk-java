...
public class CodatLendingAccountingBankData implements
    ...
    public io.codat.lending.models.operations.ListAccountingBankAccountTransactionsRequestBuilder listAccountingBankAccountTransactions() {
        return new io.codat.lending.models.operations.ListAccountingBankAccountTransactionsRequestBuilder(this);
    }
     ...
     */
    public io.codat.lending.models.operations.ListAccountingBankAccountTransactionsResponse listAccountingBankAccountTransactions(
        ...
        String url = io.codat.lending.utils.Utils.generateURL(
                io.codat.lending.models.operations.ListAccountingBankAccountTransactionsRequest.class, 
                baseUrl, 
        ...
        java.util.List<NameValuePair> queryParams = io.codat.lending.utils.Utils.getQueryParams(
                io.codat.lending.models.operations.ListAccountingBankAccountTransactionsRequest.class, request, null);
        if (queryParams != null) {
        ...
        io.codat.lending.models.operations.ListAccountingBankAccountTransactionsResponse.Builder resBuilder = 
            io.codat.lending.models.operations.ListAccountingBankAccountTransactionsResponse
                .builder()
                .contentType(contentType)
                .statusCode(httpRes.statusCode())
                .rawResponse(httpRes);

        io.codat.lending.models.operations.ListAccountingBankAccountTransactionsResponse res = resBuilder.build();
        ...
        if (httpRes.statusCode() == 200) {
            if (io.codat.lending.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                io.codat.lending.models.shared.AccountingBankTransactions out = mapper.readValue(
                    Utils.toUtf8AndClose(httpRes.body()),
                    new TypeReference<io.codat.lending.models.shared.AccountingBankTransactions>() {});
                res.withAccountingBankTransactions(java.util.Optional.ofNullable(out));
            } else {
