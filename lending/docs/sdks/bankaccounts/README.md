...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            CreateBankAccountResponse res = sdk.loanWriteback().bankAccounts().createBankAccount()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            GetCreateUpdateBankAccountsModelResponse res = sdk.loanWriteback().bankAccounts().getCreateUpdateBankAccountsModel()
                .request(req)
                .call();
