...
* [getAccountingCashFlowStatement](#getaccountingcashflowstatement) - Get cash flow statement

## getAccountingCashFlowStatement
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            GetAccountingCashFlowStatementResponse res = sdk.financialStatements().cashFlow().getAccountingCashFlowStatement()
                .request(req)
                .call();
