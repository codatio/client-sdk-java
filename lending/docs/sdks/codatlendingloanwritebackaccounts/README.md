...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            CreateAccountResponse res = sdk.loanWriteback().accounts().createAccount()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            GetCreateChartOfAccountsModelResponse res = sdk.loanWriteback().accounts().getCreateChartOfAccountsModel()
                .request(req)
                .call();
