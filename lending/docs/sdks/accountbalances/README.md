...
* [listBankingAccountBalances](#listbankingaccountbalances) - List account balances
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            ListBankingAccountBalancesResponse res = sdk.banking().accountBalances().listBankingAccountBalances()
                .request(req)
                .call();
