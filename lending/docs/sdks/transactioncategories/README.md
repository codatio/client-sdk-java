...
* [getBankingTransactionCategory](#getbankingtransactioncategory) - Get transaction category
* [listBankingTransactionCategories](#listbankingtransactioncategories) - List transaction categories

## getBankingTransactionCategory
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            GetBankingTransactionCategoryResponse res = sdk.banking().transactionCategories().getBankingTransactionCategory()
                .request(req)
                .call();
...
| ------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                  | [io.codat.lending.models.operations.GetBankingTransactionCategoryRequest](../../models/operations/GetBankingTransactionCategoryRequest.md) | :heavy_check_mark:                                                                                                                         | The request object to use for the request.                                                                                                 |


### Response

**[Optional<? extends io.codat.lending.models.operations.GetBankingTransactionCategoryResponse>](../../models/operations/GetBankingTransactionCategoryResponse.md)**
### Errors
...
## listBankingTransactionCategories
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            ListBankingTransactionCategoriesResponse res = sdk.banking().transactionCategories().listBankingTransactionCategories()
                .request(req)
                .call();
...
| Parameter                                                                                                                                        | Type                                                                                                                                             | Required                                                                                                                                         | Description                                                                                                                                      |
| ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                        | [io.codat.lending.models.operations.ListBankingTransactionCategoriesRequest](../../models/operations/ListBankingTransactionCategoriesRequest.md) | :heavy_check_mark:                                                                                                                               | The request object to use for the request.                                                                                                       |


### Response

**[Optional<? extends io.codat.lending.models.operations.ListBankingTransactionCategoriesResponse>](../../models/operations/ListBankingTransactionCategoriesResponse.md)**
### Errors
