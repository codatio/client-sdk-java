...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            CreateSupplierResponse res = sdk.loanWriteback().suppliers().createSupplier()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            GetCreateUpdateSuppliersModelResponse res = sdk.loanWriteback().suppliers().getCreateUpdateSuppliersModel()
                .request(req)
                .call();
