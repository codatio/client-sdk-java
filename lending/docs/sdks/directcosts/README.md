...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            CreateDirectCostResponse res = sdk.loanWriteback().directCosts().createDirectCost()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            GetCreateDirectCostsModelResponse res = sdk.loanWriteback().directCosts().getCreateDirectCostsModel()
                .request(req)
                .call();
