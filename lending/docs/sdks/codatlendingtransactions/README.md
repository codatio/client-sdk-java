...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            GetCommerceTransactionResponse res = sdk.sales().transactions().getCommerceTransaction()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            ListCommerceTransactionsResponse res = sdk.sales().transactions().listCommerceTransactions()
                .request(req)
                .call();
