...
* [getCommercePaymentMethod](#getcommercepaymentmethod) - Get payment method
* [listCommercePaymentMethods](#listcommercepaymentmethods) - List payment methods
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            GetCommercePaymentMethodResponse res = sdk.sales().paymentMethods().getCommercePaymentMethod()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            ListCommercePaymentMethodsResponse res = sdk.sales().paymentMethods().listCommercePaymentMethods()
                .request(req)
                .call();
