...
* [getCommerceLifetimeValueMetrics](#getcommercelifetimevaluemetrics) - Get lifetime value metrics
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            GetCommerceCustomerRetentionMetricsResponse res = sdk.sales().metrics().getCommerceCustomerRetentionMetrics()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            GetCommerceLifetimeValueMetricsResponse res = sdk.sales().metrics().getCommerceLifetimeValueMetrics()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            GetCommerceRevenueMetricsResponse res = sdk.sales().metrics().getCommerceRevenueMetrics()
                .request(req)
                .call();
