...
* [getCommerceOrdersReport](#getcommerceordersreport) - Get orders report
* [getCommerceRefundsReport](#getcommercerefundsreport) - Get refunds report

## getCommerceOrdersReport
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            GetCommerceOrdersReportResponse res = sdk.sales().reports().getCommerceOrdersReport()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            GetCommerceRefundsReportResponse res = sdk.sales().reports().getCommerceRefundsReport()
                .request(req)
                .call();
