...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            GetCommerceProductResponse res = sdk.sales().products().getCommerceProduct()
                .request(req)
                .call();
...
| -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| `request`                                                                                                            | [io.codat.lending.models.operations.GetCommerceProductRequest](../../models/operations/GetCommerceProductRequest.md) | :heavy_check_mark:                                                                                                   | The request object to use for the request.                                                                           |


### Response

**[Optional<? extends io.codat.lending.models.operations.GetCommerceProductResponse>](../../models/operations/GetCommerceProductResponse.md)**
### Errors
...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            ListCommerceProductsResponse res = sdk.sales().products().listCommerceProducts()
                .request(req)
                .call();
...
| Parameter                                                                                                                | Type                                                                                                                     | Required                                                                                                                 | Description                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                | [io.codat.lending.models.operations.ListCommerceProductsRequest](../../models/operations/ListCommerceProductsRequest.md) | :heavy_check_mark:                                                                                                       | The request object to use for the request.                                                                               |


### Response

**[Optional<? extends io.codat.lending.models.operations.ListCommerceProductsResponse>](../../models/operations/ListCommerceProductsResponse.md)**
### Errors
